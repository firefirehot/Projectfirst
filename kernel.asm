...
80100927:	e9 e4 37 00 00       	jmp    80104110 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100a2a:	75 d4                	jne    80100a00 <exec+0x60>
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 8f 62 00 00       	call   80106cc0 <setupkvm>
...
80100b13:	e8 58 5f 00 00       	call   80106a70 <loaduvm>
80100b18:	85 c0                	test   %eax,%eax
80100b1a:	0f 89 40 ff ff ff    	jns    80100a60 <exec+0xc0>
    freevm(pgdir);
80100b20:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100b26:	89 04 24             	mov    %eax,(%esp)
80100b29:	e8 12 61 00 00       	call   80106c40 <freevm>
...
80100b6c:	e8 bf 5f 00 00       	call   80106b30 <allocuvm>
...
80100b84:	e8 b7 60 00 00       	call   80106c40 <freevm>
  return -1;
...
80100bc8:	e8 a3 61 00 00       	call   80106d70 <clearpteu>
...
80100c31:	e8 9a 62 00 00       	call   80106ed0 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 27 62 00 00       	call   80106ed0 <copyout>
...
80100d1f:	e8 bc 5b 00 00       	call   801068e0 <switchuvm>
  freevm(oldpgdir);
80100d24:	89 34 24             	mov    %esi,(%esp)
80100d27:	e8 14 5f 00 00       	call   80106c40 <freevm>
  return 0;
...
80102c8a:	e8 a1 13 00 00       	call   80104030 <wakeup>
    release(&log.lock);
...
80102da7:	e8 54 2a 00 00       	call   80105800 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 e5 3a 00 00       	call   801068c0 <switchkvm>
  seginit();
80102ddb:	e8 20 3a 00 00       	call   80106800 <seginit>
  lapicinit();
...
80102e13:	e8 38 3f 00 00       	call   80106d50 <kvmalloc>
...
80102e25:	e8 d6 39 00 00       	call   80106800 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 e1 2c 00 00       	call   80105b20 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 16 29 00 00       	call   80105760 <tvinit>
  binit();         // buffer cache
...
8010328d:	e8 9e 0d 00 00       	call   80104030 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032cb:	e8 60 0d 00 00       	call   80104030 <wakeup>
...
8010334f:	e8 dc 0c 00 00       	call   80104030 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
801033ca:	e8 61 0c 00 00       	call   80104030 <wakeup>
  release(&p->lock);
...
801034a5:	e8 86 0b 00 00       	call   80104030 <wakeup>
  release(&p->lock);
...
8010350e:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103511:	e8 da 0f 00 00       	call   801044f0 <release>
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 55 57 10 80 	movl   $0x80105755,0x14(%eax)
...
8010354a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010354d:	e8 ee 0f 00 00       	call   80104540 <memset>
...
8010356f:	e8 7c 0f 00 00       	call   801044f0 <release>
}
...
8010359d:	e8 4e 0f 00 00       	call   801044f0 <release>
...
801035f5:	e8 16 0d 00 00       	call   80104310 <initlock>
}
801035fa:	c9                   	leave  
801035fb:	c3                   	ret    
...
801036a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036a7:	e8 e4 0c 00 00       	call   80104390 <pushcli>
  c = mycpu();
801036ac:	e8 4f ff ff ff       	call   80103600 <mycpu>
  p = c->proc;
801036b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036b7:	e8 14 0d 00 00       	call   801043d0 <popcli>
}
...
801036e3:	e8 d8 35 00 00       	call   80106cc0 <setupkvm>
...
80103705:	80 
80103706:	e8 e5 32 00 00       	call   801069f0 <inituvm>
  p->sz = PGSIZE;
...
80103727:	e8 14 0e 00 00       	call   80104540 <memset>
...
8010378e:	e8 8d 0f 00 00       	call   80104720 <safestrcpy>
  p->cwd = namei("/");
...
80103809:	e8 22 33 00 00       	call   80106b30 <allocuvm>
...
80103817:	e8 c4 30 00 00       	call   801068e0 <switchuvm>
  return 0;
...
8010383a:	e8 e1 33 00 00       	call   80106c20 <deallocuvm>
...
8010387e:	e8 1d 35 00 00       	call   80106da0 <copyuvm>
...
80103988:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
8010398d:	e8 ee 0a 00 00       	call   80104480 <acquire>
...
801039b2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039b5:	e8 26 2f 00 00       	call   801068e0 <switchuvm>
...
801039cb:	e8 ab 0d 00 00       	call   8010477b <swtch>
      switchkvm();
801039d0:	e8 eb 2e 00 00       	call   801068c0 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801039ef:	e8 fc 0a 00 00       	call   801044f0 <release>
  }
...
80103a14:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103a16:	e8 25 0a 00 00       	call   80104440 <holding>
...
80103a57:	e8 1f 0d 00 00       	call   8010477b <swtch>
  mycpu()->intena = intena;
...
80103b03:	e8 78 09 00 00       	call   80104480 <acquire>
...
80103c23:	e8 58 08 00 00       	call   80104480 <acquire>
  wakeup1(curproc->parent);
...
80103ced:	e8 8e 07 00 00       	call   80104480 <acquire>
...
80103d0a:	e8 e1 07 00 00       	call   801044f0 <release>
}
80103d0f:	c9                   	leave  
80103d10:	c3                   	ret    
...
80103d51:	e8 2a 07 00 00       	call   80104480 <acquire>
    release(lk);
80103d56:	89 34 24             	mov    %esi,(%esp)
80103d59:	e8 92 07 00 00       	call   801044f0 <release>
  p->chan = chan;
...
80103d7b:	e8 70 07 00 00       	call   801044f0 <release>
    acquire(lk);
...
80103d89:	5d                   	pop    %ebp
    acquire(lk);
80103d8a:	e9 f1 06 00 00       	jmp    80104480 <acquire>
80103d8f:	90                   	nop
  p->chan = chan;
...
80103de8:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103dea:	e8 91 06 00 00       	call   80104480 <acquire>
    havekids = 0;
...
80103e58:	e8 e3 2d 00 00       	call   80106c40 <freevm>
        release(&ptable.lock);
...
80103e7d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103e84:	e8 67 06 00 00       	call   801044f0 <release>
...
80103ea3:	e8 48 06 00 00       	call   801044f0 <release>
}
...
80103ecc:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  struct proc *curproc = myproc();
80103ecf:	e8 cc f7 ff ff       	call   801036a0 <myproc>
  acquire(&ptable.lock);
80103ed4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103edb:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103edd:	e8 9e 05 00 00       	call   80104480 <acquire>
  if(options == 1){
80103ee2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103ee5:	83 7d 10 01          	cmpl   $0x1,0x10(%ebp)
80103ee9:	0f 85 9c 00 00 00    	jne    80103f8b <waitpid+0xcb>
80103eef:	31 c0                	xor    %eax,%eax
80103ef1:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103ef6:	eb 0b                	jmp    80103f03 <waitpid+0x43>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ef8:	83 eb 80             	sub    $0xffffff80,%ebx
80103efb:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103f01:	74 1d                	je     80103f20 <waitpid+0x60>
      if(p->parent != curproc)
80103f03:	39 73 14             	cmp    %esi,0x14(%ebx)
80103f06:	75 f0                	jne    80103ef8 <waitpid+0x38>
      if(p->pid == pid){
80103f08:	39 53 10             	cmp    %edx,0x10(%ebx)
80103f0b:	74 3c                	je     80103f49 <waitpid+0x89>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f0d:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
80103f10:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f15:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103f1b:	75 e6                	jne    80103f03 <waitpid+0x43>
80103f1d:	8d 76 00             	lea    0x0(%esi),%esi
    if(!havekids || curproc->killed){
80103f20:	85 c0                	test   %eax,%eax
80103f22:	0f 84 f0 00 00 00    	je     80104018 <waitpid+0x158>
80103f28:	8b 7e 24             	mov    0x24(%esi),%edi
80103f2b:	85 ff                	test   %edi,%edi
80103f2d:	0f 85 e5 00 00 00    	jne    80104018 <waitpid+0x158>
	release(&ptable.lock);
80103f33:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f3a:	e8 b1 05 00 00       	call   801044f0 <release>
}
80103f3f:	83 c4 1c             	add    $0x1c,%esp
80103f42:	89 f8                	mov    %edi,%eax
80103f44:	5b                   	pop    %ebx
80103f45:	5e                   	pop    %esi
80103f46:	5f                   	pop    %edi
80103f47:	5d                   	pop    %ebp
80103f48:	c3                   	ret    
	release(&ptable.lock);
80103f49:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f50:	e8 9b 05 00 00       	call   801044f0 <release>
        return p->exitStat;
80103f55:	8b 7b 7c             	mov    0x7c(%ebx),%edi
}
...
80103f60:	5d                   	pop    %ebp
80103f61:	c3                   	ret    
    if(!match || curproc->killed){
80103f62:	85 c0                	test   %eax,%eax
80103f64:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80103f67:	0f 84 ab 00 00 00    	je     80104018 <waitpid+0x158>
80103f6d:	8b 46 24             	mov    0x24(%esi),%eax
80103f70:	85 c0                	test   %eax,%eax
80103f72:	0f 85 a0 00 00 00    	jne    80104018 <waitpid+0x158>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103f78:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103f7f:	80 
80103f80:	89 34 24             	mov    %esi,(%esp)
80103f83:	e8 98 fd ff ff       	call   80103d20 <sleep>
  }
...
80103f92:	eb 0f                	jmp    80103fa3 <waitpid+0xe3>
...
80103fa1:	74 bf                	je     80103f62 <waitpid+0xa2>
      if(p->pid != pid)
80103fa3:	8b 7b 10             	mov    0x10(%ebx),%edi
80103fa6:	39 d7                	cmp    %edx,%edi
80103fa8:	75 ee                	jne    80103f98 <waitpid+0xd8>
      if(p->state == ZOMBIE){
80103faa:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103fae:	74 07                	je     80103fb7 <waitpid+0xf7>
      match = 1;
80103fb0:	b8 01 00 00 00       	mov    $0x1,%eax
80103fb5:	eb e1                	jmp    80103f98 <waitpid+0xd8>
        kfree(p->kstack);
80103fb7:	8b 43 08             	mov    0x8(%ebx),%eax
80103fba:	89 04 24             	mov    %eax,(%esp)
80103fbd:	e8 2e e3 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80103fc2:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80103fc5:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103fcc:	89 04 24             	mov    %eax,(%esp)
80103fcf:	e8 6c 2c 00 00       	call   80106c40 <freevm>
        release(&ptable.lock);
80103fd4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
...
80103ffb:	e8 f0 04 00 00       	call   801044f0 <release>
	if(waitStatus != ((void*)0))
80104000:	8b 55 0c             	mov    0xc(%ebp),%edx
80104003:	85 d2                	test   %edx,%edx
80104005:	0f 84 34 ff ff ff    	je     80103f3f <waitpid+0x7f>
	*waitStatus = p->exitStat;
8010400b:	8b 43 7c             	mov    0x7c(%ebx),%eax
8010400e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104011:	89 01                	mov    %eax,(%ecx)
80104013:	e9 27 ff ff ff       	jmp    80103f3f <waitpid+0x7f>
      release(&ptable.lock);
80104018:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
      return -1;
8010401f:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      release(&ptable.lock);
80104024:	e8 c7 04 00 00       	call   801044f0 <release>
      return -1;
80104029:	e9 11 ff ff ff       	jmp    80103f3f <waitpid+0x7f>
...
80104041:	e8 3a 04 00 00       	call   80104480 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104046:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010404b:	eb 0d                	jmp    8010405a <wakeup+0x2a>
8010404d:	8d 76 00             	lea    0x0(%esi),%esi
80104050:	83 e8 80             	sub    $0xffffff80,%eax
80104053:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80104058:	74 1e                	je     80104078 <wakeup+0x48>
    if(p->state == SLEEPING && p->chan == chan)
...
8010406f:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80104074:	75 e4                	jne    8010405a <wakeup+0x2a>
80104076:	66 90                	xchg   %ax,%ax
  wakeup1(chan);
  release(&ptable.lock);
80104078:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
8010407f:	83 c4 14             	add    $0x14,%esp
80104082:	5b                   	pop    %ebx
80104083:	5d                   	pop    %ebp
  release(&ptable.lock);
80104084:	e9 67 04 00 00       	jmp    801044f0 <release>
...
801040a1:	e8 da 03 00 00       	call   80104480 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040a6:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801040ab:	eb 0d                	jmp    801040ba <kill+0x2a>
801040ad:	8d 76 00             	lea    0x0(%esi),%esi
801040b0:	83 e8 80             	sub    $0xffffff80,%eax
801040b3:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
...
801040c3:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
801040ca:	74 14                	je     801040e0 <kill+0x50>
        p->state = RUNNABLE;
      release(&ptable.lock);
801040cc:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801040d3:	e8 18 04 00 00       	call   801044f0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801040d8:	83 c4 14             	add    $0x14,%esp
      return 0;
801040db:	31 c0                	xor    %eax,%eax
}
801040dd:	5b                   	pop    %ebx
801040de:	5d                   	pop    %ebp
801040df:	c3                   	ret    
        p->state = RUNNABLE;
801040e0:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
801040e7:	eb e3                	jmp    801040cc <kill+0x3c>
801040e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  release(&ptable.lock);
801040f0:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801040f7:	e8 f4 03 00 00       	call   801044f0 <release>
}
801040fc:	83 c4 14             	add    $0x14,%esp
  return -1;
...
80104116:	bb c0 2d 11 80       	mov    $0x80112dc0,%ebx
8010411b:	83 ec 4c             	sub    $0x4c,%esp
8010411e:	8d 75 e8             	lea    -0x18(%ebp),%esi
80104121:	eb 20                	jmp    80104143 <procdump+0x33>
80104123:	90                   	nop
80104124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80104128:	c7 04 24 df 78 10 80 	movl   $0x801078df,(%esp)
8010412f:	e8 1c c5 ff ff       	call   80100650 <cprintf>
80104134:	83 eb 80             	sub    $0xffffff80,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104137:	81 fb c0 4d 11 80    	cmp    $0x80114dc0,%ebx
8010413d:	0f 84 8d 00 00 00    	je     801041d0 <procdump+0xc0>
    if(p->state == UNUSED)
80104143:	8b 43 a0             	mov    -0x60(%ebx),%eax
80104146:	85 c0                	test   %eax,%eax
80104148:	74 ea                	je     80104134 <procdump+0x24>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010414a:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
8010414d:	ba 60 75 10 80       	mov    $0x80107560,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104152:	77 11                	ja     80104165 <procdump+0x55>
80104154:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
      state = "???";
8010415b:	b8 60 75 10 80       	mov    $0x80107560,%eax
80104160:	85 d2                	test   %edx,%edx
80104162:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80104165:	8b 43 a4             	mov    -0x5c(%ebx),%eax
80104168:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010416c:	89 54 24 08          	mov    %edx,0x8(%esp)
80104170:	c7 04 24 64 75 10 80 	movl   $0x80107564,(%esp)
80104177:	89 44 24 04          	mov    %eax,0x4(%esp)
8010417b:	e8 d0 c4 ff ff       	call   80100650 <cprintf>
    if(p->state == SLEEPING){
80104180:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80104184:	75 a2                	jne    80104128 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104186:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104189:	89 44 24 04          	mov    %eax,0x4(%esp)
8010418d:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104190:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104193:	8b 40 0c             	mov    0xc(%eax),%eax
80104196:	83 c0 08             	add    $0x8,%eax
80104199:	89 04 24             	mov    %eax,(%esp)
8010419c:	e8 8f 01 00 00       	call   80104330 <getcallerpcs>
...
801041ac:	0f 84 76 ff ff ff    	je     80104128 <procdump+0x18>
        cprintf(" %p", pc[i]);
801041b2:	89 54 24 04          	mov    %edx,0x4(%esp)
801041b6:	83 c7 04             	add    $0x4,%edi
801041b9:	c7 04 24 a1 6f 10 80 	movl   $0x80106fa1,(%esp)
801041c0:	e8 8b c4 ff ff       	call   80100650 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801041c5:	39 f7                	cmp    %esi,%edi
801041c7:	75 df                	jne    801041a8 <procdump+0x98>
801041c9:	e9 5a ff ff ff       	jmp    80104128 <procdump+0x18>
...
801041ea:	c7 44 24 04 d8 75 10 	movl   $0x801075d8,0x4(%esp)
801041f1:	80 
...
80104247:	e8 d4 fa ff ff       	call   80103d20 <sleep>
  while (lk->locked) {
...
80104252:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104258:	e8 43 f4 ff ff       	call   801036a0 <myproc>
...
801042a6:	e8 85 fd ff ff       	call   80104030 <wakeup>
  release(&lk->lk);
...
801042e2:	e8 b9 f3 ff ff       	call   801036a0 <myproc>
...
801043db:	75 49                	jne    80104426 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
801043dd:	e8 1e f2 ff ff       	call   80103600 <mycpu>
...
801043f5:	e8 06 f2 ff ff       	call   80103600 <mycpu>
...
80104406:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104408:	e8 f3 f1 ff ff       	call   80103600 <mycpu>
...
80104419:	c3                   	ret    
    panic("popcli");
8010441a:	c7 04 24 fa 75 10 80 	movl   $0x801075fa,(%esp)
80104421:	e8 3a bf ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104426:	c7 04 24 e3 75 10 80 	movl   $0x801075e3,(%esp)
...
80104458:	e8 a3 f1 ff ff       	call   80103600 <mycpu>
...
801044b2:	e8 49 f1 ff ff       	call   80103600 <mycpu>
...
801044d4:	c3                   	ret    
    panic("acquire");
801044d5:	c7 04 24 01 76 10 80 	movl   $0x80107601,(%esp)
...
80104522:	e9 a9 fe ff ff       	jmp    801043d0 <popcli>
    panic("release");
80104527:	c7 04 24 09 76 10 80 	movl   $0x80107609,(%esp)
...
80104797:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010479a:	e8 01 ef ff ff       	call   801036a0 <myproc>
...
8010483b:	e8 60 ee ff ff       	call   801036a0 <myproc>
...
80104905:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104908:	e8 93 ed ff ff       	call   801036a0 <myproc>
...
80104918:	83 fa 16             	cmp    $0x16,%edx
8010491b:	77 1b                	ja     80104938 <syscall+0x38>
8010491d:	8b 14 85 40 76 10 80 	mov    -0x7fef89c0(,%eax,4),%edx
...
80104946:	c7 04 24 11 76 10 80 	movl   $0x80107611,(%esp)
...
80104ad0:	c7 44 24 04 bc 76 10 	movl   $0x801076bc,0x4(%esp)
80104ad7:	80 
...
80104aeb:	c7 44 24 04 bb 76 10 	movl   $0x801076bb,0x4(%esp)
80104af2:	80 
...
80104b01:	79 89                	jns    80104a8c <create+0xdc>
      panic("create dots");
80104b03:	c7 04 24 af 76 10 80 	movl   $0x801076af,(%esp)
80104b0a:	e8 51 b8 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
80104b0f:	c7 04 24 be 76 10 80 	movl   $0x801076be,(%esp)
80104b16:	e8 45 b8 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104b1b:	c7 04 24 a0 76 10 80 	movl   $0x801076a0,(%esp)
...
80104b59:	e8 42 eb ff ff       	call   801036a0 <myproc>
...
80104cd3:	78 23                	js     80104cf8 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104cd5:	e8 c6 e9 ff ff       	call   801036a0 <myproc>
...
80104ec1:	c7 44 24 04 bc 76 10 	movl   $0x801076bc,0x4(%esp)
80104ec8:	80 
...
80104ed9:	c7 44 24 04 bb 76 10 	movl   $0x801076bb,0x4(%esp)
80104ee0:	80 
...
8010502d:	c7 04 24 e0 76 10 80 	movl   $0x801076e0,(%esp)
80105034:	e8 27 b3 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80105039:	c7 04 24 f2 76 10 80 	movl   $0x801076f2,(%esp)
80105040:	e8 1b b3 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80105045:	c7 04 24 ce 76 10 80 	movl   $0x801076ce,(%esp)
...
80105295:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105298:	e8 03 e4 ff ff       	call   801036a0 <myproc>
...
80105479:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105480:	e8 1b e2 ff ff       	call   801036a0 <myproc>
...
801054b3:	5d                   	pop    %ebp
  return fork();
801054b4:	e9 97 e3 ff ff       	jmp    80103850 <fork>
...
801054c3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054c6:	e8 d5 e5 ff ff       	call   80103aa0 <exit>
...
801054e4:	e8 47 f3 ff ff       	call   80104830 <argint>
801054e9:	85 c0                	test   %eax,%eax
801054eb:	78 13                	js     80105500 <sys_exitS+0x30>
     return -1;
  	
  exitS(pid);
801054ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054f0:	89 04 24             	mov    %eax,(%esp)
801054f3:	e8 c8 e6 ff ff       	call   80103bc0 <exitS>
...
80105519:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105520:	00 
80105521:	89 44 24 04          	mov    %eax,0x4(%esp)
80105525:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010552c:	e8 2f f3 ff ff       	call   80104860 <argptr>
80105531:	85 c0                	test   %eax,%eax
80105533:	78 13                	js     80105548 <sys_wait+0x38>
     return -1;
  return wait(pid);
80105535:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105538:	89 04 24             	mov    %eax,(%esp)
8010553b:	e8 90 e8 ff ff       	call   80103dd0 <wait>
}
80105540:	c9                   	leave  
80105541:	c3                   	ret    
...
801055a9:	8b 45 ec             	mov    -0x14(%ebp),%eax
801055ac:	89 04 24             	mov    %eax,(%esp)
801055af:	e8 0c e9 ff ff       	call   80103ec0 <waitpid>
}
801055b4:	c9                   	leave  
801055b5:	c3                   	ret    
...
801055e3:	e8 a8 ea ff ff       	call   80104090 <kill>
}
801055e8:	c9                   	leave  
801055e9:	c3                   	ret    
...
80105625:	e8 06 f2 ff ff       	call   80104830 <argint>
...
80105675:	e8 b6 f1 ff ff       	call   80104830 <argint>
8010567a:	85 c0                	test   %eax,%eax
8010567c:	78 7e                	js     801056fc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010567e:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105685:	e8 f6 ed ff ff       	call   80104480 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010568a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010568d:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
801056a0:	c7 44 24 04 60 4d 11 	movl   $0x80114d60,0x4(%esp)
801056a7:	80 
801056a8:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
801056af:	e8 6c e6 ff ff       	call   80103d20 <sleep>
  while(ticks - ticks0 < n){
801056b4:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
801056ca:	74 d4                	je     801056a0 <sys_sleep+0x40>
      release(&tickslock);
801056cc:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801056d3:	e8 18 ee ff ff       	call   801044f0 <release>
      return -1;
...
801056e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801056e8:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801056ef:	e8 fc ed ff ff       	call   801044f0 <release>
}
...
8010571e:	e8 5d ed ff ff       	call   80104480 <acquire>
  xticks = ticks;
80105723:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
80105729:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105730:	e8 bb ed ff ff       	call   801044f0 <release>
  return xticks;
}
...
8010573d:	1e                   	push   %ds
8010573e:	06                   	push   %es
8010573f:	0f a0                	push   %fs
80105741:	0f a8                	push   %gs
80105743:	60                   	pusha  
80105744:	66 b8 10 00          	mov    $0x10,%ax
80105748:	8e d8                	mov    %eax,%ds
8010574a:	8e c0                	mov    %eax,%es
8010574c:	54                   	push   %esp
8010574d:	e8 de 00 00 00       	call   80105830 <trap>
80105752:	83 c4 04             	add    $0x4,%esp

80105755 <trapret>:
80105755:	61                   	popa   
80105756:	0f a9                	pop    %gs
80105758:	0f a1                	pop    %fs
8010575a:	07                   	pop    %es
8010575b:	1f                   	pop    %ds
...
80105774:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
8010577b:	80 
8010577c:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
80105783:	00 
...
801057b9:	c7 44 24 04 01 77 10 	movl   $0x80107701,0x4(%esp)
801057c0:	80 
801057c1:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801057c8:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
801057cf:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
801057d5:	c1 e8 10             	shr    $0x10,%eax
801057d8:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
801057df:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
801057e6:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
801057ec:	e8 1f eb ff ff       	call   80104310 <initlock>
}
801057f1:	c9                   	leave  
801057f2:	c3                   	ret    
...
80105842:	0f 84 a0 01 00 00    	je     801059e8 <trap+0x1b8>
    if(myproc()->killed)
      exit();
    return;
  }
...
8010584e:	77 08                	ja     80105858 <trap+0x28>
80105850:	ff 24 85 a8 77 10 80 	jmp    *-0x7fef8858(,%eax,4)
80105857:	90                   	nop
    lapiceoi();
    break;
...
80105858:	e8 43 de ff ff       	call   801036a0 <myproc>
8010585d:	85 c0                	test   %eax,%eax
8010585f:	90                   	nop
80105860:	0f 84 fa 01 00 00    	je     80105a60 <trap+0x230>
80105866:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010586a:	0f 84 f0 01 00 00    	je     80105a60 <trap+0x230>
...
80105873:	8b 53 38             	mov    0x38(%ebx),%edx
80105876:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105879:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010587c:	e8 ff dd ff ff       	call   80103680 <cpuid>
80105881:	8b 73 30             	mov    0x30(%ebx),%esi
80105884:	89 c7                	mov    %eax,%edi
80105886:	8b 43 34             	mov    0x34(%ebx),%eax
80105889:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010588c:	e8 0f de ff ff       	call   801036a0 <myproc>
80105891:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105894:	e8 07 de ff ff       	call   801036a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105899:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010589c:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801058a0:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801058a3:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801058a6:	89 7c 24 14          	mov    %edi,0x14(%esp)
801058aa:	89 54 24 18          	mov    %edx,0x18(%esp)
801058ae:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
801058b1:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801058b4:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801058b8:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801058bc:	89 54 24 10          	mov    %edx,0x10(%esp)
801058c0:	8b 40 10             	mov    0x10(%eax),%eax
801058c3:	c7 04 24 64 77 10 80 	movl   $0x80107764,(%esp)
801058ca:	89 44 24 04          	mov    %eax,0x4(%esp)
801058ce:	e8 7d ad ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801058d3:	e8 c8 dd ff ff       	call   801036a0 <myproc>
801058d8:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801058df:	90                   	nop
  }
...
801058e0:	e8 bb dd ff ff       	call   801036a0 <myproc>
801058e5:	85 c0                	test   %eax,%eax
801058e7:	74 0c                	je     801058f5 <trap+0xc5>
801058e9:	e8 b2 dd ff ff       	call   801036a0 <myproc>
801058ee:	8b 50 24             	mov    0x24(%eax),%edx
801058f1:	85 d2                	test   %edx,%edx
801058f3:	75 4b                	jne    80105940 <trap+0x110>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801058f5:	e8 a6 dd ff ff       	call   801036a0 <myproc>
801058fa:	85 c0                	test   %eax,%eax
801058fc:	74 0d                	je     8010590b <trap+0xdb>
801058fe:	66 90                	xchg   %ax,%ax
80105900:	e8 9b dd ff ff       	call   801036a0 <myproc>
80105905:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105909:	74 4d                	je     80105958 <trap+0x128>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010590b:	e8 90 dd ff ff       	call   801036a0 <myproc>
80105910:	85 c0                	test   %eax,%eax
80105912:	74 1d                	je     80105931 <trap+0x101>
80105914:	e8 87 dd ff ff       	call   801036a0 <myproc>
80105919:	8b 40 24             	mov    0x24(%eax),%eax
8010591c:	85 c0                	test   %eax,%eax
8010591e:	74 11                	je     80105931 <trap+0x101>
80105920:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105924:	83 e0 03             	and    $0x3,%eax
80105927:	66 83 f8 03          	cmp    $0x3,%ax
8010592b:	0f 84 e8 00 00 00    	je     80105a19 <trap+0x1e9>
    exit();
}
80105931:	83 c4 3c             	add    $0x3c,%esp
80105934:	5b                   	pop    %ebx
80105935:	5e                   	pop    %esi
80105936:	5f                   	pop    %edi
80105937:	5d                   	pop    %ebp
...
8010594b:	75 a8                	jne    801058f5 <trap+0xc5>
    exit();
8010594d:	e8 4e e1 ff ff       	call   80103aa0 <exit>
80105952:	eb a1                	jmp    801058f5 <trap+0xc5>
...
80105960:	75 a9                	jne    8010590b <trap+0xdb>
    yield();
80105962:	e8 79 e3 ff ff       	call   80103ce0 <yield>
80105967:	eb a2                	jmp    8010590b <trap+0xdb>
80105969:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105970:	e8 0b dd ff ff       	call   80103680 <cpuid>
80105975:	85 c0                	test   %eax,%eax
80105977:	0f 84 b3 00 00 00    	je     80105a30 <trap+0x200>
8010597d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105980:	e8 fb cd ff ff       	call   80102780 <lapiceoi>
    break;
80105985:	e9 56 ff ff ff       	jmp    801058e0 <trap+0xb0>
...
80105995:	e8 e6 cd ff ff       	call   80102780 <lapiceoi>
    break;
8010599a:	e9 41 ff ff ff       	jmp    801058e0 <trap+0xb0>
8010599f:	90                   	nop
    uartintr();
801059a0:	e8 1b 02 00 00       	call   80105bc0 <uartintr>
    lapiceoi();
801059a5:	e8 d6 cd ff ff       	call   80102780 <lapiceoi>
    break;
801059aa:	e9 31 ff ff ff       	jmp    801058e0 <trap+0xb0>
801059af:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801059b0:	8b 7b 38             	mov    0x38(%ebx),%edi
801059b3:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
801059b7:	e8 c4 dc ff ff       	call   80103680 <cpuid>
801059bc:	c7 04 24 0c 77 10 80 	movl   $0x8010770c,(%esp)
801059c3:	89 7c 24 0c          	mov    %edi,0xc(%esp)
801059c7:	89 74 24 08          	mov    %esi,0x8(%esp)
801059cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801059cf:	e8 7c ac ff ff       	call   80100650 <cprintf>
    lapiceoi();
801059d4:	e8 a7 cd ff ff       	call   80102780 <lapiceoi>
    break;
801059d9:	e9 02 ff ff ff       	jmp    801058e0 <trap+0xb0>
801059de:	66 90                	xchg   %ax,%ax
    ideintr();
801059e0:	e8 9b c6 ff ff       	call   80102080 <ideintr>
801059e5:	eb 96                	jmp    8010597d <trap+0x14d>
801059e7:	90                   	nop
801059e8:	90                   	nop
801059e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
801059f0:	e8 ab dc ff ff       	call   801036a0 <myproc>
801059f5:	8b 70 24             	mov    0x24(%eax),%esi
801059f8:	85 f6                	test   %esi,%esi
801059fa:	75 2c                	jne    80105a28 <trap+0x1f8>
    myproc()->tf = tf;
801059fc:	e8 9f dc ff ff       	call   801036a0 <myproc>
80105a01:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105a04:	e8 f7 ee ff ff       	call   80104900 <syscall>
    if(myproc()->killed)
80105a09:	e8 92 dc ff ff       	call   801036a0 <myproc>
80105a0e:	8b 48 24             	mov    0x24(%eax),%ecx
80105a11:	85 c9                	test   %ecx,%ecx
80105a13:	0f 84 18 ff ff ff    	je     80105931 <trap+0x101>
}
80105a19:	83 c4 3c             	add    $0x3c,%esp
80105a1c:	5b                   	pop    %ebx
80105a1d:	5e                   	pop    %esi
80105a1e:	5f                   	pop    %edi
80105a1f:	5d                   	pop    %ebp
      exit();
80105a20:	e9 7b e0 ff ff       	jmp    80103aa0 <exit>
80105a25:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105a28:	e8 73 e0 ff ff       	call   80103aa0 <exit>
80105a2d:	eb cd                	jmp    801059fc <trap+0x1cc>
80105a2f:	90                   	nop
      acquire(&tickslock);
80105a30:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105a37:	e8 44 ea ff ff       	call   80104480 <acquire>
      wakeup(&ticks);
80105a3c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105a43:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105a4a:	e8 e1 e5 ff ff       	call   80104030 <wakeup>
      release(&tickslock);
80105a4f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105a56:	e8 95 ea ff ff       	call   801044f0 <release>
80105a5b:	e9 1d ff ff ff       	jmp    8010597d <trap+0x14d>
80105a60:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105a63:	8b 73 38             	mov    0x38(%ebx),%esi
80105a66:	e8 15 dc ff ff       	call   80103680 <cpuid>
80105a6b:	89 7c 24 10          	mov    %edi,0x10(%esp)
80105a6f:	89 74 24 0c          	mov    %esi,0xc(%esp)
80105a73:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a77:	8b 43 30             	mov    0x30(%ebx),%eax
80105a7a:	c7 04 24 30 77 10 80 	movl   $0x80107730,(%esp)
80105a81:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a85:	e8 c6 ab ff ff       	call   80100650 <cprintf>
      panic("trap");
80105a8a:	c7 04 24 06 77 10 80 	movl   $0x80107706,(%esp)
80105a91:	e8 ca a8 ff ff       	call   80100360 <panic>
...
80105af7:	e8 a4 cc ff ff       	call   801027a0 <microdelay>
...
80105b6e:	74 42                	je     80105bb2 <uartinit+0x92>
  uart = 1;
80105b70:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105b77:	00 00 00 
...
80105b80:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b87:	00 
  for(p="xv6...\n"; *p; p++)
80105b88:	bb 28 78 10 80       	mov    $0x80107828,%ebx
  ioapicenable(IRQ_COM1, 0);
80105b8d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105b94:	e8 17 c7 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105ba3:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105ba6:	e8 25 ff ff ff       	call   80105ad0 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105bab:	0f be 03             	movsbl (%ebx),%eax
80105bae:	84 c0                	test   %al,%al
80105bb0:	75 ee                	jne    80105ba0 <uartinit+0x80>
}
...
80105bc6:	c7 04 24 a0 5a 10 80 	movl   $0x80105aa0,(%esp)
...
80105bd6:	6a 00                	push   $0x0
  jmp alltraps
80105bd8:	e9 60 fb ff ff       	jmp    8010573d <alltraps>
...
80105bdf:	6a 01                	push   $0x1
  jmp alltraps
80105be1:	e9 57 fb ff ff       	jmp    8010573d <alltraps>
...
80105be8:	6a 02                	push   $0x2
  jmp alltraps
80105bea:	e9 4e fb ff ff       	jmp    8010573d <alltraps>
...
80105bf1:	6a 03                	push   $0x3
  jmp alltraps
80105bf3:	e9 45 fb ff ff       	jmp    8010573d <alltraps>
...
80105bfa:	6a 04                	push   $0x4
  jmp alltraps
80105bfc:	e9 3c fb ff ff       	jmp    8010573d <alltraps>
...
80105c03:	6a 05                	push   $0x5
  jmp alltraps
80105c05:	e9 33 fb ff ff       	jmp    8010573d <alltraps>
...
80105c0c:	6a 06                	push   $0x6
  jmp alltraps
80105c0e:	e9 2a fb ff ff       	jmp    8010573d <alltraps>
...
80105c15:	6a 07                	push   $0x7
  jmp alltraps
80105c17:	e9 21 fb ff ff       	jmp    8010573d <alltraps>
...
80105c1c:	6a 08                	push   $0x8
  jmp alltraps
80105c1e:	e9 1a fb ff ff       	jmp    8010573d <alltraps>
...
80105c25:	6a 09                	push   $0x9
  jmp alltraps
80105c27:	e9 11 fb ff ff       	jmp    8010573d <alltraps>
...
80105c2c:	6a 0a                	push   $0xa
  jmp alltraps
80105c2e:	e9 0a fb ff ff       	jmp    8010573d <alltraps>
...
80105c33:	6a 0b                	push   $0xb
  jmp alltraps
80105c35:	e9 03 fb ff ff       	jmp    8010573d <alltraps>
...
80105c3a:	6a 0c                	push   $0xc
  jmp alltraps
80105c3c:	e9 fc fa ff ff       	jmp    8010573d <alltraps>
...
80105c41:	6a 0d                	push   $0xd
  jmp alltraps
80105c43:	e9 f5 fa ff ff       	jmp    8010573d <alltraps>
...
80105c48:	6a 0e                	push   $0xe
  jmp alltraps
80105c4a:	e9 ee fa ff ff       	jmp    8010573d <alltraps>
...
80105c51:	6a 0f                	push   $0xf
  jmp alltraps
80105c53:	e9 e5 fa ff ff       	jmp    8010573d <alltraps>
...
80105c5a:	6a 10                	push   $0x10
  jmp alltraps
80105c5c:	e9 dc fa ff ff       	jmp    8010573d <alltraps>
...
80105c61:	6a 11                	push   $0x11
  jmp alltraps
80105c63:	e9 d5 fa ff ff       	jmp    8010573d <alltraps>
...
80105c6a:	6a 12                	push   $0x12
  jmp alltraps
80105c6c:	e9 cc fa ff ff       	jmp    8010573d <alltraps>
...
80105c73:	6a 13                	push   $0x13
  jmp alltraps
80105c75:	e9 c3 fa ff ff       	jmp    8010573d <alltraps>
...
80105c7c:	6a 14                	push   $0x14
  jmp alltraps
80105c7e:	e9 ba fa ff ff       	jmp    8010573d <alltraps>
...
80105c85:	6a 15                	push   $0x15
  jmp alltraps
80105c87:	e9 b1 fa ff ff       	jmp    8010573d <alltraps>
...
80105c8e:	6a 16                	push   $0x16
  jmp alltraps
80105c90:	e9 a8 fa ff ff       	jmp    8010573d <alltraps>
...
80105c97:	6a 17                	push   $0x17
  jmp alltraps
80105c99:	e9 9f fa ff ff       	jmp    8010573d <alltraps>
...
80105ca0:	6a 18                	push   $0x18
  jmp alltraps
80105ca2:	e9 96 fa ff ff       	jmp    8010573d <alltraps>
...
80105ca9:	6a 19                	push   $0x19
  jmp alltraps
80105cab:	e9 8d fa ff ff       	jmp    8010573d <alltraps>
...
80105cb2:	6a 1a                	push   $0x1a
  jmp alltraps
80105cb4:	e9 84 fa ff ff       	jmp    8010573d <alltraps>
...
80105cbb:	6a 1b                	push   $0x1b
  jmp alltraps
80105cbd:	e9 7b fa ff ff       	jmp    8010573d <alltraps>
...
80105cc4:	6a 1c                	push   $0x1c
  jmp alltraps
80105cc6:	e9 72 fa ff ff       	jmp    8010573d <alltraps>
...
80105ccd:	6a 1d                	push   $0x1d
  jmp alltraps
80105ccf:	e9 69 fa ff ff       	jmp    8010573d <alltraps>
...
80105cd6:	6a 1e                	push   $0x1e
  jmp alltraps
80105cd8:	e9 60 fa ff ff       	jmp    8010573d <alltraps>
...
80105cdf:	6a 1f                	push   $0x1f
  jmp alltraps
80105ce1:	e9 57 fa ff ff       	jmp    8010573d <alltraps>
...
80105ce8:	6a 20                	push   $0x20
  jmp alltraps
80105cea:	e9 4e fa ff ff       	jmp    8010573d <alltraps>
...
80105cf1:	6a 21                	push   $0x21
  jmp alltraps
80105cf3:	e9 45 fa ff ff       	jmp    8010573d <alltraps>
...
80105cfa:	6a 22                	push   $0x22
  jmp alltraps
80105cfc:	e9 3c fa ff ff       	jmp    8010573d <alltraps>
...
80105d03:	6a 23                	push   $0x23
  jmp alltraps
80105d05:	e9 33 fa ff ff       	jmp    8010573d <alltraps>
...
80105d0c:	6a 24                	push   $0x24
  jmp alltraps
80105d0e:	e9 2a fa ff ff       	jmp    8010573d <alltraps>
...
80105d15:	6a 25                	push   $0x25
  jmp alltraps
80105d17:	e9 21 fa ff ff       	jmp    8010573d <alltraps>
...
80105d1e:	6a 26                	push   $0x26
  jmp alltraps
80105d20:	e9 18 fa ff ff       	jmp    8010573d <alltraps>
...
80105d27:	6a 27                	push   $0x27
  jmp alltraps
80105d29:	e9 0f fa ff ff       	jmp    8010573d <alltraps>
...
80105d30:	6a 28                	push   $0x28
  jmp alltraps
80105d32:	e9 06 fa ff ff       	jmp    8010573d <alltraps>
...
80105d39:	6a 29                	push   $0x29
  jmp alltraps
80105d3b:	e9 fd f9 ff ff       	jmp    8010573d <alltraps>
...
80105d42:	6a 2a                	push   $0x2a
  jmp alltraps
80105d44:	e9 f4 f9 ff ff       	jmp    8010573d <alltraps>
...
80105d4b:	6a 2b                	push   $0x2b
  jmp alltraps
80105d4d:	e9 eb f9 ff ff       	jmp    8010573d <alltraps>
...
80105d54:	6a 2c                	push   $0x2c
  jmp alltraps
80105d56:	e9 e2 f9 ff ff       	jmp    8010573d <alltraps>
...
80105d5d:	6a 2d                	push   $0x2d
  jmp alltraps
80105d5f:	e9 d9 f9 ff ff       	jmp    8010573d <alltraps>
...
80105d66:	6a 2e                	push   $0x2e
  jmp alltraps
80105d68:	e9 d0 f9 ff ff       	jmp    8010573d <alltraps>
...
80105d6f:	6a 2f                	push   $0x2f
  jmp alltraps
80105d71:	e9 c7 f9 ff ff       	jmp    8010573d <alltraps>
...
80105d78:	6a 30                	push   $0x30
  jmp alltraps
80105d7a:	e9 be f9 ff ff       	jmp    8010573d <alltraps>
...
80105d81:	6a 31                	push   $0x31
  jmp alltraps
80105d83:	e9 b5 f9 ff ff       	jmp    8010573d <alltraps>
...
80105d8a:	6a 32                	push   $0x32
  jmp alltraps
80105d8c:	e9 ac f9 ff ff       	jmp    8010573d <alltraps>
...
80105d93:	6a 33                	push   $0x33
  jmp alltraps
80105d95:	e9 a3 f9 ff ff       	jmp    8010573d <alltraps>
...
80105d9c:	6a 34                	push   $0x34
  jmp alltraps
80105d9e:	e9 9a f9 ff ff       	jmp    8010573d <alltraps>
...
80105da5:	6a 35                	push   $0x35
  jmp alltraps
80105da7:	e9 91 f9 ff ff       	jmp    8010573d <alltraps>
...
80105dae:	6a 36                	push   $0x36
  jmp alltraps
80105db0:	e9 88 f9 ff ff       	jmp    8010573d <alltraps>
...
80105db7:	6a 37                	push   $0x37
  jmp alltraps
80105db9:	e9 7f f9 ff ff       	jmp    8010573d <alltraps>
...
80105dc0:	6a 38                	push   $0x38
  jmp alltraps
80105dc2:	e9 76 f9 ff ff       	jmp    8010573d <alltraps>
...
80105dc9:	6a 39                	push   $0x39
  jmp alltraps
80105dcb:	e9 6d f9 ff ff       	jmp    8010573d <alltraps>
...
80105dd2:	6a 3a                	push   $0x3a
  jmp alltraps
80105dd4:	e9 64 f9 ff ff       	jmp    8010573d <alltraps>
...
80105ddb:	6a 3b                	push   $0x3b
  jmp alltraps
80105ddd:	e9 5b f9 ff ff       	jmp    8010573d <alltraps>
...
80105de4:	6a 3c                	push   $0x3c
  jmp alltraps
80105de6:	e9 52 f9 ff ff       	jmp    8010573d <alltraps>
...
80105ded:	6a 3d                	push   $0x3d
  jmp alltraps
80105def:	e9 49 f9 ff ff       	jmp    8010573d <alltraps>
...
80105df6:	6a 3e                	push   $0x3e
  jmp alltraps
80105df8:	e9 40 f9 ff ff       	jmp    8010573d <alltraps>
...
80105dff:	6a 3f                	push   $0x3f
  jmp alltraps
80105e01:	e9 37 f9 ff ff       	jmp    8010573d <alltraps>
...
80105e08:	6a 40                	push   $0x40
  jmp alltraps
80105e0a:	e9 2e f9 ff ff       	jmp    8010573d <alltraps>
...
80105e11:	6a 41                	push   $0x41
  jmp alltraps
80105e13:	e9 25 f9 ff ff       	jmp    8010573d <alltraps>
...
80105e1a:	6a 42                	push   $0x42
  jmp alltraps
80105e1c:	e9 1c f9 ff ff       	jmp    8010573d <alltraps>
...
80105e23:	6a 43                	push   $0x43
  jmp alltraps
80105e25:	e9 13 f9 ff ff       	jmp    8010573d <alltraps>
...
80105e2c:	6a 44                	push   $0x44
  jmp alltraps
80105e2e:	e9 0a f9 ff ff       	jmp    8010573d <alltraps>
...
80105e35:	6a 45                	push   $0x45
  jmp alltraps
80105e37:	e9 01 f9 ff ff       	jmp    8010573d <alltraps>
...
80105e3e:	6a 46                	push   $0x46
  jmp alltraps
80105e40:	e9 f8 f8 ff ff       	jmp    8010573d <alltraps>
...
80105e47:	6a 47                	push   $0x47
  jmp alltraps
80105e49:	e9 ef f8 ff ff       	jmp    8010573d <alltraps>
...
80105e50:	6a 48                	push   $0x48
  jmp alltraps
80105e52:	e9 e6 f8 ff ff       	jmp    8010573d <alltraps>
...
80105e59:	6a 49                	push   $0x49
  jmp alltraps
80105e5b:	e9 dd f8 ff ff       	jmp    8010573d <alltraps>
...
80105e62:	6a 4a                	push   $0x4a
  jmp alltraps
80105e64:	e9 d4 f8 ff ff       	jmp    8010573d <alltraps>
...
80105e6b:	6a 4b                	push   $0x4b
  jmp alltraps
80105e6d:	e9 cb f8 ff ff       	jmp    8010573d <alltraps>
...
80105e74:	6a 4c                	push   $0x4c
  jmp alltraps
80105e76:	e9 c2 f8 ff ff       	jmp    8010573d <alltraps>
...
80105e7d:	6a 4d                	push   $0x4d
  jmp alltraps
80105e7f:	e9 b9 f8 ff ff       	jmp    8010573d <alltraps>
...
80105e86:	6a 4e                	push   $0x4e
  jmp alltraps
80105e88:	e9 b0 f8 ff ff       	jmp    8010573d <alltraps>
...
80105e8f:	6a 4f                	push   $0x4f
  jmp alltraps
80105e91:	e9 a7 f8 ff ff       	jmp    8010573d <alltraps>
...
80105e98:	6a 50                	push   $0x50
  jmp alltraps
80105e9a:	e9 9e f8 ff ff       	jmp    8010573d <alltraps>
...
80105ea1:	6a 51                	push   $0x51
  jmp alltraps
80105ea3:	e9 95 f8 ff ff       	jmp    8010573d <alltraps>
...
80105eaa:	6a 52                	push   $0x52
  jmp alltraps
80105eac:	e9 8c f8 ff ff       	jmp    8010573d <alltraps>
...
80105eb3:	6a 53                	push   $0x53
  jmp alltraps
80105eb5:	e9 83 f8 ff ff       	jmp    8010573d <alltraps>
...
80105ebc:	6a 54                	push   $0x54
  jmp alltraps
80105ebe:	e9 7a f8 ff ff       	jmp    8010573d <alltraps>
...
80105ec5:	6a 55                	push   $0x55
  jmp alltraps
80105ec7:	e9 71 f8 ff ff       	jmp    8010573d <alltraps>
...
80105ece:	6a 56                	push   $0x56
  jmp alltraps
80105ed0:	e9 68 f8 ff ff       	jmp    8010573d <alltraps>
...
80105ed7:	6a 57                	push   $0x57
  jmp alltraps
80105ed9:	e9 5f f8 ff ff       	jmp    8010573d <alltraps>
...
80105ee0:	6a 58                	push   $0x58
  jmp alltraps
80105ee2:	e9 56 f8 ff ff       	jmp    8010573d <alltraps>
...
80105ee9:	6a 59                	push   $0x59
  jmp alltraps
80105eeb:	e9 4d f8 ff ff       	jmp    8010573d <alltraps>
...
80105ef2:	6a 5a                	push   $0x5a
  jmp alltraps
80105ef4:	e9 44 f8 ff ff       	jmp    8010573d <alltraps>
...
80105efb:	6a 5b                	push   $0x5b
  jmp alltraps
80105efd:	e9 3b f8 ff ff       	jmp    8010573d <alltraps>
...
80105f04:	6a 5c                	push   $0x5c
  jmp alltraps
80105f06:	e9 32 f8 ff ff       	jmp    8010573d <alltraps>
...
80105f0d:	6a 5d                	push   $0x5d
  jmp alltraps
80105f0f:	e9 29 f8 ff ff       	jmp    8010573d <alltraps>
...
80105f16:	6a 5e                	push   $0x5e
  jmp alltraps
80105f18:	e9 20 f8 ff ff       	jmp    8010573d <alltraps>
...
80105f1f:	6a 5f                	push   $0x5f
  jmp alltraps
80105f21:	e9 17 f8 ff ff       	jmp    8010573d <alltraps>
...
80105f28:	6a 60                	push   $0x60
  jmp alltraps
80105f2a:	e9 0e f8 ff ff       	jmp    8010573d <alltraps>
...
80105f31:	6a 61                	push   $0x61
  jmp alltraps
80105f33:	e9 05 f8 ff ff       	jmp    8010573d <alltraps>
...
80105f3a:	6a 62                	push   $0x62
  jmp alltraps
80105f3c:	e9 fc f7 ff ff       	jmp    8010573d <alltraps>
...
80105f43:	6a 63                	push   $0x63
  jmp alltraps
80105f45:	e9 f3 f7 ff ff       	jmp    8010573d <alltraps>
...
80105f4c:	6a 64                	push   $0x64
  jmp alltraps
80105f4e:	e9 ea f7 ff ff       	jmp    8010573d <alltraps>
...
80105f55:	6a 65                	push   $0x65
  jmp alltraps
80105f57:	e9 e1 f7 ff ff       	jmp    8010573d <alltraps>
...
80105f5e:	6a 66                	push   $0x66
  jmp alltraps
80105f60:	e9 d8 f7 ff ff       	jmp    8010573d <alltraps>
...
80105f67:	6a 67                	push   $0x67
  jmp alltraps
80105f69:	e9 cf f7 ff ff       	jmp    8010573d <alltraps>
...
80105f70:	6a 68                	push   $0x68
  jmp alltraps
80105f72:	e9 c6 f7 ff ff       	jmp    8010573d <alltraps>
...
80105f79:	6a 69                	push   $0x69
  jmp alltraps
80105f7b:	e9 bd f7 ff ff       	jmp    8010573d <alltraps>
...
80105f82:	6a 6a                	push   $0x6a
  jmp alltraps
80105f84:	e9 b4 f7 ff ff       	jmp    8010573d <alltraps>
...
80105f8b:	6a 6b                	push   $0x6b
  jmp alltraps
80105f8d:	e9 ab f7 ff ff       	jmp    8010573d <alltraps>
...
80105f94:	6a 6c                	push   $0x6c
  jmp alltraps
80105f96:	e9 a2 f7 ff ff       	jmp    8010573d <alltraps>
...
80105f9d:	6a 6d                	push   $0x6d
  jmp alltraps
80105f9f:	e9 99 f7 ff ff       	jmp    8010573d <alltraps>
...
80105fa6:	6a 6e                	push   $0x6e
  jmp alltraps
80105fa8:	e9 90 f7 ff ff       	jmp    8010573d <alltraps>
...
80105faf:	6a 6f                	push   $0x6f
  jmp alltraps
80105fb1:	e9 87 f7 ff ff       	jmp    8010573d <alltraps>
...
80105fb8:	6a 70                	push   $0x70
  jmp alltraps
80105fba:	e9 7e f7 ff ff       	jmp    8010573d <alltraps>
...
80105fc1:	6a 71                	push   $0x71
  jmp alltraps
80105fc3:	e9 75 f7 ff ff       	jmp    8010573d <alltraps>
...
80105fca:	6a 72                	push   $0x72
  jmp alltraps
80105fcc:	e9 6c f7 ff ff       	jmp    8010573d <alltraps>
...
80105fd3:	6a 73                	push   $0x73
  jmp alltraps
80105fd5:	e9 63 f7 ff ff       	jmp    8010573d <alltraps>
...
80105fdc:	6a 74                	push   $0x74
  jmp alltraps
80105fde:	e9 5a f7 ff ff       	jmp    8010573d <alltraps>
...
80105fe5:	6a 75                	push   $0x75
  jmp alltraps
80105fe7:	e9 51 f7 ff ff       	jmp    8010573d <alltraps>
...
80105fee:	6a 76                	push   $0x76
  jmp alltraps
80105ff0:	e9 48 f7 ff ff       	jmp    8010573d <alltraps>
...
80105ff7:	6a 77                	push   $0x77
  jmp alltraps
80105ff9:	e9 3f f7 ff ff       	jmp    8010573d <alltraps>
...
80106000:	6a 78                	push   $0x78
  jmp alltraps
80106002:	e9 36 f7 ff ff       	jmp    8010573d <alltraps>
...
80106009:	6a 79                	push   $0x79
  jmp alltraps
8010600b:	e9 2d f7 ff ff       	jmp    8010573d <alltraps>
...
80106012:	6a 7a                	push   $0x7a
  jmp alltraps
80106014:	e9 24 f7 ff ff       	jmp    8010573d <alltraps>
...
8010601b:	6a 7b                	push   $0x7b
  jmp alltraps
8010601d:	e9 1b f7 ff ff       	jmp    8010573d <alltraps>
...
80106024:	6a 7c                	push   $0x7c
  jmp alltraps
80106026:	e9 12 f7 ff ff       	jmp    8010573d <alltraps>
...
8010602d:	6a 7d                	push   $0x7d
  jmp alltraps
8010602f:	e9 09 f7 ff ff       	jmp    8010573d <alltraps>
...
80106036:	6a 7e                	push   $0x7e
  jmp alltraps
80106038:	e9 00 f7 ff ff       	jmp    8010573d <alltraps>
...
8010603f:	6a 7f                	push   $0x7f
  jmp alltraps
80106041:	e9 f7 f6 ff ff       	jmp    8010573d <alltraps>
...
80106048:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010604d:	e9 eb f6 ff ff       	jmp    8010573d <alltraps>
...
80106054:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106059:	e9 df f6 ff ff       	jmp    8010573d <alltraps>
...
80106060:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106065:	e9 d3 f6 ff ff       	jmp    8010573d <alltraps>
...
8010606c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106071:	e9 c7 f6 ff ff       	jmp    8010573d <alltraps>
...
80106078:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010607d:	e9 bb f6 ff ff       	jmp    8010573d <alltraps>
...
80106084:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106089:	e9 af f6 ff ff       	jmp    8010573d <alltraps>
...
80106090:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106095:	e9 a3 f6 ff ff       	jmp    8010573d <alltraps>
...
8010609c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801060a1:	e9 97 f6 ff ff       	jmp    8010573d <alltraps>
...
801060a8:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801060ad:	e9 8b f6 ff ff       	jmp    8010573d <alltraps>
...
801060b4:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801060b9:	e9 7f f6 ff ff       	jmp    8010573d <alltraps>
...
801060c0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801060c5:	e9 73 f6 ff ff       	jmp    8010573d <alltraps>
...
801060cc:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801060d1:	e9 67 f6 ff ff       	jmp    8010573d <alltraps>
...
801060d8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801060dd:	e9 5b f6 ff ff       	jmp    8010573d <alltraps>
...
801060e4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801060e9:	e9 4f f6 ff ff       	jmp    8010573d <alltraps>
...
801060f0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801060f5:	e9 43 f6 ff ff       	jmp    8010573d <alltraps>
...
801060fc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106101:	e9 37 f6 ff ff       	jmp    8010573d <alltraps>
...
80106108:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010610d:	e9 2b f6 ff ff       	jmp    8010573d <alltraps>
...
80106114:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106119:	e9 1f f6 ff ff       	jmp    8010573d <alltraps>
...
80106120:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106125:	e9 13 f6 ff ff       	jmp    8010573d <alltraps>
...
8010612c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106131:	e9 07 f6 ff ff       	jmp    8010573d <alltraps>
...
80106138:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010613d:	e9 fb f5 ff ff       	jmp    8010573d <alltraps>
...
80106144:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106149:	e9 ef f5 ff ff       	jmp    8010573d <alltraps>
...
80106150:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106155:	e9 e3 f5 ff ff       	jmp    8010573d <alltraps>
...
8010615c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106161:	e9 d7 f5 ff ff       	jmp    8010573d <alltraps>
...
80106168:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010616d:	e9 cb f5 ff ff       	jmp    8010573d <alltraps>
...
80106174:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106179:	e9 bf f5 ff ff       	jmp    8010573d <alltraps>
...
80106180:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106185:	e9 b3 f5 ff ff       	jmp    8010573d <alltraps>
...
8010618c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106191:	e9 a7 f5 ff ff       	jmp    8010573d <alltraps>
...
80106198:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010619d:	e9 9b f5 ff ff       	jmp    8010573d <alltraps>
...
801061a4:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801061a9:	e9 8f f5 ff ff       	jmp    8010573d <alltraps>
...
801061b0:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801061b5:	e9 83 f5 ff ff       	jmp    8010573d <alltraps>
...
801061bc:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801061c1:	e9 77 f5 ff ff       	jmp    8010573d <alltraps>
...
801061c8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801061cd:	e9 6b f5 ff ff       	jmp    8010573d <alltraps>
...
801061d4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801061d9:	e9 5f f5 ff ff       	jmp    8010573d <alltraps>
...
801061e0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801061e5:	e9 53 f5 ff ff       	jmp    8010573d <alltraps>
...
801061ec:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801061f1:	e9 47 f5 ff ff       	jmp    8010573d <alltraps>
...
801061f8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801061fd:	e9 3b f5 ff ff       	jmp    8010573d <alltraps>
...
80106204:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106209:	e9 2f f5 ff ff       	jmp    8010573d <alltraps>
...
80106210:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106215:	e9 23 f5 ff ff       	jmp    8010573d <alltraps>
...
8010621c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106221:	e9 17 f5 ff ff       	jmp    8010573d <alltraps>
...
80106228:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010622d:	e9 0b f5 ff ff       	jmp    8010573d <alltraps>
...
80106234:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106239:	e9 ff f4 ff ff       	jmp    8010573d <alltraps>
...
80106240:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106245:	e9 f3 f4 ff ff       	jmp    8010573d <alltraps>
...
8010624c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106251:	e9 e7 f4 ff ff       	jmp    8010573d <alltraps>
...
80106258:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010625d:	e9 db f4 ff ff       	jmp    8010573d <alltraps>
...
80106264:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106269:	e9 cf f4 ff ff       	jmp    8010573d <alltraps>
...
80106270:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106275:	e9 c3 f4 ff ff       	jmp    8010573d <alltraps>
...
8010627c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106281:	e9 b7 f4 ff ff       	jmp    8010573d <alltraps>
...
80106288:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010628d:	e9 ab f4 ff ff       	jmp    8010573d <alltraps>
...
80106294:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106299:	e9 9f f4 ff ff       	jmp    8010573d <alltraps>
...
801062a0:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801062a5:	e9 93 f4 ff ff       	jmp    8010573d <alltraps>
...
801062ac:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801062b1:	e9 87 f4 ff ff       	jmp    8010573d <alltraps>
...
801062b8:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801062bd:	e9 7b f4 ff ff       	jmp    8010573d <alltraps>
...
801062c4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801062c9:	e9 6f f4 ff ff       	jmp    8010573d <alltraps>
...
801062d0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801062d5:	e9 63 f4 ff ff       	jmp    8010573d <alltraps>
...
801062dc:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801062e1:	e9 57 f4 ff ff       	jmp    8010573d <alltraps>
...
801062e8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801062ed:	e9 4b f4 ff ff       	jmp    8010573d <alltraps>
...
801062f4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801062f9:	e9 3f f4 ff ff       	jmp    8010573d <alltraps>
...
80106300:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106305:	e9 33 f4 ff ff       	jmp    8010573d <alltraps>
...
8010630c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106311:	e9 27 f4 ff ff       	jmp    8010573d <alltraps>
...
80106318:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010631d:	e9 1b f4 ff ff       	jmp    8010573d <alltraps>
...
80106324:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106329:	e9 0f f4 ff ff       	jmp    8010573d <alltraps>
...
80106330:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106335:	e9 03 f4 ff ff       	jmp    8010573d <alltraps>
...
8010633c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106341:	e9 f7 f3 ff ff       	jmp    8010573d <alltraps>
...
80106348:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010634d:	e9 eb f3 ff ff       	jmp    8010573d <alltraps>
...
80106354:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106359:	e9 df f3 ff ff       	jmp    8010573d <alltraps>
...
80106360:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106365:	e9 d3 f3 ff ff       	jmp    8010573d <alltraps>
...
8010636c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106371:	e9 c7 f3 ff ff       	jmp    8010573d <alltraps>
...
80106378:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010637d:	e9 bb f3 ff ff       	jmp    8010573d <alltraps>
...
80106384:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106389:	e9 af f3 ff ff       	jmp    8010573d <alltraps>
...
80106390:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106395:	e9 a3 f3 ff ff       	jmp    8010573d <alltraps>
...
8010639c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801063a1:	e9 97 f3 ff ff       	jmp    8010573d <alltraps>
...
801063a8:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801063ad:	e9 8b f3 ff ff       	jmp    8010573d <alltraps>
...
801063b4:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801063b9:	e9 7f f3 ff ff       	jmp    8010573d <alltraps>
...
801063c0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801063c5:	e9 73 f3 ff ff       	jmp    8010573d <alltraps>
...
801063cc:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801063d1:	e9 67 f3 ff ff       	jmp    8010573d <alltraps>
...
801063d8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801063dd:	e9 5b f3 ff ff       	jmp    8010573d <alltraps>
...
801063e4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801063e9:	e9 4f f3 ff ff       	jmp    8010573d <alltraps>
...
801063f0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801063f5:	e9 43 f3 ff ff       	jmp    8010573d <alltraps>
...
801063fc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106401:	e9 37 f3 ff ff       	jmp    8010573d <alltraps>
...
80106408:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010640d:	e9 2b f3 ff ff       	jmp    8010573d <alltraps>
...
80106414:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106419:	e9 1f f3 ff ff       	jmp    8010573d <alltraps>
...
80106420:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106425:	e9 13 f3 ff ff       	jmp    8010573d <alltraps>
...
8010642c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106431:	e9 07 f3 ff ff       	jmp    8010573d <alltraps>
...
80106438:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010643d:	e9 fb f2 ff ff       	jmp    8010573d <alltraps>
...
80106444:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106449:	e9 ef f2 ff ff       	jmp    8010573d <alltraps>
...
80106450:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106455:	e9 e3 f2 ff ff       	jmp    8010573d <alltraps>
...
8010645c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106461:	e9 d7 f2 ff ff       	jmp    8010573d <alltraps>
...
80106468:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010646d:	e9 cb f2 ff ff       	jmp    8010573d <alltraps>
...
80106474:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106479:	e9 bf f2 ff ff       	jmp    8010573d <alltraps>
...
80106480:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106485:	e9 b3 f2 ff ff       	jmp    8010573d <alltraps>
...
8010648c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106491:	e9 a7 f2 ff ff       	jmp    8010573d <alltraps>
...
80106498:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010649d:	e9 9b f2 ff ff       	jmp    8010573d <alltraps>
...
801064a4:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801064a9:	e9 8f f2 ff ff       	jmp    8010573d <alltraps>
...
801064b0:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801064b5:	e9 83 f2 ff ff       	jmp    8010573d <alltraps>
...
801064bc:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801064c1:	e9 77 f2 ff ff       	jmp    8010573d <alltraps>
...
801064c8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801064cd:	e9 6b f2 ff ff       	jmp    8010573d <alltraps>
...
801064d4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801064d9:	e9 5f f2 ff ff       	jmp    8010573d <alltraps>
...
801064e0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801064e5:	e9 53 f2 ff ff       	jmp    8010573d <alltraps>
...
801064ec:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801064f1:	e9 47 f2 ff ff       	jmp    8010573d <alltraps>
...
801064f8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801064fd:	e9 3b f2 ff ff       	jmp    8010573d <alltraps>
...
80106504:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106509:	e9 2f f2 ff ff       	jmp    8010573d <alltraps>
...
80106510:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106515:	e9 23 f2 ff ff       	jmp    8010573d <alltraps>
...
8010651c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106521:	e9 17 f2 ff ff       	jmp    8010573d <alltraps>
...
80106528:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010652d:	e9 0b f2 ff ff       	jmp    8010573d <alltraps>
...
80106534:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106539:	e9 ff f1 ff ff       	jmp    8010573d <alltraps>
...
80106540:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106545:	e9 f3 f1 ff ff       	jmp    8010573d <alltraps>
...
8010654c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106551:	e9 e7 f1 ff ff       	jmp    8010573d <alltraps>
...
80106558:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010655d:	e9 db f1 ff ff       	jmp    8010573d <alltraps>
...
80106564:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106569:	e9 cf f1 ff ff       	jmp    8010573d <alltraps>
...
80106570:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106575:	e9 c3 f1 ff ff       	jmp    8010573d <alltraps>
...
8010657c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106581:	e9 b7 f1 ff ff       	jmp    8010573d <alltraps>
...
80106588:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010658d:	e9 ab f1 ff ff       	jmp    8010573d <alltraps>
...
80106594:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106599:	e9 9f f1 ff ff       	jmp    8010573d <alltraps>
...
801065a0:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801065a5:	e9 93 f1 ff ff       	jmp    8010573d <alltraps>
...
801065ac:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801065b1:	e9 87 f1 ff ff       	jmp    8010573d <alltraps>
...
801065b8:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801065bd:	e9 7b f1 ff ff       	jmp    8010573d <alltraps>
...
801065c4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801065c9:	e9 6f f1 ff ff       	jmp    8010573d <alltraps>
...
801065d0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801065d5:	e9 63 f1 ff ff       	jmp    8010573d <alltraps>
...
801065dc:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801065e1:	e9 57 f1 ff ff       	jmp    8010573d <alltraps>
...
801065e8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801065ed:	e9 4b f1 ff ff       	jmp    8010573d <alltraps>
...
801065f4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801065f9:	e9 3f f1 ff ff       	jmp    8010573d <alltraps>
...
80106600:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106605:	e9 33 f1 ff ff       	jmp    8010573d <alltraps>
...
8010660c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106611:	e9 27 f1 ff ff       	jmp    8010573d <alltraps>
...
80106618:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010661d:	e9 1b f1 ff ff       	jmp    8010573d <alltraps>
...
80106624:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106629:	e9 0f f1 ff ff       	jmp    8010573d <alltraps>
...
80106630:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106635:	e9 03 f1 ff ff       	jmp    8010573d <alltraps>
...
8010663c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106641:	e9 f7 f0 ff ff       	jmp    8010573d <alltraps>
...
801066b2:	e8 89 de ff ff       	call   80104540 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106751:	c3                   	ret    
      panic("remap");
80106752:	c7 04 24 30 78 10 80 	movl   $0x80107830,(%esp)
...
801067ea:	c3                   	ret    
        panic("kfree");
801067eb:	c7 04 24 c6 71 10 80 	movl   $0x801071c6,(%esp)
...
80106803:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106806:	e8 75 ce ff ff       	call   80103680 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010680b:	31 c9                	xor    %ecx,%ecx
8010680d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c = &cpus[cpuid()];
80106812:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106818:	05 80 27 11 80       	add    $0x80112780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010681d:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106821:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  lgdt(c->gdt, sizeof(c->gdt));
80106826:	83 c0 70             	add    $0x70,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106829:	66 89 48 0a          	mov    %cx,0xa(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010682d:	31 c9                	xor    %ecx,%ecx
8010682f:	66 89 50 10          	mov    %dx,0x10(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106833:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106838:	66 89 48 12          	mov    %cx,0x12(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010683c:	31 c9                	xor    %ecx,%ecx
8010683e:	66 89 50 18          	mov    %dx,0x18(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106842:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106847:	66 89 48 1a          	mov    %cx,0x1a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010684b:	31 c9                	xor    %ecx,%ecx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010684d:	c6 40 0d 9a          	movb   $0x9a,0xd(%eax)
80106851:	c6 40 0e cf          	movb   $0xcf,0xe(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106855:	c6 40 15 92          	movb   $0x92,0x15(%eax)
80106859:	c6 40 16 cf          	movb   $0xcf,0x16(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010685d:	c6 40 1d fa          	movb   $0xfa,0x1d(%eax)
80106861:	c6 40 1e cf          	movb   $0xcf,0x1e(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106865:	c6 40 25 f2          	movb   $0xf2,0x25(%eax)
80106869:	c6 40 26 cf          	movb   $0xcf,0x26(%eax)
8010686d:	66 89 50 20          	mov    %dx,0x20(%eax)
  pd[0] = size-1;
80106871:	ba 2f 00 00 00       	mov    $0x2f,%edx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106876:	c6 40 0c 00          	movb   $0x0,0xc(%eax)
8010687a:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010687e:	c6 40 14 00          	movb   $0x0,0x14(%eax)
80106882:	c6 40 17 00          	movb   $0x0,0x17(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106886:	c6 40 1c 00          	movb   $0x0,0x1c(%eax)
8010688a:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010688e:	66 89 48 22          	mov    %cx,0x22(%eax)
80106892:	c6 40 24 00          	movb   $0x0,0x24(%eax)
80106896:	c6 40 27 00          	movb   $0x0,0x27(%eax)
8010689a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
8010689e:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
801068a2:	c1 e8 10             	shr    $0x10,%eax
801068a5:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801068a9:	8d 45 f2             	lea    -0xe(%ebp),%eax
801068ac:	0f 01 10             	lgdtl  (%eax)
}
801068af:	c9                   	leave  
801068b0:	c3                   	ret    
801068b1:	eb 0d                	jmp    801068c0 <switchkvm>
801068b3:	90                   	nop
801068b4:	90                   	nop
801068b5:	90                   	nop
801068b6:	90                   	nop
...
80106904:	0f 84 c3 00 00 00    	je     801069cd <switchuvm+0xed>
  pushcli();
8010690a:	e8 81 da ff ff       	call   80104390 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010690f:	e8 ec cc ff ff       	call   80103600 <mycpu>
80106914:	89 c3                	mov    %eax,%ebx
80106916:	e8 e5 cc ff ff       	call   80103600 <mycpu>
8010691b:	89 c7                	mov    %eax,%edi
8010691d:	e8 de cc ff ff       	call   80103600 <mycpu>
80106922:	83 c7 08             	add    $0x8,%edi
80106925:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106928:	e8 d3 cc ff ff       	call   80103600 <mycpu>
8010692d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106930:	ba 67 00 00 00       	mov    $0x67,%edx
80106935:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
8010693c:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106943:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
8010694a:	83 c1 08             	add    $0x8,%ecx
8010694d:	c1 e9 10             	shr    $0x10,%ecx
80106950:	83 c0 08             	add    $0x8,%eax
80106953:	c1 e8 18             	shr    $0x18,%eax
80106956:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
8010695c:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106963:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106969:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
8010696e:	e8 8d cc ff ff       	call   80103600 <mycpu>
80106973:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010697a:	e8 81 cc ff ff       	call   80103600 <mycpu>
8010697f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106984:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106988:	e8 73 cc ff ff       	call   80103600 <mycpu>
8010698d:	8b 56 08             	mov    0x8(%esi),%edx
80106990:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106996:	89 48 0c             	mov    %ecx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106999:	e8 62 cc ff ff       	call   80103600 <mycpu>
...
801069b5:	83 c4 1c             	add    $0x1c,%esp
801069b8:	5b                   	pop    %ebx
801069b9:	5e                   	pop    %esi
801069ba:	5f                   	pop    %edi
801069bb:	5d                   	pop    %ebp
  popcli();
801069bc:	e9 0f da ff ff       	jmp    801043d0 <popcli>
    panic("switchuvm: no process");
801069c1:	c7 04 24 36 78 10 80 	movl   $0x80107836,(%esp)
801069c8:	e8 93 99 ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801069cd:	c7 04 24 61 78 10 80 	movl   $0x80107861,(%esp)
801069d4:	e8 87 99 ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801069d9:	c7 04 24 4c 78 10 80 	movl   $0x8010784c,(%esp)
801069e0:	e8 7b 99 ff ff       	call   80100360 <panic>
801069e5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80106a08:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106a0b:	77 54                	ja     80106a61 <inituvm+0x71>
  mem = kalloc();
80106a0d:	e8 8e ba ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
80106a12:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106a19:	00 
80106a1a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a21:	00 
  mem = kalloc();
80106a22:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106a24:	89 04 24             	mov    %eax,(%esp)
80106a27:	e8 14 db ff ff       	call   80104540 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106a2c:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106a32:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106a37:	89 04 24             	mov    %eax,(%esp)
80106a3a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106a3d:	31 d2                	xor    %edx,%edx
80106a3f:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106a46:	00 
80106a47:	e8 94 fc ff ff       	call   801066e0 <mappages>
  memmove(mem, init, sz);
80106a4c:	89 75 10             	mov    %esi,0x10(%ebp)
80106a4f:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106a52:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80106a5b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106a5c:	e9 7f db ff ff       	jmp    801045e0 <memmove>
    panic("inituvm: more than a page");
80106a61:	c7 04 24 75 78 10 80 	movl   $0x80107875,(%esp)
...
80106a80:	0f 85 98 00 00 00    	jne    80106b1e <loaduvm+0xae>
...
80106a8f:	eb 77                	jmp    80106b08 <loaduvm+0x98>
...
80106ab3:	e8 98 fb ff ff       	call   80106650 <walkpgdir>
80106ab8:	85 c0                	test   %eax,%eax
80106aba:	74 56                	je     80106b12 <loaduvm+0xa2>
    pa = PTE_ADDR(*pte);
80106abc:	8b 00                	mov    (%eax),%eax
      n = PGSIZE;
80106abe:	bf 00 10 00 00       	mov    $0x1000,%edi
80106ac3:	8b 4d 14             	mov    0x14(%ebp),%ecx
    pa = PTE_ADDR(*pte);
80106ac6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
      n = PGSIZE;
80106acb:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
80106ad1:	0f 42 fe             	cmovb  %esi,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106ad4:	05 00 00 00 80       	add    $0x80000000,%eax
80106ad9:	89 44 24 04          	mov    %eax,0x4(%esp)
80106add:	8b 45 10             	mov    0x10(%ebp),%eax
80106ae0:	01 d9                	add    %ebx,%ecx
80106ae2:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106ae6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106aea:	89 04 24             	mov    %eax,(%esp)
80106aed:	e8 6e ae ff ff       	call   80101960 <readi>
80106af2:	39 f8                	cmp    %edi,%eax
80106af4:	74 a2                	je     80106a98 <loaduvm+0x28>
}
80106af6:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80106b08:	83 c4 1c             	add    $0x1c,%esp
  return 0;
...
80106b12:	c7 04 24 8f 78 10 80 	movl   $0x8010788f,(%esp)
80106b19:	e8 42 98 ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
80106b1e:	c7 04 24 30 79 10 80 	movl   $0x80107930,(%esp)
80106b25:	e8 36 98 ff ff       	call   80100360 <panic>
...
80106b3e:	0f 88 7e 00 00 00    	js     80106bc2 <allocuvm+0x92>
  if(newsz < oldsz)
80106b44:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80106b47:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106b4a:	72 78                	jb     80106bc4 <allocuvm+0x94>
  a = PGROUNDUP(oldsz);
80106b4c:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106b52:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106b58:	39 df                	cmp    %ebx,%edi
80106b5a:	77 4a                	ja     80106ba6 <allocuvm+0x76>
80106b5c:	eb 72                	jmp    80106bd0 <allocuvm+0xa0>
...
80106b73:	e8 c8 d9 ff ff       	call   80104540 <memset>
...
80106b89:	89 da                	mov    %ebx,%edx
80106b8b:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106b92:	00 
80106b93:	e8 48 fb ff ff       	call   801066e0 <mappages>
80106b98:	85 c0                	test   %eax,%eax
80106b9a:	78 44                	js     80106be0 <allocuvm+0xb0>
  for(; a < newsz; a += PGSIZE){
80106b9c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106ba2:	39 df                	cmp    %ebx,%edi
80106ba4:	76 2a                	jbe    80106bd0 <allocuvm+0xa0>
    mem = kalloc();
80106ba6:	e8 f5 b8 ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
80106bab:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106bad:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106baf:	75 af                	jne    80106b60 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106bb1:	c7 04 24 ad 78 10 80 	movl   $0x801078ad,(%esp)
80106bb8:	e8 93 9a ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106bbd:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106bc0:	77 48                	ja     80106c0a <allocuvm+0xda>
      return 0;
80106bc2:	31 c0                	xor    %eax,%eax
}
80106bc4:	83 c4 1c             	add    $0x1c,%esp
80106bc7:	5b                   	pop    %ebx
80106bc8:	5e                   	pop    %esi
80106bc9:	5f                   	pop    %edi
80106bca:	5d                   	pop    %ebp
...
80106be0:	c7 04 24 c5 78 10 80 	movl   $0x801078c5,(%esp)
80106be7:	e8 64 9a ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106bec:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106bef:	76 0d                	jbe    80106bfe <allocuvm+0xce>
80106bf1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106bf4:	89 fa                	mov    %edi,%edx
80106bf6:	8b 45 08             	mov    0x8(%ebp),%eax
80106bf9:	e8 62 fb ff ff       	call   80106760 <deallocuvm.part.0>
      kfree(mem);
80106bfe:	89 34 24             	mov    %esi,(%esp)
80106c01:	e8 ea b6 ff ff       	call   801022f0 <kfree>
      return 0;
80106c06:	31 c0                	xor    %eax,%eax
80106c08:	eb ba                	jmp    80106bc4 <allocuvm+0x94>
80106c0a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106c0d:	89 fa                	mov    %edi,%edx
80106c0f:	8b 45 08             	mov    0x8(%ebp),%eax
80106c12:	e8 49 fb ff ff       	call   80106760 <deallocuvm.part.0>
      return 0;
80106c17:	31 c0                	xor    %eax,%eax
80106c19:	eb a9                	jmp    80106bc4 <allocuvm+0x94>
80106c1b:	90                   	nop
...
80106c2e:	73 08                	jae    80106c38 <deallocuvm+0x18>
}
80106c30:	5d                   	pop    %ebp
80106c31:	e9 2a fb ff ff       	jmp    80106760 <deallocuvm.part.0>
80106c36:	66 90                	xchg   %ax,%ax
80106c38:	89 d0                	mov    %edx,%eax
80106c3a:	5d                   	pop    %ebp
80106c3b:	c3                   	ret    
...
80106c48:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
80106c4b:	85 f6                	test   %esi,%esi
80106c4d:	74 59                	je     80106ca8 <freevm+0x68>
80106c4f:	31 c9                	xor    %ecx,%ecx
80106c51:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106c56:	89 f0                	mov    %esi,%eax
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106c58:	31 db                	xor    %ebx,%ebx
80106c5a:	e8 01 fb ff ff       	call   80106760 <deallocuvm.part.0>
80106c5f:	eb 12                	jmp    80106c73 <freevm+0x33>
80106c61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106c68:	83 c3 01             	add    $0x1,%ebx
80106c6b:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106c71:	74 27                	je     80106c9a <freevm+0x5a>
    if(pgdir[i] & PTE_P){
80106c73:	8b 14 9e             	mov    (%esi,%ebx,4),%edx
80106c76:	f6 c2 01             	test   $0x1,%dl
80106c79:	74 ed                	je     80106c68 <freevm+0x28>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106c7b:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  for(i = 0; i < NPDENTRIES; i++){
80106c81:	83 c3 01             	add    $0x1,%ebx
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106c84:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
80106c8a:	89 14 24             	mov    %edx,(%esp)
80106c8d:	e8 5e b6 ff ff       	call   801022f0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
80106c92:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106c98:	75 d9                	jne    80106c73 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
...
80106ca2:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106ca3:	e9 48 b6 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106ca8:	c7 04 24 e1 78 10 80 	movl   $0x801078e1,(%esp)
80106caf:	e8 ac 96 ff ff       	call   80100360 <panic>
...
80106cc8:	e8 d3 b7 ff ff       	call   801024a0 <kalloc>
80106ccd:	85 c0                	test   %eax,%eax
80106ccf:	89 c6                	mov    %eax,%esi
80106cd1:	74 6d                	je     80106d40 <setupkvm+0x80>
  memset(pgdir, 0, PGSIZE);
80106cd3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106cda:	00 
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106cdb:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
80106ce0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ce7:	00 
80106ce8:	89 04 24             	mov    %eax,(%esp)
80106ceb:	e8 50 d8 ff ff       	call   80104540 <memset>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106cf0:	8b 53 0c             	mov    0xc(%ebx),%edx
80106cf3:	8b 43 04             	mov    0x4(%ebx),%eax
80106cf6:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106cf9:	89 54 24 04          	mov    %edx,0x4(%esp)
80106cfd:	8b 13                	mov    (%ebx),%edx
80106cff:	89 04 24             	mov    %eax,(%esp)
80106d02:	29 c1                	sub    %eax,%ecx
80106d04:	89 f0                	mov    %esi,%eax
80106d06:	e8 d5 f9 ff ff       	call   801066e0 <mappages>
80106d0b:	85 c0                	test   %eax,%eax
80106d0d:	78 19                	js     80106d28 <setupkvm+0x68>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106d0f:	83 c3 10             	add    $0x10,%ebx
80106d12:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106d18:	72 d6                	jb     80106cf0 <setupkvm+0x30>
80106d1a:	89 f0                	mov    %esi,%eax
}
...
80106d24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      freevm(pgdir);
80106d28:	89 34 24             	mov    %esi,(%esp)
80106d2b:	e8 10 ff ff ff       	call   80106c40 <freevm>
}
...
80106d42:	eb d8                	jmp    80106d1c <setupkvm+0x5c>
...
80106d53:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106d56:	e8 65 ff ff ff       	call   80106cc0 <setupkvm>
...
80106d7e:	e8 cd f8 ff ff       	call   80106650 <walkpgdir>
  if(pte == 0)
...
80106d8b:	c3                   	ret    
    panic("clearpteu");
80106d8c:	c7 04 24 f2 78 10 80 	movl   $0x801078f2,(%esp)
...
80106da6:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80106da9:	e8 12 ff ff ff       	call   80106cc0 <setupkvm>
80106dae:	85 c0                	test   %eax,%eax
80106db0:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106db3:	0f 84 b9 00 00 00    	je     80106e72 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106dc8:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106dce:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106dd5:	00 
80106dd6:	89 74 24 04          	mov    %esi,0x4(%esp)
80106dda:	89 04 24             	mov    %eax,(%esp)
80106ddd:	e8 fe d7 ff ff       	call   801045e0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106de2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106de5:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106dea:	89 fa                	mov    %edi,%edx
80106dec:	89 44 24 04          	mov    %eax,0x4(%esp)
80106df0:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106df6:	89 04 24             	mov    %eax,(%esp)
80106df9:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106dfc:	e8 df f8 ff ff       	call   801066e0 <mappages>
80106e01:	85 c0                	test   %eax,%eax
80106e03:	78 63                	js     80106e68 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106e05:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106e0b:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106e0e:	76 48                	jbe    80106e58 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106e10:	8b 45 08             	mov    0x8(%ebp),%eax
80106e13:	31 c9                	xor    %ecx,%ecx
80106e15:	89 fa                	mov    %edi,%edx
80106e17:	e8 34 f8 ff ff       	call   80106650 <walkpgdir>
80106e1c:	85 c0                	test   %eax,%eax
80106e1e:	74 62                	je     80106e82 <copyuvm+0xe2>
    if(!(*pte & PTE_P))
80106e20:	8b 00                	mov    (%eax),%eax
80106e22:	a8 01                	test   $0x1,%al
80106e24:	74 50                	je     80106e76 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106e26:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106e28:	25 ff 0f 00 00       	and    $0xfff,%eax
80106e2d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106e30:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106e36:	e8 65 b6 ff ff       	call   801024a0 <kalloc>
80106e3b:	85 c0                	test   %eax,%eax
80106e3d:	89 c3                	mov    %eax,%ebx
80106e3f:	75 87                	jne    80106dc8 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106e41:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106e44:	89 04 24             	mov    %eax,(%esp)
80106e47:	e8 f4 fd ff ff       	call   80106c40 <freevm>
  return 0;
80106e4c:	31 c0                	xor    %eax,%eax
}
80106e4e:	83 c4 2c             	add    $0x2c,%esp
80106e51:	5b                   	pop    %ebx
80106e52:	5e                   	pop    %esi
80106e53:	5f                   	pop    %edi
80106e54:	5d                   	pop    %ebp
80106e55:	c3                   	ret    
80106e56:	66 90                	xchg   %ax,%ax
...
80106e64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80106e68:	89 1c 24             	mov    %ebx,(%esp)
80106e6b:	e8 80 b4 ff ff       	call   801022f0 <kfree>
      goto bad;
80106e70:	eb cf                	jmp    80106e41 <copyuvm+0xa1>
    return 0;
80106e72:	31 c0                	xor    %eax,%eax
80106e74:	eb d8                	jmp    80106e4e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106e76:	c7 04 24 16 79 10 80 	movl   $0x80107916,(%esp)
80106e7d:	e8 de 94 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106e82:	c7 04 24 fc 78 10 80 	movl   $0x801078fc,(%esp)
80106e89:	e8 d2 94 ff ff       	call   80100360 <panic>
...
80106f0c:	e8 cf d6 ff ff       	call   801045e0 <memmove>
    len -= n;
    buf += n;
