...
801000e3:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000e6:	e8 15 43 00 00       	call   80104400 <acquire>
...
80100161:	e8 0a 43 00 00       	call   80104470 <release>
      acquiresleep(&b->lock);
...
80100209:	e8 f2 41 00 00       	call   80104400 <acquire>
  b->refcnt--;
  if (b->refcnt == 0) {
...
8010024f:	5d                   	pop    %ebp
  release(&bcache.lock);
80100250:	e9 1b 42 00 00       	jmp    80104470 <release>
    panic("brelse");
...
8010028e:	e8 6d 41 00 00       	call   80104400 <acquire>
  while(n > 0){
...
80100311:	e8 5a 41 00 00       	call   80104470 <release>
  ilock(ip);
...
8010032f:	e8 3c 41 00 00       	call   80104470 <release>
        ilock(ip);
...
801003af:	e8 fc 3e 00 00       	call   801042b0 <getcallerpcs>
...
801004fc:	e8 5f 40 00 00       	call   80104560 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100518:	00 
80100519:	e8 a2 3f 00 00       	call   801044c0 <memset>
...
8010060e:	e8 ed 3d 00 00       	call   80104400 <acquire>
...
80100636:	e8 35 3e 00 00       	call   80104470 <release>
  ilock(ip);
...
801006f3:	e8 78 3d 00 00       	call   80104470 <release>
}
...
80100797:	e8 64 3c 00 00       	call   80104400 <acquire>
...
801007c5:	e8 36 3c 00 00       	call   80104400 <acquire>
...
80100827:	e8 44 3c 00 00       	call   80104470 <release>
  if(doprocdump) {
...
80100c01:	e8 da 3a 00 00       	call   801046e0 <strlen>
...
80100c12:	e8 c9 3a 00 00       	call   801046e0 <strlen>
...
80100cf1:	e8 aa 39 00 00       	call   801046a0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d65:	e8 26 35 00 00       	call   80104290 <initlock>
}
80100d6a:	c9                   	leave  
80100d6b:	c3                   	ret    
...
80100d83:	e8 78 36 00 00       	call   80104400 <acquire>
...
80100da9:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100db0:	e8 bb 36 00 00       	call   80104470 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dc7:	e8 a4 36 00 00       	call   80104470 <release>
}
...
80100df1:	e8 0a 36 00 00       	call   80104400 <acquire>
  if(f->ref < 1)
...
80100e0a:	e8 61 36 00 00       	call   80104470 <release>
  return f;
}
...
80100e43:	e8 b8 35 00 00       	call   80104400 <acquire>
  if(f->ref < 1)
...
80100e6a:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e6b:	e9 00 36 00 00       	jmp    80104470 <release>
  ff = *f;
...
80100e8c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e8f:	e8 dc 35 00 00       	call   80104470 <release>
  if(ff.type == FD_PIPE)
...
80101278:	e8 43 32 00 00       	call   801044c0 <memset>
  log_write(bp);
...
801012b9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
801012bc:	e8 3f 31 00 00       	call   80104400 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801012f6:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012f9:	e8 72 31 00 00       	call   80104470 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
8010133e:	e8 2d 31 00 00       	call   80104470 <release>
}
...
80101452:	e8 09 31 00 00       	call   80104560 <memmove>
  brelse(bp);
...
801015a9:	e8 12 2f 00 00       	call   801044c0 <memset>
      dip->type = type;
...
8010165f:	00 
80101660:	e8 fb 2e 00 00       	call   80104560 <memmove>
  log_write(bp);
...
80101691:	e8 6a 2d 00 00       	call   80104400 <acquire>
  ip->ref++;
80101696:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010169a:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016a1:	e8 ca 2d 00 00       	call   80104470 <release>
}
...
8010174b:	e8 10 2e 00 00       	call   80104560 <memmove>
    brelse(bp);
...
801017a5:	e8 96 2a 00 00       	call   80104240 <holdingsleep>
...
801017bd:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017be:	e9 3d 2a 00 00       	jmp    80104200 <releasesleep>
    panic("iunlock");
...
801017e2:	e8 b9 29 00 00       	call   801041a0 <acquiresleep>
...
801017f8:	e8 03 2a 00 00       	call   80104200 <releasesleep>
  acquire(&icache.lock);
801017fd:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101804:	e8 f7 2b 00 00       	call   80104400 <acquire>
  ip->ref--;
...
8010181a:	5d                   	pop    %ebp
  release(&icache.lock);
8010181b:	e9 50 2c 00 00       	jmp    80104470 <release>
    acquire(&icache.lock);
80101820:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101827:	e8 d4 2b 00 00       	call   80104400 <acquire>
    int r = ip->ref;
8010182c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010182f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101836:	e8 35 2c 00 00       	call   80104470 <release>
    if(r == 1){
...
80101a08:	e8 53 2b 00 00       	call   80104560 <memmove>
    brelse(bp);
...
80101b04:	e8 57 2a 00 00       	call   80104560 <memmove>
    log_write(bp);
...
80101bab:	e8 30 2a 00 00       	call   801045e0 <strncmp>
}
80101bb0:	c9                   	leave  
80101bb1:	c3                   	ret    
...
80101c29:	e8 b2 29 00 00       	call   801045e0 <strncmp>
      continue;
...
80101ca8:	e8 53 27 00 00       	call   80104400 <acquire>
  ip->ref++;
80101cad:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cb1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cb8:	e8 b3 27 00 00       	call   80104470 <release>
...
80101d1b:	e8 40 28 00 00       	call   80104560 <memmove>
    path++;
...
80101da9:	e8 b2 27 00 00       	call   80104560 <memmove>
    name[len] = 0;
...
80101ea3:	e8 a8 27 00 00       	call   80104650 <strncpy>
  de.inum = inum;
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 46 76 10 80 	movl   $0x80107646,(%esp)
...
80102015:	e8 76 22 00 00       	call   80104290 <initlock>
...
80102090:	e8 6b 23 00 00       	call   80104400 <acquire>
...
801020bc:	e8 ef 1e 00 00       	call   80103fb0 <wakeup>
...
801020d6:	e8 95 23 00 00       	call   80104470 <release>
...
80102130:	e8 0b 21 00 00       	call   80104240 <holdingsleep>
...
80102166:	e8 95 22 00 00       	call   80104400 <acquire>
...
801021c5:	5d                   	pop    %ebp
  release(&idelock);
801021c6:	e9 a5 22 00 00       	jmp    80104470 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
8010232a:	e8 91 21 00 00       	call   801044c0 <memset>
...
801023fa:	e8 91 1e 00 00       	call   80104290 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024cd:	e8 9e 1f 00 00       	call   80104470 <release>
  return (char*)r;
}
...
801024e7:	e8 14 1f 00 00       	call   80104400 <acquire>
...
8010289c:	e8 6f 1c 00 00       	call   80104510 <memcmp>
...
801029c7:	e8 94 1b 00 00       	call   80104560 <memmove>
...
80102a8a:	e8 01 18 00 00       	call   80104290 <initlock>
  readsb(dev, &sb);
...
80102b1d:	e8 de 18 00 00       	call   80104400 <acquire>
...
80102b65:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b6a:	e8 01 19 00 00       	call   80104470 <release>
      break;
    }
  }
}
...
80102b90:	e8 6b 18 00 00       	call   80104400 <acquire>
  log.outstanding -= 1;
...
80102bc8:	00 00 00 
  release(&log.lock);
80102bcb:	e8 a0 18 00 00       	call   80104470 <release>
  if (log.lh.n > 0) {
...
80102c2f:	e8 2c 19 00 00       	call   80104560 <memmove>
...
80102ced:	e8 0e 17 00 00       	call   80104400 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d3e:	5d                   	pop    %ebp
  release(&log.lock);
80102d3f:	e9 2c 17 00 00       	jmp    80104470 <release>
...
80102da7:	e8 d4 29 00 00       	call   80105780 <idtinit>
...
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 96 28 00 00       	call   801056e0 <tvinit>
  binit();         // buffer cache
...
80102e71:	e8 ea 16 00 00       	call   80104560 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f4b:	e8 c0 15 00 00       	call   80104510 <memcmp>
...
80103006:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103009:	e8 02 15 00 00       	call   80104510 <memcmp>
...
801031e6:	80 
801031e7:	e8 a4 10 00 00       	call   80104290 <initlock>
  (*f0)->type = FD_PIPE;
...
80103271:	e8 8a 11 00 00       	call   80104400 <acquire>
  if(writable){
...
8010328d:	e8 1e 0d 00 00       	call   80103fb0 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032ae:	5d                   	pop    %ebp
    release(&p->lock);
801032af:	e9 bc 11 00 00       	jmp    80104470 <release>
...
8010334f:	e8 5c 0c 00 00       	call   80103fb0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
80103382:	e8 e9 10 00 00       	call   80104470 <release>
        return -1;
...
801033ca:	e8 e1 0b 00 00       	call   80103fb0 <wakeup>
  release(&p->lock);
801033cf:	89 1c 24             	mov    %ebx,(%esp)
801033d2:	e8 99 10 00 00       	call   80104470 <release>
  return n;
...
801033f2:	e8 09 10 00 00       	call   80104400 <acquire>
...
8010344b:	e8 20 10 00 00       	call   80104470 <release>
...
801034a5:	e8 06 0b 00 00       	call   80103fb0 <wakeup>
  release(&p->lock);
801034aa:	89 34 24             	mov    %esi,(%esp)
801034ad:	e8 be 0f 00 00       	call   80104470 <release>
}
...
801034d3:	e8 28 0f 00 00       	call   80104400 <acquire>
...
8010350e:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103511:	e8 5a 0f 00 00       	call   80104470 <release>
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 d5 56 10 80 	movl   $0x801056d5,0x14(%eax)
...
8010354a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010354d:	e8 6e 0f 00 00       	call   801044c0 <memset>
...
8010356f:	e8 fc 0e 00 00       	call   80104470 <release>
}
...
8010359d:	e8 ce 0e 00 00       	call   80104470 <release>
...
801035e6:	c7 44 24 04 35 74 10 	movl   $0x80107435,0x4(%esp)
801035ed:	80 
801035ee:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801035f5:	e8 96 0c 00 00       	call   80104290 <initlock>
}
801035fa:	c9                   	leave  
801035fb:	c3                   	ret    
...
8010365a:	c7 04 24 3c 74 10 80 	movl   $0x8010743c,(%esp)
80103661:	e8 fa cc ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103666:	c7 04 24 18 75 10 80 	movl   $0x80107518,(%esp)
...
801036a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036a7:	e8 64 0c 00 00       	call   80104310 <pushcli>
  c = mycpu();
801036ac:	e8 4f ff ff ff       	call   80103600 <mycpu>
  p = c->proc;
801036b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036b7:	e8 94 0c 00 00       	call   80104350 <popcli>
}
...
801036e3:	e8 58 35 00 00       	call   80106c40 <setupkvm>
...
80103705:	80 
80103706:	e8 65 32 00 00       	call   80106970 <inituvm>
  p->sz = PGSIZE;
...
80103727:	e8 94 0d 00 00       	call   801044c0 <memset>
...
80103782:	00 
80103783:	c7 44 24 04 65 74 10 	movl   $0x80107465,0x4(%esp)
8010378a:	80 
8010378b:	89 04 24             	mov    %eax,(%esp)
8010378e:	e8 0d 0f 00 00       	call   801046a0 <safestrcpy>
  p->cwd = namei("/");
80103793:	c7 04 24 6e 74 10 80 	movl   $0x8010746e,(%esp)
...
801037c7:	c7 04 24 4c 74 10 80 	movl   $0x8010744c,(%esp)
...
80103809:	e8 a2 32 00 00       	call   80106ab0 <allocuvm>
...
80103817:	e8 44 30 00 00       	call   80106860 <switchuvm>
  return 0;
...
8010383a:	e8 61 33 00 00       	call   80106ba0 <deallocuvm>
...
8010387e:	e8 9d 34 00 00       	call   80106d20 <copyuvm>
...
80103988:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
8010398d:	e8 6e 0a 00 00       	call   80104400 <acquire>
...
801039b2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039b5:	e8 a6 2e 00 00       	call   80106860 <switchuvm>
...
801039cb:	e8 2b 0d 00 00       	call   801046fb <swtch>
      switchkvm();
801039d0:	e8 6b 2e 00 00       	call   80106840 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801039ef:	e8 7c 0a 00 00       	call   80104470 <release>
  }
...
80103a14:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103a16:	e8 a5 09 00 00       	call   801043c0 <holding>
...
80103a57:	e8 9f 0c 00 00       	call   801046fb <swtch>
  mycpu()->intena = intena;
...
80103a6e:	c7 04 24 70 74 10 80 	movl   $0x80107470,(%esp)
80103a75:	e8 e6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a7a:	c7 04 24 9c 74 10 80 	movl   $0x8010749c,(%esp)
80103a81:	e8 da c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a86:	c7 04 24 8e 74 10 80 	movl   $0x8010748e,(%esp)
80103a8d:	e8 ce c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103a92:	c7 04 24 82 74 10 80 	movl   $0x80107482,(%esp)
...
80103b03:	e8 f8 08 00 00       	call   80104400 <acquire>
...
80103b96:	e8 65 fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103b9b:	c7 04 24 bd 74 10 80 	movl   $0x801074bd,(%esp)
80103ba2:	e8 b9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103ba7:	c7 04 24 b0 74 10 80 	movl   $0x801074b0,(%esp)
...
80103c23:	e8 d8 07 00 00       	call   80104400 <acquire>
  wakeup1(curproc->parent);
...
80103cbc:	e8 3f fd ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103cc1:	c7 04 24 bd 74 10 80 	movl   $0x801074bd,(%esp)
80103cc8:	e8 93 c6 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103ccd:	c7 04 24 b0 74 10 80 	movl   $0x801074b0,(%esp)
...
80103ced:	e8 0e 07 00 00       	call   80104400 <acquire>
...
80103d0a:	e8 61 07 00 00       	call   80104470 <release>
}
80103d0f:	c9                   	leave  
80103d10:	c3                   	ret    
...
80103d51:	e8 aa 06 00 00       	call   80104400 <acquire>
    release(lk);
80103d56:	89 34 24             	mov    %esi,(%esp)
80103d59:	e8 12 07 00 00       	call   80104470 <release>
  p->chan = chan;
...
80103d7b:	e8 f0 06 00 00       	call   80104470 <release>
    acquire(lk);
...
80103d89:	5d                   	pop    %ebp
    acquire(lk);
80103d8a:	e9 71 06 00 00       	jmp    80104400 <acquire>
80103d8f:	90                   	nop
  p->chan = chan;
...
80103dae:	c7 04 24 cf 74 10 80 	movl   $0x801074cf,(%esp)
80103db5:	e8 a6 c5 ff ff       	call   80100360 <panic>
    panic("sleep");
80103dba:	c7 04 24 c9 74 10 80 	movl   $0x801074c9,(%esp)
...
80103de8:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103dea:	e8 11 06 00 00       	call   80104400 <acquire>
    havekids = 0;
...
80103e58:	e8 63 2d 00 00       	call   80106bc0 <freevm>
        release(&ptable.lock);
...
80103e7d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103e84:	e8 e7 05 00 00       	call   80104470 <release>
...
80103ea3:	e8 c8 05 00 00       	call   80104470 <release>
}
...
80103f0c:	75 e5                	jne    80103ef3 <waitpid+0x33>
80103f0e:	66 90                	xchg   %ax,%ax
    if(!havekids || curproc->killed){
80103f10:	85 c0                	test   %eax,%eax
80103f12:	74 78                	je     80103f8c <waitpid+0xcc>
80103f14:	8b 46 24             	mov    0x24(%esi),%eax
80103f17:	85 c0                	test   %eax,%eax
80103f19:	75 71                	jne    80103f8c <waitpid+0xcc>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103f1b:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103f22:	80 
80103f23:	89 34 24             	mov    %esi,(%esp)
80103f26:	e8 f5 fd ff ff       	call   80103d20 <sleep>
  }
80103f2b:	eb b2                	jmp    80103edf <waitpid+0x1f>
        kfree(p->kstack);
...
80103f36:	e8 b5 e3 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
...
80103f48:	e8 73 2c 00 00       	call   80106bc0 <freevm>
        release(&ptable.lock);
...
80103f7b:	74 28                	je     80103fa5 <waitpid+0xe5>
	*waitStatus = p->exitStat;
...
80103fc1:	e8 3a 04 00 00       	call   80104400 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80104003:	5d                   	pop    %ebp
  release(&ptable.lock);
80104004:	e9 67 04 00 00       	jmp    80104470 <release>
...
80104021:	e8 da 03 00 00       	call   80104400 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104053:	e8 18 04 00 00       	call   80104470 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104077:	e8 f4 03 00 00       	call   80104470 <release>
}
...
801040a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
801040a8:	c7 04 24 5f 78 10 80 	movl   $0x8010785f,(%esp)
...
801040ca:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801040cd:	ba e0 74 10 80       	mov    $0x801074e0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040d2:	77 11                	ja     801040e5 <procdump+0x55>
801040d4:	8b 14 85 40 75 10 80 	mov    -0x7fef8ac0(,%eax,4),%edx
      state = "???";
801040db:	b8 e0 74 10 80       	mov    $0x801074e0,%eax
...
801040f0:	c7 04 24 e4 74 10 80 	movl   $0x801074e4,(%esp)
...
8010411c:	e8 8f 01 00 00       	call   801042b0 <getcallerpcs>
...
80104139:	c7 04 24 21 6f 10 80 	movl   $0x80106f21,(%esp)
...
8010416a:	c7 44 24 04 58 75 10 	movl   $0x80107558,0x4(%esp)
80104171:	80 
80104172:	8d 43 04             	lea    0x4(%ebx),%eax
80104175:	89 04 24             	mov    %eax,(%esp)
80104178:	e8 13 01 00 00       	call   80104290 <initlock>
  lk->name = name;
...
801041b1:	e8 4a 02 00 00       	call   80104400 <acquire>
  while (lk->locked) {
...
801041c7:	e8 54 fb ff ff       	call   80103d20 <sleep>
  while (lk->locked) {
...
801041d2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041d8:	e8 c3 f4 ff ff       	call   801036a0 <myproc>
...
801041eb:	5d                   	pop    %ebp
  release(&lk->lk);
801041ec:	e9 7f 02 00 00       	jmp    80104470 <release>
...
80104211:	e8 ea 01 00 00       	call   80104400 <acquire>
  lk->locked = 0;
...
80104233:	5d                   	pop    %ebp
  release(&lk->lk);
80104234:	e9 37 02 00 00       	jmp    80104470 <release>
...
80104244:	31 ff                	xor    %edi,%edi
{
80104246:	56                   	push   %esi
80104247:	53                   	push   %ebx
80104248:	83 ec 1c             	sub    $0x1c,%esp
8010424b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
8010424e:	8d 73 04             	lea    0x4(%ebx),%esi
80104251:	89 34 24             	mov    %esi,(%esp)
80104254:	e8 a7 01 00 00       	call   80104400 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104259:	8b 03                	mov    (%ebx),%eax
8010425b:	85 c0                	test   %eax,%eax
8010425d:	74 13                	je     80104272 <holdingsleep+0x32>
8010425f:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80104262:	e8 39 f4 ff ff       	call   801036a0 <myproc>
80104267:	3b 58 10             	cmp    0x10(%eax),%ebx
8010426a:	0f 94 c0             	sete   %al
8010426d:	0f b6 c0             	movzbl %al,%eax
80104270:	89 c7                	mov    %eax,%edi
  release(&lk->lk);
80104272:	89 34 24             	mov    %esi,(%esp)
80104275:	e8 f6 01 00 00       	call   80104470 <release>
  return r;
}
8010427a:	83 c4 1c             	add    $0x1c,%esp
8010427d:	89 f8                	mov    %edi,%eax
8010427f:	5b                   	pop    %ebx
80104280:	5e                   	pop    %esi
80104281:	5f                   	pop    %edi
80104282:	5d                   	pop    %ebp
...
80104319:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010431a:	e8 e1 f2 ff ff       	call   80103600 <mycpu>
8010431f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104325:	85 c0                	test   %eax,%eax
80104327:	75 11                	jne    8010433a <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
80104329:	e8 d2 f2 ff ff       	call   80103600 <mycpu>
8010432e:	81 e3 00 02 00 00    	and    $0x200,%ebx
80104334:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010433a:	e8 c1 f2 ff ff       	call   80103600 <mycpu>
...
8010435b:	75 49                	jne    801043a6 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
8010435d:	e8 9e f2 ff ff       	call   80103600 <mycpu>
...
80104375:	e8 86 f2 ff ff       	call   80103600 <mycpu>
...
80104386:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104388:	e8 73 f2 ff ff       	call   80103600 <mycpu>
...
80104399:	c3                   	ret    
    panic("popcli");
8010439a:	c7 04 24 7a 75 10 80 	movl   $0x8010757a,(%esp)
801043a1:	e8 ba bf ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
801043a6:	c7 04 24 63 75 10 80 	movl   $0x80107563,(%esp)
...
801043ca:	e8 41 ff ff ff       	call   80104310 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801043cf:	8b 03                	mov    (%ebx),%eax
801043d1:	85 c0                	test   %eax,%eax
801043d3:	74 12                	je     801043e7 <holding+0x27>
801043d5:	8b 5b 08             	mov    0x8(%ebx),%ebx
801043d8:	e8 23 f2 ff ff       	call   80103600 <mycpu>
801043dd:	39 c3                	cmp    %eax,%ebx
801043df:	0f 94 c0             	sete   %al
801043e2:	0f b6 c0             	movzbl %al,%eax
801043e5:	89 c6                	mov    %eax,%esi
  popcli();
801043e7:	e8 64 ff ff ff       	call   80104350 <popcli>
}
801043ec:	89 f0                	mov    %esi,%eax
801043ee:	5b                   	pop    %ebx
801043ef:	5e                   	pop    %esi
801043f0:	5d                   	pop    %ebp
801043f1:	c3                   	ret    
...
80104407:	e8 04 ff ff ff       	call   80104310 <pushcli>
  if(holding(lk))
8010440c:	8b 45 08             	mov    0x8(%ebp),%eax
8010440f:	89 04 24             	mov    %eax,(%esp)
80104412:	e8 a9 ff ff ff       	call   801043c0 <holding>
80104417:	85 c0                	test   %eax,%eax
80104419:	75 3a                	jne    80104455 <acquire+0x55>
  asm volatile("lock; xchgl %0, %1" :
8010441b:	b9 01 00 00 00       	mov    $0x1,%ecx
  while(xchg(&lk->locked, 1) != 0)
80104420:	8b 55 08             	mov    0x8(%ebp),%edx
80104423:	89 c8                	mov    %ecx,%eax
80104425:	f0 87 02             	lock xchg %eax,(%edx)
...
80104432:	e8 c9 f1 ff ff       	call   80103600 <mycpu>
80104437:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
8010443a:	8b 45 08             	mov    0x8(%ebp),%eax
8010443d:	83 c0 0c             	add    $0xc,%eax
80104440:	89 44 24 04          	mov    %eax,0x4(%esp)
80104444:	8d 45 08             	lea    0x8(%ebp),%eax
80104447:	89 04 24             	mov    %eax,(%esp)
8010444a:	e8 61 fe ff ff       	call   801042b0 <getcallerpcs>
}
8010444f:	83 c4 14             	add    $0x14,%esp
80104452:	5b                   	pop    %ebx
80104453:	5d                   	pop    %ebp
80104454:	c3                   	ret    
    panic("acquire");
80104455:	c7 04 24 81 75 10 80 	movl   $0x80107581,(%esp)
8010445c:	e8 ff be ff ff       	call   80100360 <panic>
...
80104477:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
8010447a:	89 1c 24             	mov    %ebx,(%esp)
8010447d:	e8 3e ff ff ff       	call   801043c0 <holding>
80104482:	85 c0                	test   %eax,%eax
80104484:	74 21                	je     801044a7 <release+0x37>
  lk->pcs[0] = 0;
80104486:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
8010448d:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104494:	0f ae f0             	mfence 
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104497:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
8010449d:	83 c4 14             	add    $0x14,%esp
801044a0:	5b                   	pop    %ebx
801044a1:	5d                   	pop    %ebp
  popcli();
801044a2:	e9 a9 fe ff ff       	jmp    80104350 <popcli>
    panic("release");
801044a7:	c7 04 24 89 75 10 80 	movl   $0x80107589,(%esp)
801044ae:	e8 ad be ff ff       	call   80100360 <panic>
801044b3:	66 90                	xchg   %ax,%ax
...
801044c3:	8b 55 08             	mov    0x8(%ebp),%edx
...
80104513:	8b 45 10             	mov    0x10(%ebp),%eax
...
80104521:	8d 78 ff             	lea    -0x1(%eax),%edi
80104524:	74 26                	je     8010454c <memcmp+0x3c>
80104526:	0f b6 03             	movzbl (%ebx),%eax
80104529:	31 d2                	xor    %edx,%edx
8010452b:	0f b6 0e             	movzbl (%esi),%ecx
8010452e:	38 c8                	cmp    %cl,%al
80104530:	74 16                	je     80104548 <memcmp+0x38>
80104532:	eb 24                	jmp    80104558 <memcmp+0x48>
80104534:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104538:	0f b6 44 13 01       	movzbl 0x1(%ebx,%edx,1),%eax
8010453d:	83 c2 01             	add    $0x1,%edx
80104540:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
80104544:	38 c8                	cmp    %cl,%al
80104546:	75 10                	jne    80104558 <memcmp+0x48>
80104548:	39 fa                	cmp    %edi,%edx
...
80104571:	73 35                	jae    801045a8 <memmove+0x48>
80104573:	8d 0c 1e             	lea    (%esi,%ebx,1),%ecx
80104576:	39 c8                	cmp    %ecx,%eax
80104578:	73 2e                	jae    801045a8 <memmove+0x48>
8010457a:	85 db                	test   %ebx,%ebx
8010457c:	8d 3c 18             	lea    (%eax,%ebx,1),%edi
8010457f:	8d 53 ff             	lea    -0x1(%ebx),%edx
80104582:	74 1b                	je     8010459f <memmove+0x3f>
80104584:	f7 db                	neg    %ebx
80104586:	8d 34 19             	lea    (%ecx,%ebx,1),%esi
80104589:	01 fb                	add    %edi,%ebx
8010458b:	90                   	nop
8010458c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104590:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
80104594:	88 0c 13             	mov    %cl,(%ebx,%edx,1)
80104597:	83 ea 01             	sub    $0x1,%edx
8010459a:	83 fa ff             	cmp    $0xffffffff,%edx
8010459d:	75 f1                	jne    80104590 <memmove+0x30>
8010459f:	5b                   	pop    %ebx
801045a0:	5e                   	pop    %esi
801045a1:	5f                   	pop    %edi
801045a2:	5d                   	pop    %ebp
...
801045aa:	85 db                	test   %ebx,%ebx
801045ac:	74 f1                	je     8010459f <memmove+0x3f>
...
801045e8:	8b 4d 08             	mov    0x8(%ebp),%ecx
801045eb:	8b 5d 0c             	mov    0xc(%ebp),%ebx
801045ee:	85 f6                	test   %esi,%esi
801045f0:	74 30                	je     80104622 <strncmp+0x42>
801045f2:	0f b6 01             	movzbl (%ecx),%eax
801045f5:	84 c0                	test   %al,%al
801045f7:	74 2f                	je     80104628 <strncmp+0x48>
801045f9:	0f b6 13             	movzbl (%ebx),%edx
801045fc:	38 d0                	cmp    %dl,%al
801045fe:	75 46                	jne    80104646 <strncmp+0x66>
80104600:	8d 51 01             	lea    0x1(%ecx),%edx
80104603:	01 ce                	add    %ecx,%esi
80104605:	eb 14                	jmp    8010461b <strncmp+0x3b>
80104607:	90                   	nop
80104608:	0f b6 02             	movzbl (%edx),%eax
8010460b:	84 c0                	test   %al,%al
8010460d:	74 31                	je     80104640 <strncmp+0x60>
8010460f:	0f b6 19             	movzbl (%ecx),%ebx
80104612:	83 c2 01             	add    $0x1,%edx
80104615:	38 d8                	cmp    %bl,%al
80104617:	75 17                	jne    80104630 <strncmp+0x50>
80104619:	89 cb                	mov    %ecx,%ebx
8010461b:	39 f2                	cmp    %esi,%edx
8010461d:	8d 4b 01             	lea    0x1(%ebx),%ecx
...
80104626:	5d                   	pop    %ebp
80104627:	c3                   	ret    
80104628:	0f b6 1b             	movzbl (%ebx),%ebx
8010462b:	31 c0                	xor    %eax,%eax
8010462d:	8d 76 00             	lea    0x0(%esi),%esi
80104630:	0f b6 d3             	movzbl %bl,%edx
80104633:	29 d0                	sub    %edx,%eax
80104635:	5b                   	pop    %ebx
80104636:	5e                   	pop    %esi
80104637:	5d                   	pop    %ebp
80104638:	c3                   	ret    
80104639:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104640:	0f b6 5b 01          	movzbl 0x1(%ebx),%ebx
80104644:	eb ea                	jmp    80104630 <strncmp+0x50>
80104646:	89 d3                	mov    %edx,%ebx
80104648:	eb e6                	jmp    80104630 <strncmp+0x50>
...
80104686:	7e 0f                	jle    80104697 <strncpy+0x47>
80104688:	c6 04 0a 00          	movb   $0x0,(%edx,%ecx,1)
8010468c:	89 f3                	mov    %esi,%ebx
8010468e:	83 c1 01             	add    $0x1,%ecx
80104691:	29 cb                	sub    %ecx,%ebx
80104693:	85 db                	test   %ebx,%ebx
80104695:	7f f1                	jg     80104688 <strncpy+0x38>
80104697:	5b                   	pop    %ebx
80104698:	5e                   	pop    %esi
80104699:	5d                   	pop    %ebp
8010469a:	c3                   	ret    
...
80104717:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010471a:	e8 81 ef ff ff       	call   801036a0 <myproc>
...
80104757:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010475a:	e8 41 ef ff ff       	call   801036a0 <myproc>

  if(addr >= curproc->sz)
8010475f:	39 18                	cmp    %ebx,(%eax)
80104761:	76 26                	jbe    80104789 <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
...
8010476e:	73 19                	jae    80104789 <fetchstr+0x39>
    if(*s == 0)
80104770:	80 3b 00             	cmpb   $0x0,(%ebx)
80104773:	75 0d                	jne    80104782 <fetchstr+0x32>
80104775:	eb 21                	jmp    80104798 <fetchstr+0x48>
80104777:	90                   	nop
80104778:	80 3a 00             	cmpb   $0x0,(%edx)
8010477b:	90                   	nop
8010477c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104780:	74 16                	je     80104798 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
80104782:	83 c2 01             	add    $0x1,%edx
80104785:	39 d0                	cmp    %edx,%eax
80104787:	77 ef                	ja     80104778 <fetchstr+0x28>
      return s - *pp;
  }
  return -1;
}
80104789:	83 c4 04             	add    $0x4,%esp
    return -1;
...
801047d2:	5d                   	pop    %ebp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801047d3:	e9 38 ff ff ff       	jmp    80104710 <fetchint>
801047d8:	90                   	nop
...
801047e8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801047eb:	e8 b0 ee ff ff       	call   801036a0 <myproc>
801047f0:	89 c6                	mov    %eax,%esi
 
  if(argint(n, &i) < 0)
801047f2:	8d 45 f4             	lea    -0xc(%ebp),%eax
801047f5:	89 44 24 04          	mov    %eax,0x4(%esp)
801047f9:	8b 45 08             	mov    0x8(%ebp),%eax
801047fc:	89 04 24             	mov    %eax,(%esp)
801047ff:	e8 ac ff ff ff       	call   801047b0 <argint>
...
80104813:	73 1b                	jae    80104830 <argptr+0x50>
80104815:	01 d3                	add    %edx,%ebx
80104817:	39 d8                	cmp    %ebx,%eax
80104819:	72 15                	jb     80104830 <argptr+0x50>
    return -1;
  *pp = (char*)i;
8010481b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010481e:	89 10                	mov    %edx,(%eax)
  return 0;
}
...
80104849:	89 44 24 04          	mov    %eax,0x4(%esp)
8010484d:	8b 45 08             	mov    0x8(%ebp),%eax
80104850:	89 04 24             	mov    %eax,(%esp)
80104853:	e8 58 ff ff ff       	call   801047b0 <argint>
80104858:	85 c0                	test   %eax,%eax
8010485a:	78 14                	js     80104870 <argstr+0x30>
    return -1;
...
80104869:	e8 e2 fe ff ff       	call   80104750 <fetchstr>
}
8010486e:	c9                   	leave  
8010486f:	c3                   	ret    
    return -1;
...
80104885:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104888:	e8 13 ee ff ff       	call   801036a0 <myproc>

  num = curproc->tf->eax;
8010488d:	8b 70 18             	mov    0x18(%eax),%esi
  struct proc *curproc = myproc();
80104890:	89 c3                	mov    %eax,%ebx
  num = curproc->tf->eax;
80104892:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104895:	8d 50 ff             	lea    -0x1(%eax),%edx
80104898:	83 fa 16             	cmp    $0x16,%edx
8010489b:	77 1b                	ja     801048b8 <syscall+0x38>
8010489d:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
801048a4:	85 d2                	test   %edx,%edx
801048a6:	74 10                	je     801048b8 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
801048a8:	ff d2                	call   *%edx
801048aa:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
801048bf:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
801048c3:	8b 43 10             	mov    0x10(%ebx),%eax
801048c6:	c7 04 24 91 75 10 80 	movl   $0x80107591,(%esp)
801048cd:	89 44 24 04          	mov    %eax,0x4(%esp)
801048d1:	e8 7a bd ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
801048d6:	8b 43 18             	mov    0x18(%ebx),%eax
801048d9:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
801048f9:	e8 a2 ed ff ff       	call   801036a0 <myproc>
  ...
  for(fd = 0; fd < NOFILE; fd++){
801048fe:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
80104900:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80104904:	85 c9                	test   %ecx,%ecx
80104906:	74 18                	je     80104920 <fdalloc+0x30>
  for(fd = 0; fd < NOFILE; fd++){
80104908:	83 c2 01             	add    $0x1,%edx
8010490b:	83 fa 10             	cmp    $0x10,%edx
8010490e:	75 f0                	jne    80104900 <fdalloc+0x10>
      curproc->ofile[fd] = f;
      return fd;
    }
  }
...
8010491c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80104920:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
}
80104924:	83 c4 04             	add    $0x4,%esp
      return fd;
80104927:	89 d0                	mov    %edx,%eax
}
80104929:	5b                   	pop    %ebx
8010492a:	5d                   	pop    %ebp
8010492b:	c3                   	ret    
...
80104936:	83 ec 3c             	sub    $0x3c,%esp
80104939:	89 4d d0             	mov    %ecx,-0x30(%ebp)
8010493c:	8b 4d 08             	mov    0x8(%ebp),%ecx
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010493f:	8d 5d da             	lea    -0x26(%ebp),%ebx
80104942:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104946:	89 04 24             	mov    %eax,(%esp)
{
80104949:	89 55 d4             	mov    %edx,-0x2c(%ebp)
8010494c:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010494f:	e8 cc d5 ff ff       	call   80101f20 <nameiparent>
80104954:	85 c0                	test   %eax,%eax
80104956:	89 c7                	mov    %eax,%edi
80104958:	0f 84 da 00 00 00    	je     80104a38 <create+0x108>
    return 0;
  ilock(dp);
8010495e:	89 04 24             	mov    %eax,(%esp)
80104961:	e8 4a cd ff ff       	call   801016b0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104966:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010496d:	00 
8010496e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104972:	89 3c 24             	mov    %edi,(%esp)
80104975:	e8 46 d2 ff ff       	call   80101bc0 <dirlookup>
8010497a:	85 c0                	test   %eax,%eax
8010497c:	89 c6                	mov    %eax,%esi
8010497e:	74 40                	je     801049c0 <create+0x90>
    iunlockput(dp);
80104980:	89 3c 24             	mov    %edi,(%esp)
80104983:	e8 88 cf ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104988:	89 34 24             	mov    %esi,(%esp)
8010498b:	e8 20 cd ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104990:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104995:	75 11                	jne    801049a8 <create+0x78>
80104997:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
8010499c:	89 f0                	mov    %esi,%eax
8010499e:	75 08                	jne    801049a8 <create+0x78>
...
801049ab:	e8 60 cf ff ff       	call   80101910 <iunlockput>
}
...
801049c4:	89 44 24 04          	mov    %eax,0x4(%esp)
801049c8:	8b 07                	mov    (%edi),%eax
801049ca:	89 04 24             	mov    %eax,(%esp)
801049cd:	e8 4e cb ff ff       	call   80101520 <ialloc>
801049d2:	85 c0                	test   %eax,%eax
801049d4:	89 c6                	mov    %eax,%esi
801049d6:	0f 84 bf 00 00 00    	je     80104a9b <create+0x16b>
  ilock(ip);
801049dc:	89 04 24             	mov    %eax,(%esp)
801049df:	e8 cc cc ff ff       	call   801016b0 <ilock>
  ip->major = major;
801049e4:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
801049e8:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
801049ec:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
801049f0:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
801049f4:	b8 01 00 00 00       	mov    $0x1,%eax
801049f9:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
801049fd:	89 34 24             	mov    %esi,(%esp)
80104a00:	e8 eb cb ff ff       	call   801015f0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104a05:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80104a0a:	74 34                	je     80104a40 <create+0x110>
  if(dirlink(dp, name, ip->inum) < 0)
80104a0c:	8b 46 04             	mov    0x4(%esi),%eax
80104a0f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104a13:	89 3c 24             	mov    %edi,(%esp)
80104a16:	89 44 24 08          	mov    %eax,0x8(%esp)
80104a1a:	e8 01 d4 ff ff       	call   80101e20 <dirlink>
80104a1f:	85 c0                	test   %eax,%eax
80104a21:	78 6c                	js     80104a8f <create+0x15f>
  iunlockput(dp);
80104a23:	89 3c 24             	mov    %edi,(%esp)
80104a26:	e8 e5 ce ff ff       	call   80101910 <iunlockput>
}
80104a2b:	83 c4 3c             	add    $0x3c,%esp
  return ip;
80104a2e:	89 f0                	mov    %esi,%eax
}
80104a30:	5b                   	pop    %ebx
80104a31:	5e                   	pop    %esi
80104a32:	5f                   	pop    %edi
...
80104a3a:	e9 61 ff ff ff       	jmp    801049a0 <create+0x70>
80104a3f:	90                   	nop
    dp->nlink++;  // for ".."
80104a40:	66 83 47 56 01       	addw   $0x1,0x56(%edi)
    iupdate(dp);
80104a45:	89 3c 24             	mov    %edi,(%esp)
80104a48:	e8 a3 cb ff ff       	call   801015f0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104a4d:	8b 46 04             	mov    0x4(%esi),%eax
80104a50:	c7 44 24 04 3c 76 10 	movl   $0x8010763c,0x4(%esp)
80104a57:	80 
80104a58:	89 34 24             	mov    %esi,(%esp)
80104a5b:	89 44 24 08          	mov    %eax,0x8(%esp)
80104a5f:	e8 bc d3 ff ff       	call   80101e20 <dirlink>
80104a64:	85 c0                	test   %eax,%eax
80104a66:	78 1b                	js     80104a83 <create+0x153>
80104a68:	8b 47 04             	mov    0x4(%edi),%eax
80104a6b:	c7 44 24 04 3b 76 10 	movl   $0x8010763b,0x4(%esp)
80104a72:	80 
80104a73:	89 34 24             	mov    %esi,(%esp)
80104a76:	89 44 24 08          	mov    %eax,0x8(%esp)
80104a7a:	e8 a1 d3 ff ff       	call   80101e20 <dirlink>
80104a7f:	85 c0                	test   %eax,%eax
80104a81:	79 89                	jns    80104a0c <create+0xdc>
      panic("create dots");
80104a83:	c7 04 24 2f 76 10 80 	movl   $0x8010762f,(%esp)
80104a8a:	e8 d1 b8 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
80104a8f:	c7 04 24 3e 76 10 80 	movl   $0x8010763e,(%esp)
80104a96:	e8 c5 b8 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104a9b:	c7 04 24 20 76 10 80 	movl   $0x80107620,(%esp)
80104aa2:	e8 b9 b8 ff ff       	call   80100360 <panic>
...
80104ab7:	89 d3                	mov    %edx,%ebx
80104ab9:	83 ec 20             	sub    $0x20,%esp
  if(argint(n, &fd) < 0)
80104abc:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104abf:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ac3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104aca:	e8 e1 fc ff ff       	call   801047b0 <argint>
80104acf:	85 c0                	test   %eax,%eax
80104ad1:	78 2d                	js     80104b00 <argfd.constprop.0+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104ad3:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104ad7:	77 27                	ja     80104b00 <argfd.constprop.0+0x50>
80104ad9:	e8 c2 eb ff ff       	call   801036a0 <myproc>
80104ade:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104ae1:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104ae5:	85 c0                	test   %eax,%eax
80104ae7:	74 17                	je     80104b00 <argfd.constprop.0+0x50>
  if(pfd)
80104ae9:	85 f6                	test   %esi,%esi
80104aeb:	74 02                	je     80104aef <argfd.constprop.0+0x3f>
    *pfd = fd;
80104aed:	89 16                	mov    %edx,(%esi)
  if(pf)
80104aef:	85 db                	test   %ebx,%ebx
80104af1:	74 1d                	je     80104b10 <argfd.constprop.0+0x60>
    *pf = f;
80104af3:	89 03                	mov    %eax,(%ebx)
  return 0;
80104af5:	31 c0                	xor    %eax,%eax
}
80104af7:	83 c4 20             	add    $0x20,%esp
80104afa:	5b                   	pop    %ebx
80104afb:	5e                   	pop    %esi
80104afc:	5d                   	pop    %ebp
80104afd:	c3                   	ret    
80104afe:	66 90                	xchg   %ax,%ax
80104b00:	83 c4 20             	add    $0x20,%esp
    return -1;
...
80104b12:	eb e3                	jmp    80104af7 <argfd.constprop.0+0x47>
...
80104b2c:	e8 7f ff ff ff       	call   80104ab0 <argfd.constprop.0>
80104b31:	85 c0                	test   %eax,%eax
80104b33:	78 23                	js     80104b58 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104b35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b38:	e8 b3 fd ff ff       	call   801048f0 <fdalloc>
80104b3d:	85 c0                	test   %eax,%eax
80104b3f:	89 c3                	mov    %eax,%ebx
80104b41:	78 15                	js     80104b58 <sys_dup+0x38>
  filedup(f);
80104b43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b46:	89 04 24             	mov    %eax,(%esp)
80104b49:	e8 92 c2 ff ff       	call   80100de0 <filedup>
  return fd;
...
80104b5d:	eb f1                	jmp    80104b50 <sys_dup+0x30>
80104b5f:	90                   	nop
...
80104ba0:	e8 3b fc ff ff       	call   801047e0 <argptr>
80104ba5:	85 c0                	test   %eax,%eax
80104ba7:	78 1f                	js     80104bc8 <sys_read+0x68>
...
80104c10:	e8 cb fb ff ff       	call   801047e0 <argptr>
80104c15:	85 c0                	test   %eax,%eax
80104c17:	78 1f                	js     80104c38 <sys_write+0x68>
...
80104c43:	83 ec 28             	sub    $0x28,%esp
  if(argfd(0, &fd, &f) < 0)
...
80104c53:	78 23                	js     80104c78 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104c55:	e8 46 ea ff ff       	call   801036a0 <myproc>
80104c5a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104c5d:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104c64:	00 
  fileclose(f);
...
80104c8b:	e8 20 fe ff ff       	call   80104ab0 <argfd.constprop.0>
80104c90:	85 c0                	test   %eax,%eax
80104c92:	78 34                	js     80104cc8 <sys_fstat+0x48>
80104c94:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104c97:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104c9e:	00 
80104c9f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ca3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104caa:	e8 31 fb ff ff       	call   801047e0 <argptr>
80104caf:	85 c0                	test   %eax,%eax
80104cb1:	78 15                	js     80104cc8 <sys_fstat+0x48>
  return filestat(f, st);
80104cb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cb6:	89 44 24 04          	mov    %eax,0x4(%esp)
80104cba:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cbd:	89 04 24             	mov    %eax,(%esp)
80104cc0:	e8 2b c2 ff ff       	call   80100ef0 <filestat>
}
80104cc5:	c9                   	leave  
80104cc6:	c3                   	ret    
80104cc7:	90                   	nop
...
80104cd6:	83 ec 3c             	sub    $0x3c,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80104cd9:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80104cdc:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ce0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104ce7:	e8 54 fb ff ff       	call   80104840 <argstr>
80104cec:	85 c0                	test   %eax,%eax
80104cee:	0f 88 e6 00 00 00    	js     80104dda <sys_link+0x10a>
80104cf4:	8d 45 d0             	lea    -0x30(%ebp),%eax
80104cf7:	89 44 24 04          	mov    %eax,0x4(%esp)
80104cfb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104d02:	e8 39 fb ff ff       	call   80104840 <argstr>
80104d07:	85 c0                	test   %eax,%eax
80104d09:	0f 88 cb 00 00 00    	js     80104dda <sys_link+0x10a>
  begin_op();
80104d0f:	e8 fc dd ff ff       	call   80102b10 <begin_op>
  if((ip = namei(old)) == 0){
80104d14:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104d17:	89 04 24             	mov    %eax,(%esp)
80104d1a:	e8 e1 d1 ff ff       	call   80101f00 <namei>
80104d1f:	85 c0                	test   %eax,%eax
80104d21:	89 c3                	mov    %eax,%ebx
80104d23:	0f 84 ac 00 00 00    	je     80104dd5 <sys_link+0x105>
  ilock(ip);
80104d29:	89 04 24             	mov    %eax,(%esp)
80104d2c:	e8 7f c9 ff ff       	call   801016b0 <ilock>
  if(ip->type == T_DIR){
80104d31:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104d36:	0f 84 91 00 00 00    	je     80104dcd <sys_link+0xfd>
  ip->nlink++;
80104d3c:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80104d41:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80104d44:	89 1c 24             	mov    %ebx,(%esp)
80104d47:	e8 a4 c8 ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
80104d4c:	89 1c 24             	mov    %ebx,(%esp)
80104d4f:	e8 3c ca ff ff       	call   80101790 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104d54:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104d57:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104d5b:	89 04 24             	mov    %eax,(%esp)
80104d5e:	e8 bd d1 ff ff       	call   80101f20 <nameiparent>
80104d63:	85 c0                	test   %eax,%eax
80104d65:	89 c6                	mov    %eax,%esi
80104d67:	74 4f                	je     80104db8 <sys_link+0xe8>
  ilock(dp);
80104d69:	89 04 24             	mov    %eax,(%esp)
80104d6c:	e8 3f c9 ff ff       	call   801016b0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104d71:	8b 03                	mov    (%ebx),%eax
80104d73:	39 06                	cmp    %eax,(%esi)
80104d75:	75 39                	jne    80104db0 <sys_link+0xe0>
...
80104d85:	e8 96 d0 ff ff       	call   80101e20 <dirlink>
80104d8a:	85 c0                	test   %eax,%eax
80104d8c:	78 22                	js     80104db0 <sys_link+0xe0>
  iunlockput(dp);
80104d8e:	89 34 24             	mov    %esi,(%esp)
80104d91:	e8 7a cb ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104d96:	89 1c 24             	mov    %ebx,(%esp)
80104d99:	e8 32 ca ff ff       	call   801017d0 <iput>
  end_op();
80104d9e:	e8 dd dd ff ff       	call   80102b80 <end_op>
}
80104da3:	83 c4 3c             	add    $0x3c,%esp
  return 0;
80104da6:	31 c0                	xor    %eax,%eax
}
80104da8:	5b                   	pop    %ebx
80104da9:	5e                   	pop    %esi
80104daa:	5f                   	pop    %edi
...
80104dad:	8d 76 00             	lea    0x0(%esi),%esi
    iunlockput(dp);
80104db0:	89 34 24             	mov    %esi,(%esp)
80104db3:	e8 58 cb ff ff       	call   80101910 <iunlockput>
  ilock(ip);
80104db8:	89 1c 24             	mov    %ebx,(%esp)
80104dbb:	e8 f0 c8 ff ff       	call   801016b0 <ilock>
  ip->nlink--;
...
80104dda:	83 c4 3c             	add    $0x3c,%esp
  return -1;
...
80104df6:	83 ec 5c             	sub    $0x5c,%esp
  if(argstr(0, &path) < 0)
80104df9:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104dfc:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e00:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104e07:	e8 34 fa ff ff       	call   80104840 <argstr>
80104e0c:	85 c0                	test   %eax,%eax
80104e0e:	0f 88 76 01 00 00    	js     80104f8a <sys_unlink+0x19a>
  begin_op();
80104e14:	e8 f7 dc ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104e19:	8b 45 c0             	mov    -0x40(%ebp),%eax
80104e1c:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80104e1f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104e23:	89 04 24             	mov    %eax,(%esp)
80104e26:	e8 f5 d0 ff ff       	call   80101f20 <nameiparent>
80104e2b:	85 c0                	test   %eax,%eax
80104e2d:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80104e30:	0f 84 4f 01 00 00    	je     80104f85 <sys_unlink+0x195>
  ilock(dp);
80104e36:	8b 75 b4             	mov    -0x4c(%ebp),%esi
80104e39:	89 34 24             	mov    %esi,(%esp)
80104e3c:	e8 6f c8 ff ff       	call   801016b0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104e41:	c7 44 24 04 3c 76 10 	movl   $0x8010763c,0x4(%esp)
80104e48:	80 
80104e49:	89 1c 24             	mov    %ebx,(%esp)
80104e4c:	e8 3f cd ff ff       	call   80101b90 <namecmp>
80104e51:	85 c0                	test   %eax,%eax
80104e53:	0f 84 21 01 00 00    	je     80104f7a <sys_unlink+0x18a>
80104e59:	c7 44 24 04 3b 76 10 	movl   $0x8010763b,0x4(%esp)
80104e60:	80 
80104e61:	89 1c 24             	mov    %ebx,(%esp)
80104e64:	e8 27 cd ff ff       	call   80101b90 <namecmp>
80104e69:	85 c0                	test   %eax,%eax
80104e6b:	0f 84 09 01 00 00    	je     80104f7a <sys_unlink+0x18a>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104e71:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104e74:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104e78:	89 44 24 08          	mov    %eax,0x8(%esp)
80104e7c:	89 34 24             	mov    %esi,(%esp)
80104e7f:	e8 3c cd ff ff       	call   80101bc0 <dirlookup>
80104e84:	85 c0                	test   %eax,%eax
80104e86:	89 c3                	mov    %eax,%ebx
80104e88:	0f 84 ec 00 00 00    	je     80104f7a <sys_unlink+0x18a>
  ilock(ip);
80104e8e:	89 04 24             	mov    %eax,(%esp)
80104e91:	e8 1a c8 ff ff       	call   801016b0 <ilock>
  if(ip->nlink < 1)
80104e96:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104e9b:	0f 8e 24 01 00 00    	jle    80104fc5 <sys_unlink+0x1d5>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104ea1:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104ea6:	8d 75 d8             	lea    -0x28(%ebp),%esi
80104ea9:	74 7d                	je     80104f28 <sys_unlink+0x138>
  memset(&de, 0, sizeof(de));
80104eab:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104eb2:	00 
80104eb3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104eba:	00 
80104ebb:	89 34 24             	mov    %esi,(%esp)
80104ebe:	e8 fd f5 ff ff       	call   801044c0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104ec3:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80104ec6:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104ecd:	00 
80104ece:	89 74 24 04          	mov    %esi,0x4(%esp)
80104ed2:	89 44 24 08          	mov    %eax,0x8(%esp)
80104ed6:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104ed9:	89 04 24             	mov    %eax,(%esp)
80104edc:	e8 7f cb ff ff       	call   80101a60 <writei>
80104ee1:	83 f8 10             	cmp    $0x10,%eax
80104ee4:	0f 85 cf 00 00 00    	jne    80104fb9 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
80104eea:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104eef:	0f 84 a3 00 00 00    	je     80104f98 <sys_unlink+0x1a8>
  iunlockput(dp);
80104ef5:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104ef8:	89 04 24             	mov    %eax,(%esp)
80104efb:	e8 10 ca ff ff       	call   80101910 <iunlockput>
  ip->nlink--;
80104f00:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104f05:	89 1c 24             	mov    %ebx,(%esp)
80104f08:	e8 e3 c6 ff ff       	call   801015f0 <iupdate>
  iunlockput(ip);
...
80104f28:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
80104f2c:	0f 86 79 ff ff ff    	jbe    80104eab <sys_unlink+0xbb>
80104f32:	bf 20 00 00 00       	mov    $0x20,%edi
80104f37:	eb 15                	jmp    80104f4e <sys_unlink+0x15e>
80104f39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104f40:	8d 57 10             	lea    0x10(%edi),%edx
80104f43:	3b 53 58             	cmp    0x58(%ebx),%edx
80104f46:	0f 83 5f ff ff ff    	jae    80104eab <sys_unlink+0xbb>
80104f4c:	89 d7                	mov    %edx,%edi
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104f4e:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104f55:	00 
80104f56:	89 7c 24 08          	mov    %edi,0x8(%esp)
80104f5a:	89 74 24 04          	mov    %esi,0x4(%esp)
80104f5e:	89 1c 24             	mov    %ebx,(%esp)
80104f61:	e8 fa c9 ff ff       	call   80101960 <readi>
80104f66:	83 f8 10             	cmp    $0x10,%eax
80104f69:	75 42                	jne    80104fad <sys_unlink+0x1bd>
    if(de.inum != 0)
80104f6b:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80104f70:	74 ce                	je     80104f40 <sys_unlink+0x150>
    iunlockput(ip);
80104f72:	89 1c 24             	mov    %ebx,(%esp)
80104f75:	e8 96 c9 ff ff       	call   80101910 <iunlockput>
  iunlockput(dp);
80104f7a:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104f7d:	89 04 24             	mov    %eax,(%esp)
80104f80:	e8 8b c9 ff ff       	call   80101910 <iunlockput>
  end_op();
80104f85:	e8 f6 db ff ff       	call   80102b80 <end_op>
}
...
80104f9b:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
80104fa0:	89 04 24             	mov    %eax,(%esp)
80104fa3:	e8 48 c6 ff ff       	call   801015f0 <iupdate>
80104fa8:	e9 48 ff ff ff       	jmp    80104ef5 <sys_unlink+0x105>
      panic("isdirempty: readi");
80104fad:	c7 04 24 60 76 10 80 	movl   $0x80107660,(%esp)
80104fb4:	e8 a7 b3 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104fb9:	c7 04 24 72 76 10 80 	movl   $0x80107672,(%esp)
80104fc0:	e8 9b b3 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104fc5:	c7 04 24 4e 76 10 80 	movl   $0x8010764e,(%esp)
80104fcc:	e8 8f b3 ff ff       	call   80100360 <panic>
...
80104fe6:	83 ec 2c             	sub    $0x2c,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80104fe9:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104fec:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ff0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104ff7:	e8 44 f8 ff ff       	call   80104840 <argstr>
80104ffc:	85 c0                	test   %eax,%eax
80104ffe:	0f 88 d1 00 00 00    	js     801050d5 <sys_open+0xf5>
80105004:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105007:	89 44 24 04          	mov    %eax,0x4(%esp)
8010500b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105012:	e8 99 f7 ff ff       	call   801047b0 <argint>
80105017:	85 c0                	test   %eax,%eax
80105019:	0f 88 b6 00 00 00    	js     801050d5 <sys_open+0xf5>
    return -1;
...
8010501f:	e8 ec da ff ff       	call   80102b10 <begin_op>
  ...
  if(omode & O_CREATE){
80105024:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105028:	0f 85 82 00 00 00    	jne    801050b0 <sys_open+0xd0>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105034:	e8 c7 ce ff ff       	call   80101f00 <namei>
80105039:	85 c0                	test   %eax,%eax
8010503b:	89 c6                	mov    %eax,%esi
8010503d:	0f 84 8d 00 00 00    	je     801050d0 <sys_open+0xf0>
      end_op();
      return -1;
    }
    ilock(ip);
80105043:	89 04 24             	mov    %eax,(%esp)
80105046:	e8 65 c6 ff ff       	call   801016b0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010504b:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105050:	0f 84 92 00 00 00    	je     801050e8 <sys_open+0x108>
      end_op();
      return -1;
    }
  }
...
8010505f:	0f 84 93 00 00 00    	je     801050f8 <sys_open+0x118>
80105065:	e8 86 f8 ff ff       	call   801048f0 <fdalloc>
8010506a:	85 c0                	test   %eax,%eax
8010506c:	89 c7                	mov    %eax,%edi
8010506e:	0f 88 94 00 00 00    	js     80105108 <sys_open+0x128>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
80105074:	89 34 24             	mov    %esi,(%esp)
80105077:	e8 14 c7 ff ff       	call   80101790 <iunlock>
  end_op();
8010507c:	e8 ff da ff ff       	call   80102b80 <end_op>

  f->type = FD_INODE;
80105081:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105087:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  f->ip = ip;
8010508a:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
8010508d:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80105094:	89 c2                	mov    %eax,%edx
80105096:	83 e2 01             	and    $0x1,%edx
80105099:	83 f2 01             	xor    $0x1,%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010509c:	a8 03                	test   $0x3,%al
  f->readable = !(omode & O_WRONLY);
8010509e:	88 53 08             	mov    %dl,0x8(%ebx)
  return fd;
801050a1:	89 f8                	mov    %edi,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801050a3:	0f 95 43 09          	setne  0x9(%ebx)
}
801050a7:	83 c4 2c             	add    $0x2c,%esp
801050aa:	5b                   	pop    %ebx
801050ab:	5e                   	pop    %esi
801050ac:	5f                   	pop    %edi
801050ad:	5d                   	pop    %ebp
...
801050b0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801050b3:	31 c9                	xor    %ecx,%ecx
801050b5:	ba 02 00 00 00       	mov    $0x2,%edx
801050ba:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801050c1:	e8 6a f8 ff ff       	call   80104930 <create>
    if(ip == 0){
801050c6:	85 c0                	test   %eax,%eax
    ip = create(path, T_FILE, 0, 0);
801050c8:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801050ca:	75 8a                	jne    80105056 <sys_open+0x76>
...
801050ed:	0f 84 63 ff ff ff    	je     80105056 <sys_open+0x76>
801050f3:	90                   	nop
801050f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    iunlockput(ip);
801050f8:	89 34 24             	mov    %esi,(%esp)
801050fb:	e8 10 c8 ff ff       	call   80101910 <iunlockput>
80105100:	eb ce                	jmp    801050d0 <sys_open+0xf0>
80105102:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      fileclose(f);
80105108:	89 1c 24             	mov    %ebx,(%esp)
8010510b:	e8 20 bd ff ff       	call   80100e30 <fileclose>
80105110:	eb e6                	jmp    801050f8 <sys_open+0x118>
...
80105123:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105126:	e8 e5 d9 ff ff       	call   80102b10 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
8010512b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010512e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105132:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105139:	e8 02 f7 ff ff       	call   80104840 <argstr>
8010513e:	85 c0                	test   %eax,%eax
80105140:	78 2e                	js     80105170 <sys_mkdir+0x50>
80105142:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105145:	31 c9                	xor    %ecx,%ecx
80105147:	ba 01 00 00 00       	mov    $0x1,%edx
8010514c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105153:	e8 d8 f7 ff ff       	call   80104930 <create>
80105158:	85 c0                	test   %eax,%eax
8010515a:	74 14                	je     80105170 <sys_mkdir+0x50>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
8010515f:	e8 ac c7 ff ff       	call   80101910 <iunlockput>
  end_op();
80105164:	e8 17 da ff ff       	call   80102b80 <end_op>
  return 0;
...
8010516d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80105170:	e8 0b da ff ff       	call   80102b80 <end_op>
    return -1;
...
80105183:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105186:	e8 85 d9 ff ff       	call   80102b10 <begin_op>
  if((argstr(0, &path)) < 0 ||
8010518b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010518e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105192:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105199:	e8 a2 f6 ff ff       	call   80104840 <argstr>
8010519e:	85 c0                	test   %eax,%eax
801051a0:	78 5e                	js     80105200 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
801051a2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801051a5:	89 44 24 04          	mov    %eax,0x4(%esp)
801051a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801051b0:	e8 fb f5 ff ff       	call   801047b0 <argint>
  if((argstr(0, &path)) < 0 ||
801051b5:	85 c0                	test   %eax,%eax
801051b7:	78 47                	js     80105200 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
801051b9:	8d 45 f4             	lea    -0xc(%ebp),%eax
801051bc:	89 44 24 04          	mov    %eax,0x4(%esp)
801051c0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801051c7:	e8 e4 f5 ff ff       	call   801047b0 <argint>
     argint(1, &major) < 0 ||
801051cc:	85 c0                	test   %eax,%eax
801051ce:	78 30                	js     80105200 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
801051d0:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
     argint(2, &minor) < 0 ||
801051d4:	ba 03 00 00 00       	mov    $0x3,%edx
     (ip = create(path, T_DEV, major, minor)) == 0){
801051d9:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
801051dd:	89 04 24             	mov    %eax,(%esp)
     argint(2, &minor) < 0 ||
801051e0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801051e3:	e8 48 f7 ff ff       	call   80104930 <create>
801051e8:	85 c0                	test   %eax,%eax
801051ea:	74 14                	je     80105200 <sys_mknod+0x80>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
801051ef:	e8 1c c7 ff ff       	call   80101910 <iunlockput>
  end_op();
801051f4:	e8 87 d9 ff ff       	call   80102b80 <end_op>
  return 0;
...
80105215:	83 ec 20             	sub    $0x20,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80105218:	e8 83 e4 ff ff       	call   801036a0 <myproc>
8010521d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010521f:	e8 ec d8 ff ff       	call   80102b10 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105224:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105227:	89 44 24 04          	mov    %eax,0x4(%esp)
8010522b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105232:	e8 09 f6 ff ff       	call   80104840 <argstr>
80105237:	85 c0                	test   %eax,%eax
80105239:	78 4a                	js     80105285 <sys_chdir+0x75>
8010523b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010523e:	89 04 24             	mov    %eax,(%esp)
80105241:	e8 ba cc ff ff       	call   80101f00 <namei>
80105246:	85 c0                	test   %eax,%eax
80105248:	89 c3                	mov    %eax,%ebx
8010524a:	74 39                	je     80105285 <sys_chdir+0x75>
    end_op();
    return -1;
  }
  ilock(ip);
8010524c:	89 04 24             	mov    %eax,(%esp)
8010524f:	e8 5c c4 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
80105254:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
    iunlockput(ip);
80105259:	89 1c 24             	mov    %ebx,(%esp)
  if(ip->type != T_DIR){
8010525c:	75 22                	jne    80105280 <sys_chdir+0x70>
    end_op();
    return -1;
  }
  iunlock(ip);
8010525e:	e8 2d c5 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105263:	8b 46 68             	mov    0x68(%esi),%eax
80105266:	89 04 24             	mov    %eax,(%esp)
80105269:	e8 62 c5 ff ff       	call   801017d0 <iput>
  end_op();
8010526e:	e8 0d d9 ff ff       	call   80102b80 <end_op>
  curproc->cwd = ip;
  return 0;
80105273:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
80105275:	89 5e 68             	mov    %ebx,0x68(%esi)
}
80105278:	83 c4 20             	add    $0x20,%esp
8010527b:	5b                   	pop    %ebx
8010527c:	5e                   	pop    %esi
8010527d:	5d                   	pop    %ebp
8010527e:	c3                   	ret    
8010527f:	90                   	nop
    iunlockput(ip);
80105280:	e8 8b c6 ff ff       	call   80101910 <iunlockput>
    end_op();
80105285:	e8 f6 d8 ff ff       	call   80102b80 <end_op>
}
8010528a:	83 c4 20             	add    $0x20,%esp
    return -1;
...
801052a6:	81 ec ac 00 00 00    	sub    $0xac,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801052ac:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
801052b2:	89 44 24 04          	mov    %eax,0x4(%esp)
801052b6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801052bd:	e8 7e f5 ff ff       	call   80104840 <argstr>
801052c2:	85 c0                	test   %eax,%eax
801052c4:	0f 88 84 00 00 00    	js     8010534e <sys_exec+0xae>
801052ca:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
801052d0:	89 44 24 04          	mov    %eax,0x4(%esp)
801052d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801052db:	e8 d0 f4 ff ff       	call   801047b0 <argint>
801052e0:	85 c0                	test   %eax,%eax
801052e2:	78 6a                	js     8010534e <sys_exec+0xae>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
801052e4:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
801052ea:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
801052ec:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801052f3:	00 
801052f4:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
801052fa:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105301:	00 
80105302:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105308:	89 04 24             	mov    %eax,(%esp)
8010530b:	e8 b0 f1 ff ff       	call   801044c0 <memset>
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105310:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105316:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010531a:	8d 04 98             	lea    (%eax,%ebx,4),%eax
8010531d:	89 04 24             	mov    %eax,(%esp)
80105320:	e8 eb f3 ff ff       	call   80104710 <fetchint>
80105325:	85 c0                	test   %eax,%eax
80105327:	78 25                	js     8010534e <sys_exec+0xae>
      return -1;
    if(uarg == 0){
80105329:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010532f:	85 c0                	test   %eax,%eax
80105331:	74 2d                	je     80105360 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105333:	89 74 24 04          	mov    %esi,0x4(%esp)
80105337:	89 04 24             	mov    %eax,(%esp)
8010533a:	e8 11 f4 ff ff       	call   80104750 <fetchstr>
8010533f:	85 c0                	test   %eax,%eax
80105341:	78 0b                	js     8010534e <sys_exec+0xae>
  for(i=0;; i++){
80105343:	83 c3 01             	add    $0x1,%ebx
80105346:	83 c6 04             	add    $0x4,%esi
    if(i >= NELEM(argv))
80105349:	83 fb 20             	cmp    $0x20,%ebx
8010534c:	75 c2                	jne    80105310 <sys_exec+0x70>
      return -1;
  }
  return exec(path, argv);
}
8010534e:	81 c4 ac 00 00 00    	add    $0xac,%esp
    return -1;
...
8010536a:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
      argv[i] = 0;
80105370:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105377:	00 00 00 00 
  return exec(path, argv);
8010537b:	89 04 24             	mov    %eax,(%esp)
8010537e:	e8 1d b6 ff ff       	call   801009a0 <exec>
}
80105383:	81 c4 ac 00 00 00    	add    $0xac,%esp
80105389:	5b                   	pop    %ebx
8010538a:	5e                   	pop    %esi
8010538b:	5f                   	pop    %edi
8010538c:	5d                   	pop    %ebp
...
8010539a:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801053a1:	00 
801053a2:	89 44 24 04          	mov    %eax,0x4(%esp)
801053a6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801053ad:	e8 2e f4 ff ff       	call   801047e0 <argptr>
801053b2:	85 c0                	test   %eax,%eax
801053b4:	78 6d                	js     80105423 <sys_pipe+0x93>
    return -1;
...
801053c3:	e8 a8 dd ff ff       	call   80103170 <pipealloc>
801053c8:	85 c0                	test   %eax,%eax
801053ca:	78 57                	js     80105423 <sys_pipe+0x93>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801053cc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053cf:	e8 1c f5 ff ff       	call   801048f0 <fdalloc>
801053d4:	85 c0                	test   %eax,%eax
801053d6:	89 c3                	mov    %eax,%ebx
801053d8:	78 33                	js     8010540d <sys_pipe+0x7d>
801053da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053dd:	e8 0e f5 ff ff       	call   801048f0 <fdalloc>
801053e2:	85 c0                	test   %eax,%eax
801053e4:	78 1a                	js     80105400 <sys_pipe+0x70>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
801053e9:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
801053eb:	8b 55 ec             	mov    -0x14(%ebp),%edx
801053ee:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
}
801053f1:	83 c4 24             	add    $0x24,%esp
  return 0;
...
80105405:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
8010540c:	00 
    fileclose(rf);
8010540d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105410:	89 04 24             	mov    %eax,(%esp)
80105413:	e8 18 ba ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
80105418:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010541b:	89 04 24             	mov    %eax,(%esp)
8010541e:	e8 0d ba ff ff       	call   80100e30 <fileclose>
}
...
80105433:	5d                   	pop    %ebp
  return fork();
80105434:	e9 17 e4 ff ff       	jmp    80103850 <fork>
...
80105443:	83 ec 08             	sub    $0x8,%esp
  exit();
80105446:	e8 55 e6 ff ff       	call   80103aa0 <exit>
...
80105464:	e8 47 f3 ff ff       	call   801047b0 <argint>
80105469:	85 c0                	test   %eax,%eax
8010546b:	78 13                	js     80105480 <sys_exitS+0x30>
     return -1;
  	
  exitS(pid);
8010546d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105470:	89 04 24             	mov    %eax,(%esp)
80105473:	e8 48 e7 ff ff       	call   80103bc0 <exitS>
...
801054ac:	e8 2f f3 ff ff       	call   801047e0 <argptr>
801054b1:	85 c0                	test   %eax,%eax
801054b3:	78 13                	js     801054c8 <sys_wait+0x38>
     return -1;
  return wait(pid);
801054b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054b8:	89 04 24             	mov    %eax,(%esp)
801054bb:	e8 10 e9 ff ff       	call   80103dd0 <wait>
}
801054c0:	c9                   	leave  
801054c1:	c3                   	ret    
...
801054d3:	83 ec 28             	sub    $0x28,%esp
 ...
 argint(0,&pid); 
801054d6:	8d 45 ec             	lea    -0x14(%ebp),%eax
801054d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801054dd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801054e4:	e8 c7 f2 ff ff       	call   801047b0 <argint>
 //put in ptr of waitStatus
 if(argptr(1,(void*)&waitStatus,sizeof(*waitStatus)) <0)
801054e9:	8d 45 f0             	lea    -0x10(%ebp),%eax
801054ec:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801054f3:	00 
801054f4:	89 44 24 04          	mov    %eax,0x4(%esp)
801054f8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801054ff:	e8 dc f2 ff ff       	call   801047e0 <argptr>
80105504:	85 c0                	test   %eax,%eax
80105506:	78 30                	js     80105538 <sys_waitpid+0x68>
   return -1;
 argint(2,&option);
80105508:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010550b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010550f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105516:	e8 95 f2 ff ff       	call   801047b0 <argint>
...
80105529:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010552c:	89 04 24             	mov    %eax,(%esp)
8010552f:	e8 8c e9 ff ff       	call   80103ec0 <waitpid>
}
80105534:	c9                   	leave  
80105535:	c3                   	ret    
...
80105554:	e8 57 f2 ff ff       	call   801047b0 <argint>
80105559:	85 c0                	test   %eax,%eax
8010555b:	78 13                	js     80105570 <sys_kill+0x30>
    return -1;
  return kill(pid);
8010555d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105560:	89 04 24             	mov    %eax,(%esp)
80105563:	e8 a8 ea ff ff       	call   80104010 <kill>
}
80105568:	c9                   	leave  
80105569:	c3                   	ret    
...
80105583:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105586:	e8 15 e1 ff ff       	call   801036a0 <myproc>
...
801055a5:	e8 06 f2 ff ff       	call   801047b0 <argint>
801055aa:	85 c0                	test   %eax,%eax
801055ac:	78 22                	js     801055d0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801055ae:	e8 ed e0 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
801055b3:	8b 55 f4             	mov    -0xc(%ebp),%edx
  addr = myproc()->sz;
801055b6:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
801055b8:	89 14 24             	mov    %edx,(%esp)
801055bb:	e8 20 e2 ff ff       	call   801037e0 <growproc>
...
801055c6:	83 c4 24             	add    $0x24,%esp
801055c9:	5b                   	pop    %ebx
801055ca:	5d                   	pop    %ebp
801055cb:	c3                   	ret    
...
801055d5:	eb ef                	jmp    801055c6 <sys_sbrk+0x36>
...
801055f5:	e8 b6 f1 ff ff       	call   801047b0 <argint>
801055fa:	85 c0                	test   %eax,%eax
801055fc:	78 7e                	js     8010567c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
801055fe:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105605:	e8 f6 ed ff ff       	call   80104400 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010560a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010560d:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
80105613:	85 d2                	test   %edx,%edx
80105615:	75 29                	jne    80105640 <sys_sleep+0x60>
80105617:	eb 4f                	jmp    80105668 <sys_sleep+0x88>
...
80105620:	c7 44 24 04 60 4d 11 	movl   $0x80114d60,0x4(%esp)
80105627:	80 
80105628:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
8010562f:	e8 ec e6 ff ff       	call   80103d20 <sleep>
  while(ticks - ticks0 < n){
80105634:	a1 a0 55 11 80       	mov    0x801155a0,%eax
80105639:	29 d8                	sub    %ebx,%eax
8010563b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010563e:	73 28                	jae    80105668 <sys_sleep+0x88>
    if(myproc()->killed){
80105640:	e8 5b e0 ff ff       	call   801036a0 <myproc>
80105645:	8b 40 24             	mov    0x24(%eax),%eax
80105648:	85 c0                	test   %eax,%eax
8010564a:	74 d4                	je     80105620 <sys_sleep+0x40>
      release(&tickslock);
8010564c:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105653:	e8 18 ee ff ff       	call   80104470 <release>
      return -1;
...
8010565d:	83 c4 24             	add    $0x24,%esp
80105660:	5b                   	pop    %ebx
80105661:	5d                   	pop    %ebp
80105662:	c3                   	ret    
80105663:	90                   	nop
80105664:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
80105668:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010566f:	e8 fc ed ff ff       	call   80104470 <release>
}
80105674:	83 c4 24             	add    $0x24,%esp
  return 0;
...
80105681:	eb da                	jmp    8010565d <sys_sleep+0x7d>
...
8010569e:	e8 5d ed ff ff       	call   80104400 <acquire>
  xticks = ticks;
801056a3:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
801056a9:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801056b0:	e8 bb ed ff ff       	call   80104470 <release>
  return xticks;
}
...
801056bd:	1e                   	push   %ds
801056be:	06                   	push   %es
801056bf:	0f a0                	push   %fs
801056c1:	0f a8                	push   %gs
801056c3:	60                   	pusha  
801056c4:	66 b8 10 00          	mov    $0x10,%ax
801056c8:	8e d8                	mov    %eax,%ds
801056ca:	8e c0                	mov    %eax,%es
801056cc:	54                   	push   %esp
801056cd:	e8 de 00 00 00       	call   801057b0 <trap>
801056d2:	83 c4 04             	add    $0x4,%esp

801056d5 <trapret>:
801056d5:	61                   	popa   
801056d6:	0f a9                	pop    %gs
801056d8:	0f a1                	pop    %fs
801056da:	07                   	pop    %es
801056db:	1f                   	pop    %ds
...
801056f4:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
801056fb:	80 
801056fc:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
80105703:	00 
80105704:	c6 04 c5 a5 4d 11 80 	movb   $0x8e,-0x7feeb25b(,%eax,8)
8010570b:	8e 
8010570c:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
80105713:	80 
80105714:	c1 ea 10             	shr    $0x10,%edx
80105717:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
8010571e:	80 
  for(i = 0; i < 256; i++)
...
80105739:	c7 44 24 04 81 76 10 	movl   $0x80107681,0x4(%esp)
80105740:	80 
80105741:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105748:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
8010574f:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
80105755:	c1 e8 10             	shr    $0x10,%eax
80105758:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
8010575f:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
80105766:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010576c:	e8 1f eb ff ff       	call   80104290 <initlock>
}
80105771:	c9                   	leave  
80105772:	c3                   	ret    
...
8010578b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010578f:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
801057ce:	77 08                	ja     801057d8 <trap+0x28>
801057d0:	ff 24 85 28 77 10 80 	jmp    *-0x7fef88d8(,%eax,4)
801057d7:	90                   	nop
    lapiceoi();
    break;
...
801057d8:	e8 c3 de ff ff       	call   801036a0 <myproc>
801057dd:	85 c0                	test   %eax,%eax
801057df:	90                   	nop
801057e0:	0f 84 fa 01 00 00    	je     801059e0 <trap+0x230>
801057e6:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801057ea:	0f 84 f0 01 00 00    	je     801059e0 <trap+0x230>
...
801057f3:	8b 53 38             	mov    0x38(%ebx),%edx
801057f6:	89 4d d8             	mov    %ecx,-0x28(%ebp)
801057f9:	89 55 dc             	mov    %edx,-0x24(%ebp)
801057fc:	e8 7f de ff ff       	call   80103680 <cpuid>
80105801:	8b 73 30             	mov    0x30(%ebx),%esi
80105804:	89 c7                	mov    %eax,%edi
80105806:	8b 43 34             	mov    0x34(%ebx),%eax
80105809:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010580c:	e8 8f de ff ff       	call   801036a0 <myproc>
80105811:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105814:	e8 87 de ff ff       	call   801036a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105819:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010581c:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105820:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105823:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105826:	89 7c 24 14          	mov    %edi,0x14(%esp)
8010582a:	89 54 24 18          	mov    %edx,0x18(%esp)
8010582e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
80105831:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105834:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105838:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010583c:	89 54 24 10          	mov    %edx,0x10(%esp)
80105840:	8b 40 10             	mov    0x10(%eax),%eax
80105843:	c7 04 24 e4 76 10 80 	movl   $0x801076e4,(%esp)
8010584a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010584e:	e8 fd ad ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105853:	e8 48 de ff ff       	call   801036a0 <myproc>
80105858:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
8010585f:	90                   	nop
  }
...
80105867:	74 0c                	je     80105875 <trap+0xc5>
80105869:	e8 32 de ff ff       	call   801036a0 <myproc>
8010586e:	8b 50 24             	mov    0x24(%eax),%edx
80105871:	85 d2                	test   %edx,%edx
80105873:	75 4b                	jne    801058c0 <trap+0x110>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105875:	e8 26 de ff ff       	call   801036a0 <myproc>
8010587a:	85 c0                	test   %eax,%eax
8010587c:	74 0d                	je     8010588b <trap+0xdb>
8010587e:	66 90                	xchg   %ax,%ax
80105880:	e8 1b de ff ff       	call   801036a0 <myproc>
80105885:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105889:	74 4d                	je     801058d8 <trap+0x128>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010588b:	e8 10 de ff ff       	call   801036a0 <myproc>
80105890:	85 c0                	test   %eax,%eax
80105892:	74 1d                	je     801058b1 <trap+0x101>
80105894:	e8 07 de ff ff       	call   801036a0 <myproc>
80105899:	8b 40 24             	mov    0x24(%eax),%eax
8010589c:	85 c0                	test   %eax,%eax
8010589e:	74 11                	je     801058b1 <trap+0x101>
801058a0:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801058a4:	83 e0 03             	and    $0x3,%eax
801058a7:	66 83 f8 03          	cmp    $0x3,%ax
801058ab:	0f 84 e8 00 00 00    	je     80105999 <trap+0x1e9>
    exit();
}
801058b1:	83 c4 3c             	add    $0x3c,%esp
801058b4:	5b                   	pop    %ebx
801058b5:	5e                   	pop    %esi
801058b6:	5f                   	pop    %edi
801058b7:	5d                   	pop    %ebp
...
801058cb:	75 a8                	jne    80105875 <trap+0xc5>
    exit();
801058cd:	e8 ce e1 ff ff       	call   80103aa0 <exit>
801058d2:	eb a1                	jmp    80105875 <trap+0xc5>
801058d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->state == RUNNING &&
801058d8:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801058dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801058e0:	75 a9                	jne    8010588b <trap+0xdb>
    yield();
801058e2:	e8 f9 e3 ff ff       	call   80103ce0 <yield>
801058e7:	eb a2                	jmp    8010588b <trap+0xdb>
801058e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
801058f0:	e8 8b dd ff ff       	call   80103680 <cpuid>
801058f5:	85 c0                	test   %eax,%eax
801058f7:	0f 84 b3 00 00 00    	je     801059b0 <trap+0x200>
801058fd:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105900:	e8 7b ce ff ff       	call   80102780 <lapiceoi>
    break;
80105905:	e9 56 ff ff ff       	jmp    80105860 <trap+0xb0>
8010590a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    kbdintr();
80105910:	e8 bb cc ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
80105915:	e8 66 ce ff ff       	call   80102780 <lapiceoi>
    break;
8010591a:	e9 41 ff ff ff       	jmp    80105860 <trap+0xb0>
8010591f:	90                   	nop
    uartintr();
80105920:	e8 1b 02 00 00       	call   80105b40 <uartintr>
    lapiceoi();
80105925:	e8 56 ce ff ff       	call   80102780 <lapiceoi>
    break;
8010592a:	e9 31 ff ff ff       	jmp    80105860 <trap+0xb0>
8010592f:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105930:	8b 7b 38             	mov    0x38(%ebx),%edi
80105933:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105937:	e8 44 dd ff ff       	call   80103680 <cpuid>
8010593c:	c7 04 24 8c 76 10 80 	movl   $0x8010768c,(%esp)
80105943:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80105947:	89 74 24 08          	mov    %esi,0x8(%esp)
8010594b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010594f:	e8 fc ac ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105954:	e8 27 ce ff ff       	call   80102780 <lapiceoi>
    break;
80105959:	e9 02 ff ff ff       	jmp    80105860 <trap+0xb0>
8010595e:	66 90                	xchg   %ax,%ax
    ideintr();
80105960:	e8 1b c7 ff ff       	call   80102080 <ideintr>
80105965:	eb 96                	jmp    801058fd <trap+0x14d>
80105967:	90                   	nop
80105968:	90                   	nop
80105969:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105970:	e8 2b dd ff ff       	call   801036a0 <myproc>
80105975:	8b 70 24             	mov    0x24(%eax),%esi
80105978:	85 f6                	test   %esi,%esi
8010597a:	75 2c                	jne    801059a8 <trap+0x1f8>
    myproc()->tf = tf;
8010597c:	e8 1f dd ff ff       	call   801036a0 <myproc>
80105981:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105984:	e8 f7 ee ff ff       	call   80104880 <syscall>
    if(myproc()->killed)
80105989:	e8 12 dd ff ff       	call   801036a0 <myproc>
8010598e:	8b 48 24             	mov    0x24(%eax),%ecx
80105991:	85 c9                	test   %ecx,%ecx
80105993:	0f 84 18 ff ff ff    	je     801058b1 <trap+0x101>
}
80105999:	83 c4 3c             	add    $0x3c,%esp
8010599c:	5b                   	pop    %ebx
8010599d:	5e                   	pop    %esi
8010599e:	5f                   	pop    %edi
8010599f:	5d                   	pop    %ebp
      exit();
801059a0:	e9 fb e0 ff ff       	jmp    80103aa0 <exit>
801059a5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
801059a8:	e8 f3 e0 ff ff       	call   80103aa0 <exit>
801059ad:	eb cd                	jmp    8010597c <trap+0x1cc>
801059af:	90                   	nop
      acquire(&tickslock);
801059b0:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801059b7:	e8 44 ea ff ff       	call   80104400 <acquire>
      wakeup(&ticks);
801059bc:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
801059c3:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
801059ca:	e8 e1 e5 ff ff       	call   80103fb0 <wakeup>
      release(&tickslock);
801059cf:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801059d6:	e8 95 ea ff ff       	call   80104470 <release>
801059db:	e9 1d ff ff ff       	jmp    801058fd <trap+0x14d>
801059e0:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801059e3:	8b 73 38             	mov    0x38(%ebx),%esi
801059e6:	e8 95 dc ff ff       	call   80103680 <cpuid>
...
801059fa:	c7 04 24 b0 76 10 80 	movl   $0x801076b0,(%esp)
80105a01:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a05:	e8 46 ac ff ff       	call   80100650 <cprintf>
      panic("trap");
80105a0a:	c7 04 24 86 76 10 80 	movl   $0x80107686,(%esp)
...
80105b07:	00 
  for(p="xv6...\n"; *p; p++)
80105b08:	bb a8 77 10 80       	mov    $0x801077a8,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105b56:	6a 00                	push   $0x0
  jmp alltraps
80105b58:	e9 60 fb ff ff       	jmp    801056bd <alltraps>
...
80105b5f:	6a 01                	push   $0x1
  jmp alltraps
80105b61:	e9 57 fb ff ff       	jmp    801056bd <alltraps>
...
80105b68:	6a 02                	push   $0x2
  jmp alltraps
80105b6a:	e9 4e fb ff ff       	jmp    801056bd <alltraps>
...
80105b71:	6a 03                	push   $0x3
  jmp alltraps
80105b73:	e9 45 fb ff ff       	jmp    801056bd <alltraps>
...
80105b7a:	6a 04                	push   $0x4
  jmp alltraps
80105b7c:	e9 3c fb ff ff       	jmp    801056bd <alltraps>
...
80105b83:	6a 05                	push   $0x5
  jmp alltraps
80105b85:	e9 33 fb ff ff       	jmp    801056bd <alltraps>
...
80105b8c:	6a 06                	push   $0x6
  jmp alltraps
80105b8e:	e9 2a fb ff ff       	jmp    801056bd <alltraps>
...
80105b95:	6a 07                	push   $0x7
  jmp alltraps
80105b97:	e9 21 fb ff ff       	jmp    801056bd <alltraps>
...
80105b9c:	6a 08                	push   $0x8
  jmp alltraps
80105b9e:	e9 1a fb ff ff       	jmp    801056bd <alltraps>
...
80105ba5:	6a 09                	push   $0x9
  jmp alltraps
80105ba7:	e9 11 fb ff ff       	jmp    801056bd <alltraps>
...
80105bac:	6a 0a                	push   $0xa
  jmp alltraps
80105bae:	e9 0a fb ff ff       	jmp    801056bd <alltraps>
...
80105bb3:	6a 0b                	push   $0xb
  jmp alltraps
80105bb5:	e9 03 fb ff ff       	jmp    801056bd <alltraps>
...
80105bba:	6a 0c                	push   $0xc
  jmp alltraps
80105bbc:	e9 fc fa ff ff       	jmp    801056bd <alltraps>
...
80105bc1:	6a 0d                	push   $0xd
  jmp alltraps
80105bc3:	e9 f5 fa ff ff       	jmp    801056bd <alltraps>
...
80105bc8:	6a 0e                	push   $0xe
  jmp alltraps
80105bca:	e9 ee fa ff ff       	jmp    801056bd <alltraps>
...
80105bd1:	6a 0f                	push   $0xf
  jmp alltraps
80105bd3:	e9 e5 fa ff ff       	jmp    801056bd <alltraps>
...
80105bda:	6a 10                	push   $0x10
  jmp alltraps
80105bdc:	e9 dc fa ff ff       	jmp    801056bd <alltraps>
...
80105be1:	6a 11                	push   $0x11
  jmp alltraps
80105be3:	e9 d5 fa ff ff       	jmp    801056bd <alltraps>
...
80105bea:	6a 12                	push   $0x12
  jmp alltraps
80105bec:	e9 cc fa ff ff       	jmp    801056bd <alltraps>
...
80105bf3:	6a 13                	push   $0x13
  jmp alltraps
80105bf5:	e9 c3 fa ff ff       	jmp    801056bd <alltraps>
...
80105bfc:	6a 14                	push   $0x14
  jmp alltraps
80105bfe:	e9 ba fa ff ff       	jmp    801056bd <alltraps>
...
80105c05:	6a 15                	push   $0x15
  jmp alltraps
80105c07:	e9 b1 fa ff ff       	jmp    801056bd <alltraps>
...
80105c0e:	6a 16                	push   $0x16
  jmp alltraps
80105c10:	e9 a8 fa ff ff       	jmp    801056bd <alltraps>
...
80105c17:	6a 17                	push   $0x17
  jmp alltraps
80105c19:	e9 9f fa ff ff       	jmp    801056bd <alltraps>
...
80105c20:	6a 18                	push   $0x18
  jmp alltraps
80105c22:	e9 96 fa ff ff       	jmp    801056bd <alltraps>
...
80105c29:	6a 19                	push   $0x19
  jmp alltraps
80105c2b:	e9 8d fa ff ff       	jmp    801056bd <alltraps>
...
80105c32:	6a 1a                	push   $0x1a
  jmp alltraps
80105c34:	e9 84 fa ff ff       	jmp    801056bd <alltraps>
...
80105c3b:	6a 1b                	push   $0x1b
  jmp alltraps
80105c3d:	e9 7b fa ff ff       	jmp    801056bd <alltraps>
...
80105c44:	6a 1c                	push   $0x1c
  jmp alltraps
80105c46:	e9 72 fa ff ff       	jmp    801056bd <alltraps>
...
80105c4d:	6a 1d                	push   $0x1d
  jmp alltraps
80105c4f:	e9 69 fa ff ff       	jmp    801056bd <alltraps>
...
80105c56:	6a 1e                	push   $0x1e
  jmp alltraps
80105c58:	e9 60 fa ff ff       	jmp    801056bd <alltraps>
...
80105c5f:	6a 1f                	push   $0x1f
  jmp alltraps
80105c61:	e9 57 fa ff ff       	jmp    801056bd <alltraps>
...
80105c68:	6a 20                	push   $0x20
  jmp alltraps
80105c6a:	e9 4e fa ff ff       	jmp    801056bd <alltraps>
...
80105c71:	6a 21                	push   $0x21
  jmp alltraps
80105c73:	e9 45 fa ff ff       	jmp    801056bd <alltraps>
...
80105c7a:	6a 22                	push   $0x22
  jmp alltraps
80105c7c:	e9 3c fa ff ff       	jmp    801056bd <alltraps>
...
80105c83:	6a 23                	push   $0x23
  jmp alltraps
80105c85:	e9 33 fa ff ff       	jmp    801056bd <alltraps>
...
80105c8c:	6a 24                	push   $0x24
  jmp alltraps
80105c8e:	e9 2a fa ff ff       	jmp    801056bd <alltraps>
...
80105c95:	6a 25                	push   $0x25
  jmp alltraps
80105c97:	e9 21 fa ff ff       	jmp    801056bd <alltraps>
...
80105c9e:	6a 26                	push   $0x26
  jmp alltraps
80105ca0:	e9 18 fa ff ff       	jmp    801056bd <alltraps>
...
80105ca7:	6a 27                	push   $0x27
  jmp alltraps
80105ca9:	e9 0f fa ff ff       	jmp    801056bd <alltraps>
...
80105cb0:	6a 28                	push   $0x28
  jmp alltraps
80105cb2:	e9 06 fa ff ff       	jmp    801056bd <alltraps>
...
80105cb9:	6a 29                	push   $0x29
  jmp alltraps
80105cbb:	e9 fd f9 ff ff       	jmp    801056bd <alltraps>
...
80105cc2:	6a 2a                	push   $0x2a
  jmp alltraps
80105cc4:	e9 f4 f9 ff ff       	jmp    801056bd <alltraps>
...
80105ccb:	6a 2b                	push   $0x2b
  jmp alltraps
80105ccd:	e9 eb f9 ff ff       	jmp    801056bd <alltraps>
...
80105cd4:	6a 2c                	push   $0x2c
  jmp alltraps
80105cd6:	e9 e2 f9 ff ff       	jmp    801056bd <alltraps>
...
80105cdd:	6a 2d                	push   $0x2d
  jmp alltraps
80105cdf:	e9 d9 f9 ff ff       	jmp    801056bd <alltraps>
...
80105ce6:	6a 2e                	push   $0x2e
  jmp alltraps
80105ce8:	e9 d0 f9 ff ff       	jmp    801056bd <alltraps>
...
80105cef:	6a 2f                	push   $0x2f
  jmp alltraps
80105cf1:	e9 c7 f9 ff ff       	jmp    801056bd <alltraps>
...
80105cf8:	6a 30                	push   $0x30
  jmp alltraps
80105cfa:	e9 be f9 ff ff       	jmp    801056bd <alltraps>
...
80105d01:	6a 31                	push   $0x31
  jmp alltraps
80105d03:	e9 b5 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d0a:	6a 32                	push   $0x32
  jmp alltraps
80105d0c:	e9 ac f9 ff ff       	jmp    801056bd <alltraps>
...
80105d13:	6a 33                	push   $0x33
  jmp alltraps
80105d15:	e9 a3 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d1c:	6a 34                	push   $0x34
  jmp alltraps
80105d1e:	e9 9a f9 ff ff       	jmp    801056bd <alltraps>
...
80105d25:	6a 35                	push   $0x35
  jmp alltraps
80105d27:	e9 91 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d2e:	6a 36                	push   $0x36
  jmp alltraps
80105d30:	e9 88 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d37:	6a 37                	push   $0x37
  jmp alltraps
80105d39:	e9 7f f9 ff ff       	jmp    801056bd <alltraps>
...
80105d40:	6a 38                	push   $0x38
  jmp alltraps
80105d42:	e9 76 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d49:	6a 39                	push   $0x39
  jmp alltraps
80105d4b:	e9 6d f9 ff ff       	jmp    801056bd <alltraps>
...
80105d52:	6a 3a                	push   $0x3a
  jmp alltraps
80105d54:	e9 64 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d5b:	6a 3b                	push   $0x3b
  jmp alltraps
80105d5d:	e9 5b f9 ff ff       	jmp    801056bd <alltraps>
...
80105d64:	6a 3c                	push   $0x3c
  jmp alltraps
80105d66:	e9 52 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d6d:	6a 3d                	push   $0x3d
  jmp alltraps
80105d6f:	e9 49 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d76:	6a 3e                	push   $0x3e
  jmp alltraps
80105d78:	e9 40 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d7f:	6a 3f                	push   $0x3f
  jmp alltraps
80105d81:	e9 37 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d88:	6a 40                	push   $0x40
  jmp alltraps
80105d8a:	e9 2e f9 ff ff       	jmp    801056bd <alltraps>
...
80105d91:	6a 41                	push   $0x41
  jmp alltraps
80105d93:	e9 25 f9 ff ff       	jmp    801056bd <alltraps>
...
80105d9a:	6a 42                	push   $0x42
  jmp alltraps
80105d9c:	e9 1c f9 ff ff       	jmp    801056bd <alltraps>
...
80105da3:	6a 43                	push   $0x43
  jmp alltraps
80105da5:	e9 13 f9 ff ff       	jmp    801056bd <alltraps>
...
80105dac:	6a 44                	push   $0x44
  jmp alltraps
80105dae:	e9 0a f9 ff ff       	jmp    801056bd <alltraps>
...
80105db5:	6a 45                	push   $0x45
  jmp alltraps
80105db7:	e9 01 f9 ff ff       	jmp    801056bd <alltraps>
...
80105dbe:	6a 46                	push   $0x46
  jmp alltraps
80105dc0:	e9 f8 f8 ff ff       	jmp    801056bd <alltraps>
...
80105dc7:	6a 47                	push   $0x47
  jmp alltraps
80105dc9:	e9 ef f8 ff ff       	jmp    801056bd <alltraps>
...
80105dd0:	6a 48                	push   $0x48
  jmp alltraps
80105dd2:	e9 e6 f8 ff ff       	jmp    801056bd <alltraps>
...
80105dd9:	6a 49                	push   $0x49
  jmp alltraps
80105ddb:	e9 dd f8 ff ff       	jmp    801056bd <alltraps>
...
80105de2:	6a 4a                	push   $0x4a
  jmp alltraps
80105de4:	e9 d4 f8 ff ff       	jmp    801056bd <alltraps>
...
80105deb:	6a 4b                	push   $0x4b
  jmp alltraps
80105ded:	e9 cb f8 ff ff       	jmp    801056bd <alltraps>
...
80105df4:	6a 4c                	push   $0x4c
  jmp alltraps
80105df6:	e9 c2 f8 ff ff       	jmp    801056bd <alltraps>
...
80105dfd:	6a 4d                	push   $0x4d
  jmp alltraps
80105dff:	e9 b9 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e06:	6a 4e                	push   $0x4e
  jmp alltraps
80105e08:	e9 b0 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e0f:	6a 4f                	push   $0x4f
  jmp alltraps
80105e11:	e9 a7 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e18:	6a 50                	push   $0x50
  jmp alltraps
80105e1a:	e9 9e f8 ff ff       	jmp    801056bd <alltraps>
...
80105e21:	6a 51                	push   $0x51
  jmp alltraps
80105e23:	e9 95 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e2a:	6a 52                	push   $0x52
  jmp alltraps
80105e2c:	e9 8c f8 ff ff       	jmp    801056bd <alltraps>
...
80105e33:	6a 53                	push   $0x53
  jmp alltraps
80105e35:	e9 83 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e3c:	6a 54                	push   $0x54
  jmp alltraps
80105e3e:	e9 7a f8 ff ff       	jmp    801056bd <alltraps>
...
80105e45:	6a 55                	push   $0x55
  jmp alltraps
80105e47:	e9 71 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e4e:	6a 56                	push   $0x56
  jmp alltraps
80105e50:	e9 68 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e57:	6a 57                	push   $0x57
  jmp alltraps
80105e59:	e9 5f f8 ff ff       	jmp    801056bd <alltraps>
...
80105e60:	6a 58                	push   $0x58
  jmp alltraps
80105e62:	e9 56 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e69:	6a 59                	push   $0x59
  jmp alltraps
80105e6b:	e9 4d f8 ff ff       	jmp    801056bd <alltraps>
...
80105e72:	6a 5a                	push   $0x5a
  jmp alltraps
80105e74:	e9 44 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e7b:	6a 5b                	push   $0x5b
  jmp alltraps
80105e7d:	e9 3b f8 ff ff       	jmp    801056bd <alltraps>
...
80105e84:	6a 5c                	push   $0x5c
  jmp alltraps
80105e86:	e9 32 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e8d:	6a 5d                	push   $0x5d
  jmp alltraps
80105e8f:	e9 29 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e96:	6a 5e                	push   $0x5e
  jmp alltraps
80105e98:	e9 20 f8 ff ff       	jmp    801056bd <alltraps>
...
80105e9f:	6a 5f                	push   $0x5f
  jmp alltraps
80105ea1:	e9 17 f8 ff ff       	jmp    801056bd <alltraps>
...
80105ea8:	6a 60                	push   $0x60
  jmp alltraps
80105eaa:	e9 0e f8 ff ff       	jmp    801056bd <alltraps>
...
80105eb1:	6a 61                	push   $0x61
  jmp alltraps
80105eb3:	e9 05 f8 ff ff       	jmp    801056bd <alltraps>
...
80105eba:	6a 62                	push   $0x62
  jmp alltraps
80105ebc:	e9 fc f7 ff ff       	jmp    801056bd <alltraps>
...
80105ec3:	6a 63                	push   $0x63
  jmp alltraps
80105ec5:	e9 f3 f7 ff ff       	jmp    801056bd <alltraps>
...
80105ecc:	6a 64                	push   $0x64
  jmp alltraps
80105ece:	e9 ea f7 ff ff       	jmp    801056bd <alltraps>
...
80105ed5:	6a 65                	push   $0x65
  jmp alltraps
80105ed7:	e9 e1 f7 ff ff       	jmp    801056bd <alltraps>
...
80105ede:	6a 66                	push   $0x66
  jmp alltraps
80105ee0:	e9 d8 f7 ff ff       	jmp    801056bd <alltraps>
...
80105ee7:	6a 67                	push   $0x67
  jmp alltraps
80105ee9:	e9 cf f7 ff ff       	jmp    801056bd <alltraps>
...
80105ef0:	6a 68                	push   $0x68
  jmp alltraps
80105ef2:	e9 c6 f7 ff ff       	jmp    801056bd <alltraps>
...
80105ef9:	6a 69                	push   $0x69
  jmp alltraps
80105efb:	e9 bd f7 ff ff       	jmp    801056bd <alltraps>
...
80105f02:	6a 6a                	push   $0x6a
  jmp alltraps
80105f04:	e9 b4 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f0b:	6a 6b                	push   $0x6b
  jmp alltraps
80105f0d:	e9 ab f7 ff ff       	jmp    801056bd <alltraps>
...
80105f14:	6a 6c                	push   $0x6c
  jmp alltraps
80105f16:	e9 a2 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f1d:	6a 6d                	push   $0x6d
  jmp alltraps
80105f1f:	e9 99 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f26:	6a 6e                	push   $0x6e
  jmp alltraps
80105f28:	e9 90 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f2f:	6a 6f                	push   $0x6f
  jmp alltraps
80105f31:	e9 87 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f38:	6a 70                	push   $0x70
  jmp alltraps
80105f3a:	e9 7e f7 ff ff       	jmp    801056bd <alltraps>
...
80105f41:	6a 71                	push   $0x71
  jmp alltraps
80105f43:	e9 75 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f4a:	6a 72                	push   $0x72
  jmp alltraps
80105f4c:	e9 6c f7 ff ff       	jmp    801056bd <alltraps>
...
80105f53:	6a 73                	push   $0x73
  jmp alltraps
80105f55:	e9 63 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f5c:	6a 74                	push   $0x74
  jmp alltraps
80105f5e:	e9 5a f7 ff ff       	jmp    801056bd <alltraps>
...
80105f65:	6a 75                	push   $0x75
  jmp alltraps
80105f67:	e9 51 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f6e:	6a 76                	push   $0x76
  jmp alltraps
80105f70:	e9 48 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f77:	6a 77                	push   $0x77
  jmp alltraps
80105f79:	e9 3f f7 ff ff       	jmp    801056bd <alltraps>
...
80105f80:	6a 78                	push   $0x78
  jmp alltraps
80105f82:	e9 36 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f89:	6a 79                	push   $0x79
  jmp alltraps
80105f8b:	e9 2d f7 ff ff       	jmp    801056bd <alltraps>
...
80105f92:	6a 7a                	push   $0x7a
  jmp alltraps
80105f94:	e9 24 f7 ff ff       	jmp    801056bd <alltraps>
...
80105f9b:	6a 7b                	push   $0x7b
  jmp alltraps
80105f9d:	e9 1b f7 ff ff       	jmp    801056bd <alltraps>
...
80105fa4:	6a 7c                	push   $0x7c
  jmp alltraps
80105fa6:	e9 12 f7 ff ff       	jmp    801056bd <alltraps>
...
80105fad:	6a 7d                	push   $0x7d
  jmp alltraps
80105faf:	e9 09 f7 ff ff       	jmp    801056bd <alltraps>
...
80105fb6:	6a 7e                	push   $0x7e
  jmp alltraps
80105fb8:	e9 00 f7 ff ff       	jmp    801056bd <alltraps>
...
80105fbf:	6a 7f                	push   $0x7f
  jmp alltraps
80105fc1:	e9 f7 f6 ff ff       	jmp    801056bd <alltraps>
...
80105fc8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fcd:	e9 eb f6 ff ff       	jmp    801056bd <alltraps>
...
80105fd4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105fd9:	e9 df f6 ff ff       	jmp    801056bd <alltraps>
...
80105fe0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105fe5:	e9 d3 f6 ff ff       	jmp    801056bd <alltraps>
...
80105fec:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105ff1:	e9 c7 f6 ff ff       	jmp    801056bd <alltraps>
...
80105ff8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105ffd:	e9 bb f6 ff ff       	jmp    801056bd <alltraps>
...
80106004:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106009:	e9 af f6 ff ff       	jmp    801056bd <alltraps>
...
80106010:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106015:	e9 a3 f6 ff ff       	jmp    801056bd <alltraps>
...
8010601c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106021:	e9 97 f6 ff ff       	jmp    801056bd <alltraps>
...
80106028:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010602d:	e9 8b f6 ff ff       	jmp    801056bd <alltraps>
...
80106034:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106039:	e9 7f f6 ff ff       	jmp    801056bd <alltraps>
...
80106040:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106045:	e9 73 f6 ff ff       	jmp    801056bd <alltraps>
...
8010604c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106051:	e9 67 f6 ff ff       	jmp    801056bd <alltraps>
...
80106058:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010605d:	e9 5b f6 ff ff       	jmp    801056bd <alltraps>
...
80106064:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106069:	e9 4f f6 ff ff       	jmp    801056bd <alltraps>
...
80106070:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106075:	e9 43 f6 ff ff       	jmp    801056bd <alltraps>
...
8010607c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106081:	e9 37 f6 ff ff       	jmp    801056bd <alltraps>
...
80106088:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010608d:	e9 2b f6 ff ff       	jmp    801056bd <alltraps>
...
80106094:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106099:	e9 1f f6 ff ff       	jmp    801056bd <alltraps>
...
801060a0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060a5:	e9 13 f6 ff ff       	jmp    801056bd <alltraps>
...
801060ac:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060b1:	e9 07 f6 ff ff       	jmp    801056bd <alltraps>
...
801060b8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060bd:	e9 fb f5 ff ff       	jmp    801056bd <alltraps>
...
801060c4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060c9:	e9 ef f5 ff ff       	jmp    801056bd <alltraps>
...
801060d0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060d5:	e9 e3 f5 ff ff       	jmp    801056bd <alltraps>
...
801060dc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060e1:	e9 d7 f5 ff ff       	jmp    801056bd <alltraps>
...
801060e8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060ed:	e9 cb f5 ff ff       	jmp    801056bd <alltraps>
...
801060f4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060f9:	e9 bf f5 ff ff       	jmp    801056bd <alltraps>
...
80106100:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106105:	e9 b3 f5 ff ff       	jmp    801056bd <alltraps>
...
8010610c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106111:	e9 a7 f5 ff ff       	jmp    801056bd <alltraps>
...
80106118:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010611d:	e9 9b f5 ff ff       	jmp    801056bd <alltraps>
...
80106124:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106129:	e9 8f f5 ff ff       	jmp    801056bd <alltraps>
...
80106130:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106135:	e9 83 f5 ff ff       	jmp    801056bd <alltraps>
...
8010613c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106141:	e9 77 f5 ff ff       	jmp    801056bd <alltraps>
...
80106148:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010614d:	e9 6b f5 ff ff       	jmp    801056bd <alltraps>
...
80106154:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106159:	e9 5f f5 ff ff       	jmp    801056bd <alltraps>
...
80106160:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106165:	e9 53 f5 ff ff       	jmp    801056bd <alltraps>
...
8010616c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106171:	e9 47 f5 ff ff       	jmp    801056bd <alltraps>
...
80106178:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010617d:	e9 3b f5 ff ff       	jmp    801056bd <alltraps>
...
80106184:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106189:	e9 2f f5 ff ff       	jmp    801056bd <alltraps>
...
80106190:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106195:	e9 23 f5 ff ff       	jmp    801056bd <alltraps>
...
8010619c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061a1:	e9 17 f5 ff ff       	jmp    801056bd <alltraps>
...
801061a8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061ad:	e9 0b f5 ff ff       	jmp    801056bd <alltraps>
...
801061b4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061b9:	e9 ff f4 ff ff       	jmp    801056bd <alltraps>
...
801061c0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061c5:	e9 f3 f4 ff ff       	jmp    801056bd <alltraps>
...
801061cc:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061d1:	e9 e7 f4 ff ff       	jmp    801056bd <alltraps>
...
801061d8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061dd:	e9 db f4 ff ff       	jmp    801056bd <alltraps>
...
801061e4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061e9:	e9 cf f4 ff ff       	jmp    801056bd <alltraps>
...
801061f0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061f5:	e9 c3 f4 ff ff       	jmp    801056bd <alltraps>
...
801061fc:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106201:	e9 b7 f4 ff ff       	jmp    801056bd <alltraps>
...
80106208:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010620d:	e9 ab f4 ff ff       	jmp    801056bd <alltraps>
...
80106214:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106219:	e9 9f f4 ff ff       	jmp    801056bd <alltraps>
...
80106220:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106225:	e9 93 f4 ff ff       	jmp    801056bd <alltraps>
...
8010622c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106231:	e9 87 f4 ff ff       	jmp    801056bd <alltraps>
...
80106238:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010623d:	e9 7b f4 ff ff       	jmp    801056bd <alltraps>
...
80106244:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106249:	e9 6f f4 ff ff       	jmp    801056bd <alltraps>
...
80106250:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106255:	e9 63 f4 ff ff       	jmp    801056bd <alltraps>
...
8010625c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106261:	e9 57 f4 ff ff       	jmp    801056bd <alltraps>
...
80106268:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010626d:	e9 4b f4 ff ff       	jmp    801056bd <alltraps>
...
80106274:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106279:	e9 3f f4 ff ff       	jmp    801056bd <alltraps>
...
80106280:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106285:	e9 33 f4 ff ff       	jmp    801056bd <alltraps>
...
8010628c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106291:	e9 27 f4 ff ff       	jmp    801056bd <alltraps>
...
80106298:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010629d:	e9 1b f4 ff ff       	jmp    801056bd <alltraps>
...
801062a4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062a9:	e9 0f f4 ff ff       	jmp    801056bd <alltraps>
...
801062b0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062b5:	e9 03 f4 ff ff       	jmp    801056bd <alltraps>
...
801062bc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062c1:	e9 f7 f3 ff ff       	jmp    801056bd <alltraps>
...
801062c8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062cd:	e9 eb f3 ff ff       	jmp    801056bd <alltraps>
...
801062d4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062d9:	e9 df f3 ff ff       	jmp    801056bd <alltraps>
...
801062e0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062e5:	e9 d3 f3 ff ff       	jmp    801056bd <alltraps>
...
801062ec:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062f1:	e9 c7 f3 ff ff       	jmp    801056bd <alltraps>
...
801062f8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062fd:	e9 bb f3 ff ff       	jmp    801056bd <alltraps>
...
80106304:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106309:	e9 af f3 ff ff       	jmp    801056bd <alltraps>
...
80106310:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106315:	e9 a3 f3 ff ff       	jmp    801056bd <alltraps>
...
8010631c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106321:	e9 97 f3 ff ff       	jmp    801056bd <alltraps>
...
80106328:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010632d:	e9 8b f3 ff ff       	jmp    801056bd <alltraps>
...
80106334:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106339:	e9 7f f3 ff ff       	jmp    801056bd <alltraps>
...
80106340:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106345:	e9 73 f3 ff ff       	jmp    801056bd <alltraps>
...
8010634c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106351:	e9 67 f3 ff ff       	jmp    801056bd <alltraps>
...
80106358:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010635d:	e9 5b f3 ff ff       	jmp    801056bd <alltraps>
...
80106364:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106369:	e9 4f f3 ff ff       	jmp    801056bd <alltraps>
...
80106370:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106375:	e9 43 f3 ff ff       	jmp    801056bd <alltraps>
...
8010637c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106381:	e9 37 f3 ff ff       	jmp    801056bd <alltraps>
...
80106388:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010638d:	e9 2b f3 ff ff       	jmp    801056bd <alltraps>
...
80106394:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106399:	e9 1f f3 ff ff       	jmp    801056bd <alltraps>
...
801063a0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063a5:	e9 13 f3 ff ff       	jmp    801056bd <alltraps>
...
801063ac:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063b1:	e9 07 f3 ff ff       	jmp    801056bd <alltraps>
...
801063b8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063bd:	e9 fb f2 ff ff       	jmp    801056bd <alltraps>
...
801063c4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063c9:	e9 ef f2 ff ff       	jmp    801056bd <alltraps>
...
801063d0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063d5:	e9 e3 f2 ff ff       	jmp    801056bd <alltraps>
...
801063dc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063e1:	e9 d7 f2 ff ff       	jmp    801056bd <alltraps>
...
801063e8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063ed:	e9 cb f2 ff ff       	jmp    801056bd <alltraps>
...
801063f4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063f9:	e9 bf f2 ff ff       	jmp    801056bd <alltraps>
...
80106400:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106405:	e9 b3 f2 ff ff       	jmp    801056bd <alltraps>
...
8010640c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106411:	e9 a7 f2 ff ff       	jmp    801056bd <alltraps>
...
80106418:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010641d:	e9 9b f2 ff ff       	jmp    801056bd <alltraps>
...
80106424:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106429:	e9 8f f2 ff ff       	jmp    801056bd <alltraps>
...
80106430:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106435:	e9 83 f2 ff ff       	jmp    801056bd <alltraps>
...
8010643c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106441:	e9 77 f2 ff ff       	jmp    801056bd <alltraps>
...
80106448:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010644d:	e9 6b f2 ff ff       	jmp    801056bd <alltraps>
...
80106454:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106459:	e9 5f f2 ff ff       	jmp    801056bd <alltraps>
...
80106460:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106465:	e9 53 f2 ff ff       	jmp    801056bd <alltraps>
...
8010646c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106471:	e9 47 f2 ff ff       	jmp    801056bd <alltraps>
...
80106478:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010647d:	e9 3b f2 ff ff       	jmp    801056bd <alltraps>
...
80106484:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106489:	e9 2f f2 ff ff       	jmp    801056bd <alltraps>
...
80106490:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106495:	e9 23 f2 ff ff       	jmp    801056bd <alltraps>
...
8010649c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064a1:	e9 17 f2 ff ff       	jmp    801056bd <alltraps>
...
801064a8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064ad:	e9 0b f2 ff ff       	jmp    801056bd <alltraps>
...
801064b4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064b9:	e9 ff f1 ff ff       	jmp    801056bd <alltraps>
...
801064c0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064c5:	e9 f3 f1 ff ff       	jmp    801056bd <alltraps>
...
801064cc:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064d1:	e9 e7 f1 ff ff       	jmp    801056bd <alltraps>
...
801064d8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064dd:	e9 db f1 ff ff       	jmp    801056bd <alltraps>
...
801064e4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064e9:	e9 cf f1 ff ff       	jmp    801056bd <alltraps>
...
801064f0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064f5:	e9 c3 f1 ff ff       	jmp    801056bd <alltraps>
...
801064fc:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106501:	e9 b7 f1 ff ff       	jmp    801056bd <alltraps>
...
80106508:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010650d:	e9 ab f1 ff ff       	jmp    801056bd <alltraps>
...
80106514:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106519:	e9 9f f1 ff ff       	jmp    801056bd <alltraps>
...
80106520:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106525:	e9 93 f1 ff ff       	jmp    801056bd <alltraps>
...
8010652c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106531:	e9 87 f1 ff ff       	jmp    801056bd <alltraps>
...
80106538:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010653d:	e9 7b f1 ff ff       	jmp    801056bd <alltraps>
...
80106544:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106549:	e9 6f f1 ff ff       	jmp    801056bd <alltraps>
...
80106550:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106555:	e9 63 f1 ff ff       	jmp    801056bd <alltraps>
...
8010655c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106561:	e9 57 f1 ff ff       	jmp    801056bd <alltraps>
...
80106568:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010656d:	e9 4b f1 ff ff       	jmp    801056bd <alltraps>
...
80106574:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106579:	e9 3f f1 ff ff       	jmp    801056bd <alltraps>
...
80106580:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106585:	e9 33 f1 ff ff       	jmp    801056bd <alltraps>
...
8010658c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106591:	e9 27 f1 ff ff       	jmp    801056bd <alltraps>
...
80106598:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010659d:	e9 1b f1 ff ff       	jmp    801056bd <alltraps>
...
801065a4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065a9:	e9 0f f1 ff ff       	jmp    801056bd <alltraps>
...
801065b0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065b5:	e9 03 f1 ff ff       	jmp    801056bd <alltraps>
...
801065bc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065c1:	e9 f7 f0 ff ff       	jmp    801056bd <alltraps>
...
80106632:	e8 89 de ff ff       	call   801044c0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801066d1:	c3                   	ret    
      panic("remap");
801066d2:	c7 04 24 b0 77 10 80 	movl   $0x801077b0,(%esp)
...
80106783:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106786:	e8 f5 ce ff ff       	call   80103680 <cpuid>
...
80106840:	a1 a4 55 11 80       	mov    0x801155a4,%eax
{
...
8010688f:	e8 6c cd ff ff       	call   80103600 <mycpu>
80106894:	89 c3                	mov    %eax,%ebx
80106896:	e8 65 cd ff ff       	call   80103600 <mycpu>
8010689b:	89 c7                	mov    %eax,%edi
8010689d:	e8 5e cd ff ff       	call   80103600 <mycpu>
801068a2:	83 c7 08             	add    $0x8,%edi
801068a5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068a8:	e8 53 cd ff ff       	call   80103600 <mycpu>
...
8010693b:	5d                   	pop    %ebp
  popcli();
8010693c:	e9 0f da ff ff       	jmp    80104350 <popcli>
    panic("switchuvm: no process");
80106941:	c7 04 24 b6 77 10 80 	movl   $0x801077b6,(%esp)
80106948:	e8 13 9a ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010694d:	c7 04 24 e1 77 10 80 	movl   $0x801077e1,(%esp)
80106954:	e8 07 9a ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106959:	c7 04 24 cc 77 10 80 	movl   $0x801077cc,(%esp)
...
801069a7:	e8 14 db ff ff       	call   801044c0 <memset>
...
801069db:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801069dc:	e9 7f db ff ff       	jmp    80104560 <memmove>
    panic("inituvm: more than a page");
801069e1:	c7 04 24 f5 77 10 80 	movl   $0x801077f5,(%esp)
...
80106a92:	c7 04 24 0f 78 10 80 	movl   $0x8010780f,(%esp)
80106a99:	e8 c2 98 ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
80106a9e:	c7 04 24 b0 78 10 80 	movl   $0x801078b0,(%esp)
...
80106af3:	e8 c8 d9 ff ff       	call   801044c0 <memset>
...
80106b31:	c7 04 24 2d 78 10 80 	movl   $0x8010782d,(%esp)
...
80106b60:	c7 04 24 45 78 10 80 	movl   $0x80107845,(%esp)
...
80106c23:	e9 c8 b6 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106c28:	c7 04 24 61 78 10 80 	movl   $0x80107861,(%esp)
...
80106c6b:	e8 50 d8 ff ff       	call   801044c0 <memset>
...
80106cdb:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106d0b:	c3                   	ret    
    panic("clearpteu");
80106d0c:	c7 04 24 72 78 10 80 	movl   $0x80107872,(%esp)
...
80106d5d:	e8 fe d7 ff ff       	call   80104560 <memmove>
...
80106df4:	eb d8                	jmp    80106dce <copyuvm+0xae>
      panic("copyuvm: page not present");
80106df6:	c7 04 24 96 78 10 80 	movl   $0x80107896,(%esp)
80106dfd:	e8 5e 95 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106e02:	c7 04 24 7c 78 10 80 	movl   $0x8010787c,(%esp)
...
80106e8c:	e8 cf d6 ff ff       	call   80104560 <memmove>
    len -= n;
    buf += n;
