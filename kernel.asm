...
8010009b:	80 
8010009c:	e8 2f 41 00 00       	call   801041d0 <initsleeplock>
...
801000e3:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000e6:	e8 85 43 00 00       	call   80104470 <acquire>
...
8010016c:	e8 9f 40 00 00       	call   80104210 <acquiresleep>
  struct buf *b;
...
801001b0:	e8 fb 40 00 00       	call   801042b0 <holdingsleep>
...
801001f1:	e8 ba 40 00 00       	call   801042b0 <holdingsleep>
...
801001fd:	e8 6e 40 00 00       	call   80104270 <releasesleep>

  acquire(&bcache.lock);
80100202:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100209:	e8 62 42 00 00       	call   80104470 <acquire>
  b->refcnt--;
  if (b->refcnt == 0) {
...
8010028e:	e8 dd 41 00 00       	call   80104470 <acquire>
  while(n > 0){
...
80100311:	e8 ca 41 00 00       	call   801044e0 <release>
  ilock(ip);
...
801003af:	e8 6c 3f 00 00       	call   80104320 <getcallerpcs>
...
8010060e:	e8 5d 3e 00 00       	call   80104470 <acquire>
...
80100797:	e8 d4 3c 00 00       	call   80104470 <acquire>
...
801007c5:	e8 a6 3c 00 00       	call   80104470 <acquire>
...
801008ad:	a3 a4 ff 10 80       	mov    %eax,0x8010ffa4
          wakeup(&input.r);
801008b2:	e8 69 37 00 00       	call   80104020 <wakeup>
...
80100927:	e9 d4 37 00 00       	jmp    80104100 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100a2a:	75 d4                	jne    80100a00 <exec+0x60>
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 7f 62 00 00       	call   80106cb0 <setupkvm>
...
80100b93:	e8 e8 1f 00 00       	call   80102b80 <end_op>
    cprintf("exec: fail\n");
80100b98:	c7 04 24 e1 6f 10 80 	movl   $0x80106fe1,(%esp)
...
80100bc8:	e8 93 61 00 00       	call   80106d60 <clearpteu>
...
80100c01:	e8 4a 3b 00 00       	call   80104750 <strlen>
...
80100c12:	e8 39 3b 00 00       	call   80104750 <strlen>
...
80100c31:	e8 8a 62 00 00       	call   80106ec0 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 17 62 00 00       	call   80106ec0 <copyout>
...
80100cf1:	e8 1a 3a 00 00       	call   80104710 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d1f:	e8 ac 5b 00 00       	call   801068d0 <switchuvm>
  freevm(oldpgdir);
80100d24:	89 34 24             	mov    %esi,(%esp)
80100d27:	e8 04 5f 00 00       	call   80106c30 <freevm>
  return 0;
...
80100d56:	c7 44 24 04 ed 6f 10 	movl   $0x80106fed,0x4(%esp)
80100d5d:	80 
...
80100d83:	e8 e8 36 00 00       	call   80104470 <acquire>
...
80100da9:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100db0:	e8 2b 37 00 00       	call   801044e0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dc7:	e8 14 37 00 00       	call   801044e0 <release>
}
...
80100df1:	e8 7a 36 00 00       	call   80104470 <acquire>
  if(f->ref < 1)
...
80100e0a:	e8 d1 36 00 00       	call   801044e0 <release>
  return f;
}
...
80100e16:	c3                   	ret    
    panic("filedup");
80100e17:	c7 04 24 f4 6f 10 80 	movl   $0x80106ff4,(%esp)
...
80100e43:	e8 28 36 00 00       	call   80104470 <acquire>
  if(f->ref < 1)
...
80100e6a:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e6b:	e9 70 36 00 00       	jmp    801044e0 <release>
  ff = *f;
...
80100e8c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e8f:	e8 4c 36 00 00       	call   801044e0 <release>
  if(ff.type == FD_PIPE)
...
80100ed7:	e9 a4 1c 00 00       	jmp    80102b80 <end_op>
    panic("fileclose");
80100edc:	c7 04 24 fc 6f 10 80 	movl   $0x80106ffc,(%esp)
...
80100fc5:	eb d8                	jmp    80100f9f <fileread+0x5f>
  panic("fileread");
80100fc7:	c7 04 24 06 70 10 80 	movl   $0x80107006,(%esp)
...
801010dc:	e9 0f 22 00 00       	jmp    801032f0 <pipewrite>
        panic("short filewrite");
801010e1:	c7 04 24 0f 70 10 80 	movl   $0x8010700f,(%esp)
801010e8:	e8 73 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010ed:	c7 04 24 15 70 10 80 	movl   $0x80107015,(%esp)
...
80101164:	c3                   	ret    
    panic("freeing free block");
80101165:	c7 04 24 1f 70 10 80 	movl   $0x8010701f,(%esp)
...
80101225:	c7 04 24 32 70 10 80 	movl   $0x80107032,(%esp)
...
80101278:	e8 b3 32 00 00       	call   80104530 <memset>
  log_write(bp);
...
801012b9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
801012bc:	e8 af 31 00 00       	call   80104470 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801012f6:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012f9:	e8 e2 31 00 00       	call   801044e0 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
8010133e:	e8 9d 31 00 00       	call   801044e0 <release>
}
...
8010134d:	c7 04 24 48 70 10 80 	movl   $0x80107048,(%esp)
...
80101405:	eb 93                	jmp    8010139a <bmap+0x3a>
  panic("bmap: out of range");
80101407:	c7 04 24 58 70 10 80 	movl   $0x80107058,(%esp)
...
80101452:	e8 79 31 00 00       	call   801045d0 <memmove>
  brelse(bp);
...
801014a0:	80 
801014a1:	e8 2a 2d 00 00       	call   801041d0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015a9:	e8 82 2f 00 00       	call   80104530 <memset>
      dip->type = type;
...
8010165f:	00 
80101660:	e8 6b 2f 00 00       	call   801045d0 <memmove>
  log_write(bp);
...
80101691:	e8 da 2d 00 00       	call   80104470 <acquire>
  ip->ref++;
80101696:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010169a:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016a1:	e8 3a 2e 00 00       	call   801044e0 <release>
}
...
801016d4:	e8 37 2b 00 00       	call   80104210 <acquiresleep>
  if(ip->valid == 0){
...
8010174b:	e8 80 2e 00 00       	call   801045d0 <memmove>
    brelse(bp);
...
801017a5:	e8 06 2b 00 00       	call   801042b0 <holdingsleep>
...
801017bd:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017be:	e9 ad 2a 00 00       	jmp    80104270 <releasesleep>
    panic("iunlock");
...
801017e2:	e8 29 2a 00 00       	call   80104210 <acquiresleep>
...
801017f8:	e8 73 2a 00 00       	call   80104270 <releasesleep>
  acquire(&icache.lock);
801017fd:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101804:	e8 67 2c 00 00       	call   80104470 <acquire>
  ip->ref--;
...
8010181a:	5d                   	pop    %ebp
  release(&icache.lock);
8010181b:	e9 c0 2c 00 00       	jmp    801044e0 <release>
    acquire(&icache.lock);
80101820:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101827:	e8 44 2c 00 00       	call   80104470 <acquire>
    int r = ip->ref;
8010182c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010182f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101836:	e8 a5 2c 00 00       	call   801044e0 <release>
    if(r == 1){
...
80101a08:	e8 c3 2b 00 00       	call   801045d0 <memmove>
    brelse(bp);
...
80101b04:	e8 c7 2a 00 00       	call   801045d0 <memmove>
    log_write(bp);
...
80101bab:	e8 a0 2a 00 00       	call   80104650 <strncmp>
}
80101bb0:	c9                   	leave  
80101bb1:	c3                   	ret    
...
80101c29:	e8 22 2a 00 00       	call   80104650 <strncmp>
      continue;
...
80101ca8:	e8 c3 27 00 00       	call   80104470 <acquire>
  ip->ref++;
80101cad:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cb1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cb8:	e8 23 28 00 00       	call   801044e0 <release>
...
80101d1b:	e8 b0 28 00 00       	call   801045d0 <memmove>
    path++;
...
80101da9:	e8 22 28 00 00       	call   801045d0 <memmove>
    name[len] = 0;
...
80101ea3:	e8 18 28 00 00       	call   801046c0 <strncpy>
  de.inum = inum;
...
80102015:	e8 e6 22 00 00       	call   80104300 <initlock>
...
80102090:	e8 db 23 00 00       	call   80104470 <acquire>
...
801020bc:	e8 5f 1f 00 00       	call   80104020 <wakeup>
...
801020d6:	e8 05 24 00 00       	call   801044e0 <release>
...
80102130:	e8 7b 21 00 00       	call   801042b0 <holdingsleep>
...
80102166:	e8 05 23 00 00       	call   80104470 <acquire>
...
801021c5:	5d                   	pop    %ebp
  release(&idelock);
801021c6:	e9 15 23 00 00       	jmp    801044e0 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
8010232a:	e8 01 22 00 00       	call   80104530 <memset>
...
801024cd:	e8 0e 20 00 00       	call   801044e0 <release>
  return (char*)r;
}
...
801024e7:	e8 84 1f 00 00       	call   80104470 <acquire>
...
8010289c:	e8 df 1c 00 00       	call   80104580 <memcmp>
...
801029c7:	e8 04 1c 00 00       	call   801045d0 <memmove>
...
80102a8a:	e8 71 18 00 00       	call   80104300 <initlock>
  readsb(dev, &sb);
...
80102b1d:	e8 4e 19 00 00       	call   80104470 <acquire>
...
80102b65:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b6a:	e8 71 19 00 00       	call   801044e0 <release>
      break;
    }
  }
}
...
80102b90:	e8 db 18 00 00       	call   80104470 <acquire>
  log.outstanding -= 1;
...
80102bc8:	00 00 00 
  release(&log.lock);
80102bcb:	e8 10 19 00 00       	call   801044e0 <release>
  if (log.lh.n > 0) {
...
80102c2f:	e8 9c 19 00 00       	call   801045d0 <memmove>
...
80102ced:	e8 7e 17 00 00       	call   80104470 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d3e:	5d                   	pop    %ebp
  release(&log.lock);
80102d3f:	e9 9c 17 00 00       	jmp    801044e0 <release>
...
80102da7:	e8 44 2a 00 00       	call   801057f0 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 d5 3a 00 00       	call   801068b0 <switchkvm>
  seginit();
80102ddb:	e8 10 3a 00 00       	call   801067f0 <seginit>
  lapicinit();
...
80102e13:	e8 28 3f 00 00       	call   80106d40 <kvmalloc>
...
80102e25:	e8 c6 39 00 00       	call   801067f0 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 d1 2c 00 00       	call   80105b10 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 06 29 00 00       	call   80105750 <tvinit>
  binit();         // buffer cache
...
80102e71:	e8 5a 17 00 00       	call   801045d0 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f4b:	e8 30 16 00 00       	call   80104580 <memcmp>
...
80103006:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103009:	e8 72 15 00 00       	call   80104580 <memcmp>
...
801031e6:	80 
801031e7:	e8 14 11 00 00       	call   80104300 <initlock>
  (*f0)->type = FD_PIPE;
...
80103271:	e8 fa 11 00 00       	call   80104470 <acquire>
  if(writable){
...
8010328d:	e8 8e 0d 00 00       	call   80104020 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032ae:	5d                   	pop    %ebp
    release(&p->lock);
801032af:	e9 2c 12 00 00       	jmp    801044e0 <release>
...
8010334f:	e8 cc 0c 00 00       	call   80104020 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
80103382:	e8 59 11 00 00       	call   801044e0 <release>
        return -1;
...
801033ca:	e8 51 0c 00 00       	call   80104020 <wakeup>
  release(&p->lock);
801033cf:	89 1c 24             	mov    %ebx,(%esp)
801033d2:	e8 09 11 00 00       	call   801044e0 <release>
  return n;
...
801033f2:	e8 79 10 00 00       	call   80104470 <acquire>
...
8010344b:	e8 90 10 00 00       	call   801044e0 <release>
...
801034a5:	e8 76 0b 00 00       	call   80104020 <wakeup>
  release(&p->lock);
801034aa:	89 34 24             	mov    %esi,(%esp)
801034ad:	e8 2e 10 00 00       	call   801044e0 <release>
}
...
801034d3:	e8 98 0f 00 00       	call   80104470 <acquire>
...
8010350e:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103511:	e8 ca 0f 00 00       	call   801044e0 <release>
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 45 57 10 80 	movl   $0x80105745,0x14(%eax)
...
8010354a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010354d:	e8 de 0f 00 00       	call   80104530 <memset>
...
8010356f:	e8 6c 0f 00 00       	call   801044e0 <release>
}
...
8010359d:	e8 3e 0f 00 00       	call   801044e0 <release>
...
801035f5:	e8 06 0d 00 00       	call   80104300 <initlock>
}
801035fa:	c9                   	leave  
801035fb:	c3                   	ret    
...
801036a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036a7:	e8 d4 0c 00 00       	call   80104380 <pushcli>
  c = mycpu();
801036ac:	e8 4f ff ff ff       	call   80103600 <mycpu>
  p = c->proc;
801036b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036b7:	e8 04 0d 00 00       	call   801043c0 <popcli>
}
...
801036e3:	e8 c8 35 00 00       	call   80106cb0 <setupkvm>
...
80103705:	80 
80103706:	e8 d5 32 00 00       	call   801069e0 <inituvm>
  p->sz = PGSIZE;
...
80103727:	e8 04 0e 00 00       	call   80104530 <memset>
...
8010378e:	e8 7d 0f 00 00       	call   80104710 <safestrcpy>
  p->cwd = namei("/");
...
80103809:	e8 12 33 00 00       	call   80106b20 <allocuvm>
...
80103817:	e8 b4 30 00 00       	call   801068d0 <switchuvm>
  return 0;
...
8010383a:	e8 d1 33 00 00       	call   80106c10 <deallocuvm>
...
8010387e:	e8 0d 35 00 00       	call   80106d90 <copyuvm>
...
80103988:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
8010398d:	e8 de 0a 00 00       	call   80104470 <acquire>
...
801039b2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039b5:	e8 16 2f 00 00       	call   801068d0 <switchuvm>
...
801039cb:	e8 9b 0d 00 00       	call   8010476b <swtch>
      switchkvm();
801039d0:	e8 db 2e 00 00       	call   801068b0 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801039ef:	e8 ec 0a 00 00       	call   801044e0 <release>
  }
...
80103a14:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103a16:	e8 15 0a 00 00       	call   80104430 <holding>
...
80103a57:	e8 0f 0d 00 00       	call   8010476b <swtch>
  mycpu()->intena = intena;
...
80103b03:	e8 68 09 00 00       	call   80104470 <acquire>
...
80103c23:	e8 48 08 00 00       	call   80104470 <acquire>
  wakeup1(curproc->parent);
...
80103cbc:	e8 3f fd ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103cc1:	c7 04 24 3d 75 10 80 	movl   $0x8010753d,(%esp)
80103cc8:	e8 93 c6 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103ccd:	c7 04 24 30 75 10 80 	movl   $0x80107530,(%esp)
...
80103ced:	e8 7e 07 00 00       	call   80104470 <acquire>
...
80103d0a:	e8 d1 07 00 00       	call   801044e0 <release>
}
80103d0f:	c9                   	leave  
80103d10:	c3                   	ret    
...
80103d51:	e8 1a 07 00 00       	call   80104470 <acquire>
    release(lk);
80103d56:	89 34 24             	mov    %esi,(%esp)
80103d59:	e8 82 07 00 00       	call   801044e0 <release>
  p->chan = chan;
...
80103d7b:	e8 60 07 00 00       	call   801044e0 <release>
    acquire(lk);
...
80103d89:	5d                   	pop    %ebp
    acquire(lk);
80103d8a:	e9 e1 06 00 00       	jmp    80104470 <acquire>
80103d8f:	90                   	nop
  p->chan = chan;
...
80103dae:	c7 04 24 4f 75 10 80 	movl   $0x8010754f,(%esp)
80103db5:	e8 a6 c5 ff ff       	call   80100360 <panic>
    panic("sleep");
80103dba:	c7 04 24 49 75 10 80 	movl   $0x80107549,(%esp)
...
80103de8:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103dea:	e8 81 06 00 00       	call   80104470 <acquire>
    havekids = 0;
...
80103e58:	e8 d3 2d 00 00       	call   80106c30 <freevm>
        release(&ptable.lock);
...
80103e7d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103e84:	e8 57 06 00 00       	call   801044e0 <release>
...
80103ed8:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103eda:	e8 91 05 00 00       	call   80104470 <acquire>
  if(options == 1){
80103edf:	83 7d 10 01          	cmpl   $0x1,0x10(%ebp)
80103ee3:	75 7e                	jne    80103f63 <waitpid+0xa3>
80103ee5:	31 c0                	xor    %eax,%eax
80103ee7:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103eec:	eb 0d                	jmp    80103efb <waitpid+0x3b>
80103eee:	66 90                	xchg   %ax,%ax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ef0:	83 ea 80             	sub    $0xffffff80,%edx
80103ef3:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
80103ef9:	74 25                	je     80103f20 <waitpid+0x60>
      if(p->parent != curproc)
80103efb:	39 72 14             	cmp    %esi,0x14(%edx)
80103efe:	75 f0                	jne    80103ef0 <waitpid+0x30>
      if(p->pid == pid){
80103f00:	39 7a 10             	cmp    %edi,0x10(%edx)
80103f03:	0f 84 f0 00 00 00    	je     80103ff9 <waitpid+0x139>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f09:	83 ea 80             	sub    $0xffffff80,%edx
      havekids = 1;
80103f0c:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f11:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
80103f17:	75 e2                	jne    80103efb <waitpid+0x3b>
80103f19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(!havekids || curproc->killed){
80103f20:	85 c0                	test   %eax,%eax
80103f22:	0f 84 dc 00 00 00    	je     80104004 <waitpid+0x144>
80103f28:	8b 46 24             	mov    0x24(%esi),%eax
80103f2b:	85 c0                	test   %eax,%eax
80103f2d:	0f 85 d1 00 00 00    	jne    80104004 <waitpid+0x144>
}
80103f33:	83 c4 1c             	add    $0x1c,%esp
80103f36:	5b                   	pop    %ebx
80103f37:	5e                   	pop    %esi
80103f38:	5f                   	pop    %edi
80103f39:	5d                   	pop    %ebp
...
80103f42:	0f 84 bc 00 00 00    	je     80104004 <waitpid+0x144>
80103f48:	8b 46 24             	mov    0x24(%esi),%eax
80103f4b:	85 c0                	test   %eax,%eax
80103f4d:	0f 85 b1 00 00 00    	jne    80104004 <waitpid+0x144>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103f53:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103f5a:	80 
80103f5b:	89 34 24             	mov    %esi,(%esp)
80103f5e:	e8 bd fd ff ff       	call   80103d20 <sleep>
    havekids = 0;
80103f63:	31 d2                	xor    %edx,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f65:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103f6a:	eb 0f                	jmp    80103f7b <waitpid+0xbb>
80103f6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f70:	83 eb 80             	sub    $0xffffff80,%ebx
80103f73:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103f79:	74 c5                	je     80103f40 <waitpid+0x80>
      if(p->parent != curproc)
80103f7b:	39 73 14             	cmp    %esi,0x14(%ebx)
80103f7e:	75 f0                	jne    80103f70 <waitpid+0xb0>
      if(p->state == ZOMBIE && p->pid == pid){
80103f80:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
      havekids = 1;
80103f84:	ba 01 00 00 00       	mov    $0x1,%edx
      if(p->state == ZOMBIE && p->pid == pid){
80103f89:	75 e5                	jne    80103f70 <waitpid+0xb0>
80103f8b:	8b 43 10             	mov    0x10(%ebx),%eax
80103f8e:	39 f8                	cmp    %edi,%eax
80103f90:	75 de                	jne    80103f70 <waitpid+0xb0>
        kfree(p->kstack);
80103f92:	8b 53 08             	mov    0x8(%ebx),%edx
80103f95:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103f98:	89 14 24             	mov    %edx,(%esp)
80103f9b:	e8 50 e3 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80103fa0:	8b 53 04             	mov    0x4(%ebx),%edx
        p->kstack = 0;
80103fa3:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103faa:	89 14 24             	mov    %edx,(%esp)
80103fad:	e8 7e 2c 00 00       	call   80106c30 <freevm>
        release(&ptable.lock);
80103fb2:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103fb9:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103fc0:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103fc7:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103fcb:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103fd2:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fd9:	e8 02 05 00 00       	call   801044e0 <release>
	if(waitStatus != ((void*)0))
80103fde:	8b 55 0c             	mov    0xc(%ebp),%edx
80103fe1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103fe4:	85 d2                	test   %edx,%edx
80103fe6:	0f 84 47 ff ff ff    	je     80103f33 <waitpid+0x73>
	*waitStatus = p->exitStat;
80103fec:	8b 53 7c             	mov    0x7c(%ebx),%edx
80103fef:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103ff2:	89 11                	mov    %edx,(%ecx)
80103ff4:	e9 3a ff ff ff       	jmp    80103f33 <waitpid+0x73>
        return p->exitStat;
80103ff9:	8b 42 7c             	mov    0x7c(%edx),%eax
}
80103ffc:	83 c4 1c             	add    $0x1c,%esp
80103fff:	5b                   	pop    %ebx
80104000:	5e                   	pop    %esi
80104001:	5f                   	pop    %edi
80104002:	5d                   	pop    %ebp
...
8010400b:	e8 d0 04 00 00       	call   801044e0 <release>
      return -1;
80104010:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104015:	e9 19 ff ff ff       	jmp    80103f33 <waitpid+0x73>
...
80104027:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010402a:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104031:	e8 3a 04 00 00       	call   80104470 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104036:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010403b:	eb 0d                	jmp    8010404a <wakeup+0x2a>
8010403d:	8d 76 00             	lea    0x0(%esi),%esi
80104040:	83 e8 80             	sub    $0xffffff80,%eax
80104043:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80104048:	74 1e                	je     80104068 <wakeup+0x48>
    if(p->state == SLEEPING && p->chan == chan)
...
80104066:	66 90                	xchg   %ax,%ax
  wakeup1(chan);
  release(&ptable.lock);
80104068:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
8010406f:	83 c4 14             	add    $0x14,%esp
80104072:	5b                   	pop    %ebx
80104073:	5d                   	pop    %ebp
  release(&ptable.lock);
80104074:	e9 67 04 00 00       	jmp    801044e0 <release>
...
80104087:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010408a:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104091:	e8 da 03 00 00       	call   80104470 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104096:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010409b:	eb 0d                	jmp    801040aa <kill+0x2a>
...
801040b3:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
801040ba:	74 14                	je     801040d0 <kill+0x50>
        p->state = RUNNABLE;
      release(&ptable.lock);
801040bc:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801040c3:	e8 18 04 00 00       	call   801044e0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801040c8:	83 c4 14             	add    $0x14,%esp
      return 0;
...
80104106:	bb c0 2d 11 80       	mov    $0x80112dc0,%ebx
8010410b:	83 ec 4c             	sub    $0x4c,%esp
8010410e:	8d 75 e8             	lea    -0x18(%ebp),%esi
80104111:	eb 20                	jmp    80104133 <procdump+0x33>
80104113:	90                   	nop
80104114:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80104118:	c7 04 24 df 78 10 80 	movl   $0x801078df,(%esp)
8010411f:	e8 2c c5 ff ff       	call   80100650 <cprintf>
80104124:	83 eb 80             	sub    $0xffffff80,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104127:	81 fb c0 4d 11 80    	cmp    $0x80114dc0,%ebx
8010412d:	0f 84 8d 00 00 00    	je     801041c0 <procdump+0xc0>
    if(p->state == UNUSED)
80104133:	8b 43 a0             	mov    -0x60(%ebx),%eax
80104136:	85 c0                	test   %eax,%eax
80104138:	74 ea                	je     80104124 <procdump+0x24>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010413a:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
8010413d:	ba 60 75 10 80       	mov    $0x80107560,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104142:	77 11                	ja     80104155 <procdump+0x55>
80104144:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
      state = "???";
8010414b:	b8 60 75 10 80       	mov    $0x80107560,%eax
80104150:	85 d2                	test   %edx,%edx
80104152:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80104155:	8b 43 a4             	mov    -0x5c(%ebx),%eax
80104158:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010415c:	89 54 24 08          	mov    %edx,0x8(%esp)
80104160:	c7 04 24 64 75 10 80 	movl   $0x80107564,(%esp)
80104167:	89 44 24 04          	mov    %eax,0x4(%esp)
8010416b:	e8 e0 c4 ff ff       	call   80100650 <cprintf>
    if(p->state == SLEEPING){
80104170:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80104174:	75 a2                	jne    80104118 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104176:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104179:	89 44 24 04          	mov    %eax,0x4(%esp)
8010417d:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104180:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104183:	8b 40 0c             	mov    0xc(%eax),%eax
80104186:	83 c0 08             	add    $0x8,%eax
80104189:	89 04 24             	mov    %eax,(%esp)
8010418c:	e8 8f 01 00 00       	call   80104320 <getcallerpcs>
...
801041a6:	83 c7 04             	add    $0x4,%edi
801041a9:	c7 04 24 a1 6f 10 80 	movl   $0x80106fa1,(%esp)
801041b0:	e8 9b c4 ff ff       	call   80100650 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801041b5:	39 f7                	cmp    %esi,%edi
801041b7:	75 df                	jne    80104198 <procdump+0x98>
801041b9:	e9 5a ff ff ff       	jmp    80104118 <procdump+0x18>
...
801041da:	c7 44 24 04 d8 75 10 	movl   $0x801075d8,0x4(%esp)
801041e1:	80 
801041e2:	8d 43 04             	lea    0x4(%ebx),%eax
801041e5:	89 04 24             	mov    %eax,(%esp)
801041e8:	e8 13 01 00 00       	call   80104300 <initlock>
  lk->name = name;
801041ed:	8b 45 0c             	mov    0xc(%ebp),%eax
  lk->locked = 0;
801041f0:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801041f6:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
801041fd:	89 43 38             	mov    %eax,0x38(%ebx)
}
80104200:	83 c4 14             	add    $0x14,%esp
80104203:	5b                   	pop    %ebx
80104204:	5d                   	pop    %ebp
80104205:	c3                   	ret    
...
80104221:	e8 4a 02 00 00       	call   80104470 <acquire>
  while (lk->locked) {
80104226:	8b 13                	mov    (%ebx),%edx
80104228:	85 d2                	test   %edx,%edx
8010422a:	74 16                	je     80104242 <acquiresleep+0x32>
8010422c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
80104230:	89 74 24 04          	mov    %esi,0x4(%esp)
80104234:	89 1c 24             	mov    %ebx,(%esp)
80104237:	e8 e4 fa ff ff       	call   80103d20 <sleep>
  while (lk->locked) {
8010423c:	8b 03                	mov    (%ebx),%eax
8010423e:	85 c0                	test   %eax,%eax
80104240:	75 ee                	jne    80104230 <acquiresleep+0x20>
  }
  lk->locked = 1;
80104242:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104248:	e8 53 f4 ff ff       	call   801036a0 <myproc>
8010424d:	8b 40 10             	mov    0x10(%eax),%eax
80104250:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
...
8010425b:	5d                   	pop    %ebp
  release(&lk->lk);
8010425c:	e9 7f 02 00 00       	jmp    801044e0 <release>
80104261:	eb 0d                	jmp    80104270 <releasesleep>
80104263:	90                   	nop
80104264:	90                   	nop
80104265:	90                   	nop
80104266:	90                   	nop
...
80104281:	e8 ea 01 00 00       	call   80104470 <acquire>
  lk->locked = 0;
80104286:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
8010428c:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80104293:	89 1c 24             	mov    %ebx,(%esp)
80104296:	e8 85 fd ff ff       	call   80104020 <wakeup>
  release(&lk->lk);
8010429b:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801042a3:	5d                   	pop    %ebp
  release(&lk->lk);
801042a4:	e9 37 02 00 00       	jmp    801044e0 <release>
...
801042c1:	89 34 24             	mov    %esi,(%esp)
801042c4:	e8 a7 01 00 00       	call   80104470 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
801042c9:	8b 03                	mov    (%ebx),%eax
801042cb:	85 c0                	test   %eax,%eax
801042cd:	74 13                	je     801042e2 <holdingsleep+0x32>
801042cf:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
801042d2:	e8 c9 f3 ff ff       	call   801036a0 <myproc>
801042d7:	3b 58 10             	cmp    0x10(%eax),%ebx
801042da:	0f 94 c0             	sete   %al
801042dd:	0f b6 c0             	movzbl %al,%eax
801042e0:	89 c7                	mov    %eax,%edi
  release(&lk->lk);
801042e2:	89 34 24             	mov    %esi,(%esp)
801042e5:	e8 f6 01 00 00       	call   801044e0 <release>
  return r;
}
801042ea:	83 c4 1c             	add    $0x1c,%esp
801042ed:	89 f8                	mov    %edi,%eax
801042ef:	5b                   	pop    %ebx
801042f0:	5e                   	pop    %esi
801042f1:	5f                   	pop    %edi
801042f2:	5d                   	pop    %ebp
801042f3:	c3                   	ret    
801042f4:	66 90                	xchg   %ax,%ax
...
80104389:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010438a:	e8 71 f2 ff ff       	call   80103600 <mycpu>
8010438f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104395:	85 c0                	test   %eax,%eax
80104397:	75 11                	jne    801043aa <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
80104399:	e8 62 f2 ff ff       	call   80103600 <mycpu>
8010439e:	81 e3 00 02 00 00    	and    $0x200,%ebx
801043a4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801043aa:	e8 51 f2 ff ff       	call   80103600 <mycpu>
...
801043cb:	75 49                	jne    80104416 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
801043cd:	e8 2e f2 ff ff       	call   80103600 <mycpu>
...
801043e5:	e8 16 f2 ff ff       	call   80103600 <mycpu>
...
801043f6:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
801043f8:	e8 03 f2 ff ff       	call   80103600 <mycpu>
...
80104409:	c3                   	ret    
    panic("popcli");
8010440a:	c7 04 24 fa 75 10 80 	movl   $0x801075fa,(%esp)
80104411:	e8 4a bf ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104416:	c7 04 24 e3 75 10 80 	movl   $0x801075e3,(%esp)
...
80104443:	74 12                	je     80104457 <holding+0x27>
80104445:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104448:	e8 b3 f1 ff ff       	call   80103600 <mycpu>
8010444d:	39 c3                	cmp    %eax,%ebx
8010444f:	0f 94 c0             	sete   %al
80104452:	0f b6 c0             	movzbl %al,%eax
80104455:	89 c6                	mov    %eax,%esi
  popcli();
80104457:	e8 64 ff ff ff       	call   801043c0 <popcli>
}
8010445c:	89 f0                	mov    %esi,%eax
8010445e:	5b                   	pop    %ebx
8010445f:	5e                   	pop    %esi
80104460:	5d                   	pop    %ebp
80104461:	c3                   	ret    
...
80104477:	e8 04 ff ff ff       	call   80104380 <pushcli>
  if(holding(lk))
8010447c:	8b 45 08             	mov    0x8(%ebp),%eax
8010447f:	89 04 24             	mov    %eax,(%esp)
80104482:	e8 a9 ff ff ff       	call   80104430 <holding>
80104487:	85 c0                	test   %eax,%eax
80104489:	75 3a                	jne    801044c5 <acquire+0x55>
  asm volatile("lock; xchgl %0, %1" :
8010448b:	b9 01 00 00 00       	mov    $0x1,%ecx
  while(xchg(&lk->locked, 1) != 0)
80104490:	8b 55 08             	mov    0x8(%ebp),%edx
80104493:	89 c8                	mov    %ecx,%eax
80104495:	f0 87 02             	lock xchg %eax,(%edx)
80104498:	85 c0                	test   %eax,%eax
8010449a:	75 f4                	jne    80104490 <acquire+0x20>
  __sync_synchronize();
8010449c:	0f ae f0             	mfence 
  lk->cpu = mycpu();
8010449f:	8b 5d 08             	mov    0x8(%ebp),%ebx
801044a2:	e8 59 f1 ff ff       	call   80103600 <mycpu>
...
801044ba:	e8 61 fe ff ff       	call   80104320 <getcallerpcs>
}
801044bf:	83 c4 14             	add    $0x14,%esp
801044c2:	5b                   	pop    %ebx
801044c3:	5d                   	pop    %ebp
801044c4:	c3                   	ret    
    panic("acquire");
801044c5:	c7 04 24 01 76 10 80 	movl   $0x80107601,(%esp)
...
801044e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
801044ea:	89 1c 24             	mov    %ebx,(%esp)
801044ed:	e8 3e ff ff ff       	call   80104430 <holding>
801044f2:	85 c0                	test   %eax,%eax
801044f4:	74 21                	je     80104517 <release+0x37>
  lk->pcs[0] = 0;
801044f6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801044fd:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104504:	0f ae f0             	mfence 
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104507:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
8010450d:	83 c4 14             	add    $0x14,%esp
80104510:	5b                   	pop    %ebx
80104511:	5d                   	pop    %ebp
  popcli();
80104512:	e9 a9 fe ff ff       	jmp    801043c0 <popcli>
    panic("release");
80104517:	c7 04 24 09 76 10 80 	movl   $0x80107609,(%esp)
8010451e:	e8 3d be ff ff       	call   80100360 <panic>
...
80104787:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010478a:	e8 11 ef ff ff       	call   801036a0 <myproc>
...
801047d1:	76 26                	jbe    801047f9 <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
...
801047de:	73 19                	jae    801047f9 <fetchstr+0x39>
    if(*s == 0)
801047e0:	80 3b 00             	cmpb   $0x0,(%ebx)
801047e3:	75 0d                	jne    801047f2 <fetchstr+0x32>
801047e5:	eb 21                	jmp    80104808 <fetchstr+0x48>
801047e7:	90                   	nop
801047e8:	80 3a 00             	cmpb   $0x0,(%edx)
801047eb:	90                   	nop
801047ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801047f0:	74 16                	je     80104808 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
801047f2:	83 c2 01             	add    $0x1,%edx
801047f5:	39 d0                	cmp    %edx,%eax
801047f7:	77 ef                	ja     801047e8 <fetchstr+0x28>
      return s - *pp;
  }
  return -1;
}
...
80104808:	83 c4 04             	add    $0x4,%esp
      return s - *pp;
8010480b:	89 d0                	mov    %edx,%eax
8010480d:	29 d8                	sub    %ebx,%eax
}
8010480f:	5b                   	pop    %ebx
80104810:	5d                   	pop    %ebp
80104811:	c3                   	ret    
...
80104824:	8b 75 0c             	mov    0xc(%ebp),%esi
80104827:	53                   	push   %ebx
80104828:	8b 5d 08             	mov    0x8(%ebp),%ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010482b:	e8 70 ee ff ff       	call   801036a0 <myproc>
80104830:	89 75 0c             	mov    %esi,0xc(%ebp)
80104833:	8b 40 18             	mov    0x18(%eax),%eax
80104836:	8b 40 44             	mov    0x44(%eax),%eax
80104839:	8d 44 98 04          	lea    0x4(%eax,%ebx,4),%eax
8010483d:	89 45 08             	mov    %eax,0x8(%ebp)
}
80104840:	5b                   	pop    %ebx
80104841:	5e                   	pop    %esi
80104842:	5d                   	pop    %ebp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104843:	e9 38 ff ff ff       	jmp    80104780 <fetchint>
80104848:	90                   	nop
...
80104855:	83 ec 20             	sub    $0x20,%esp
80104858:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010485b:	e8 40 ee ff ff       	call   801036a0 <myproc>
...
8010486f:	e8 ac ff ff ff       	call   80104820 <argint>
...
80104883:	73 1b                	jae    801048a0 <argptr+0x50>
80104885:	01 d3                	add    %edx,%ebx
80104887:	39 d8                	cmp    %ebx,%eax
80104889:	72 15                	jb     801048a0 <argptr+0x50>
    return -1;
  *pp = (char*)i;
8010488b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010488e:	89 10                	mov    %edx,(%eax)
  return 0;
}
...
801048c3:	e8 58 ff ff ff       	call   80104820 <argint>
801048c8:	85 c0                	test   %eax,%eax
801048ca:	78 14                	js     801048e0 <argstr+0x30>
    return -1;
  return fetchstr(addr, pp);
801048cc:	8b 45 0c             	mov    0xc(%ebp),%eax
801048cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801048d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048d6:	89 04 24             	mov    %eax,(%esp)
801048d9:	e8 e2 fe ff ff       	call   801047c0 <fetchstr>
}
801048de:	c9                   	leave  
801048df:	c3                   	ret    
    return -1;
...
801048f5:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
801048f8:	e8 a3 ed ff ff       	call   801036a0 <myproc>

  num = curproc->tf->eax;
801048fd:	8b 70 18             	mov    0x18(%eax),%esi
  struct proc *curproc = myproc();
80104900:	89 c3                	mov    %eax,%ebx
  num = curproc->tf->eax;
80104902:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104905:	8d 50 ff             	lea    -0x1(%eax),%edx
80104908:	83 fa 16             	cmp    $0x16,%edx
8010490b:	77 1b                	ja     80104928 <syscall+0x38>
8010490d:	8b 14 85 40 76 10 80 	mov    -0x7fef89c0(,%eax,4),%edx
80104914:	85 d2                	test   %edx,%edx
80104916:	74 10                	je     80104928 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104918:	ff d2                	call   *%edx
8010491a:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
80104924:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("%d %s: unknown sys call %d\n",
80104928:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
8010492c:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010492f:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
80104933:	8b 43 10             	mov    0x10(%ebx),%eax
80104936:	c7 04 24 11 76 10 80 	movl   $0x80107611,(%esp)
8010493d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104941:	e8 0a bd ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
80104946:	8b 43 18             	mov    0x18(%ebx),%eax
80104949:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80104969:	e8 32 ed ff ff       	call   801036a0 <myproc>
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010496e:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
80104970:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80104974:	85 c9                	test   %ecx,%ecx
80104976:	74 18                	je     80104990 <fdalloc+0x30>
  for(fd = 0; fd < NOFILE; fd++){
80104978:	83 c2 01             	add    $0x1,%edx
8010497b:	83 fa 10             	cmp    $0x10,%edx
8010497e:	75 f0                	jne    80104970 <fdalloc+0x10>
      curproc->ofile[fd] = f;
      return fd;
    }
  }
...
8010498c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80104990:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
}
80104994:	83 c4 04             	add    $0x4,%esp
      return fd;
...
801049a6:	83 ec 3c             	sub    $0x3c,%esp
801049a9:	89 4d d0             	mov    %ecx,-0x30(%ebp)
801049ac:	8b 4d 08             	mov    0x8(%ebp),%ecx
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
801049af:	8d 5d da             	lea    -0x26(%ebp),%ebx
801049b2:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801049b6:	89 04 24             	mov    %eax,(%esp)
{
801049b9:	89 55 d4             	mov    %edx,-0x2c(%ebp)
801049bc:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
801049bf:	e8 5c d5 ff ff       	call   80101f20 <nameiparent>
801049c4:	85 c0                	test   %eax,%eax
801049c6:	89 c7                	mov    %eax,%edi
801049c8:	0f 84 da 00 00 00    	je     80104aa8 <create+0x108>
    return 0;
  ilock(dp);
801049ce:	89 04 24             	mov    %eax,(%esp)
801049d1:	e8 da cc ff ff       	call   801016b0 <ilock>
...
801049e5:	e8 d6 d1 ff ff       	call   80101bc0 <dirlookup>
801049ea:	85 c0                	test   %eax,%eax
801049ec:	89 c6                	mov    %eax,%esi
801049ee:	74 40                	je     80104a30 <create+0x90>
    iunlockput(dp);
801049f0:	89 3c 24             	mov    %edi,(%esp)
801049f3:	e8 18 cf ff ff       	call   80101910 <iunlockput>
    ilock(ip);
801049f8:	89 34 24             	mov    %esi,(%esp)
801049fb:	e8 b0 cc ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104a00:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104a05:	75 11                	jne    80104a18 <create+0x78>
80104a07:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104a0c:	89 f0                	mov    %esi,%eax
80104a0e:	75 08                	jne    80104a18 <create+0x78>
...
80104a10:	83 c4 3c             	add    $0x3c,%esp
80104a13:	5b                   	pop    %ebx
80104a14:	5e                   	pop    %esi
80104a15:	5f                   	pop    %edi
80104a16:	5d                   	pop    %ebp
...
80104a1b:	e8 f0 ce ff ff       	call   80101910 <iunlockput>
}
...
80104a38:	8b 07                	mov    (%edi),%eax
80104a3a:	89 04 24             	mov    %eax,(%esp)
80104a3d:	e8 de ca ff ff       	call   80101520 <ialloc>
80104a42:	85 c0                	test   %eax,%eax
80104a44:	89 c6                	mov    %eax,%esi
80104a46:	0f 84 bf 00 00 00    	je     80104b0b <create+0x16b>
  ilock(ip);
80104a4c:	89 04 24             	mov    %eax,(%esp)
80104a4f:	e8 5c cc ff ff       	call   801016b0 <ilock>
  ip->major = major;
80104a54:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80104a58:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
80104a5c:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80104a60:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80104a64:	b8 01 00 00 00       	mov    $0x1,%eax
80104a69:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
80104a6d:	89 34 24             	mov    %esi,(%esp)
80104a70:	e8 7b cb ff ff       	call   801015f0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104a75:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80104a7a:	74 34                	je     80104ab0 <create+0x110>
  if(dirlink(dp, name, ip->inum) < 0)
80104a7c:	8b 46 04             	mov    0x4(%esi),%eax
80104a7f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
...
80104aa5:	8d 76 00             	lea    0x0(%esi),%esi
    return 0;
80104aa8:	31 c0                	xor    %eax,%eax
80104aaa:	e9 61 ff ff ff       	jmp    80104a10 <create+0x70>
80104aaf:	90                   	nop
    dp->nlink++;  // for ".."
80104ab0:	66 83 47 56 01       	addw   $0x1,0x56(%edi)
    iupdate(dp);
80104ab5:	89 3c 24             	mov    %edi,(%esp)
80104ab8:	e8 33 cb ff ff       	call   801015f0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104abd:	8b 46 04             	mov    0x4(%esi),%eax
80104ac0:	c7 44 24 04 bc 76 10 	movl   $0x801076bc,0x4(%esp)
80104ac7:	80 
80104ac8:	89 34 24             	mov    %esi,(%esp)
80104acb:	89 44 24 08          	mov    %eax,0x8(%esp)
80104acf:	e8 4c d3 ff ff       	call   80101e20 <dirlink>
80104ad4:	85 c0                	test   %eax,%eax
80104ad6:	78 1b                	js     80104af3 <create+0x153>
80104ad8:	8b 47 04             	mov    0x4(%edi),%eax
80104adb:	c7 44 24 04 bb 76 10 	movl   $0x801076bb,0x4(%esp)
80104ae2:	80 
80104ae3:	89 34 24             	mov    %esi,(%esp)
80104ae6:	89 44 24 08          	mov    %eax,0x8(%esp)
80104aea:	e8 31 d3 ff ff       	call   80101e20 <dirlink>
80104aef:	85 c0                	test   %eax,%eax
80104af1:	79 89                	jns    80104a7c <create+0xdc>
      panic("create dots");
80104af3:	c7 04 24 af 76 10 80 	movl   $0x801076af,(%esp)
80104afa:	e8 61 b8 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
80104aff:	c7 04 24 be 76 10 80 	movl   $0x801076be,(%esp)
80104b06:	e8 55 b8 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104b0b:	c7 04 24 a0 76 10 80 	movl   $0x801076a0,(%esp)
80104b12:	e8 49 b8 ff ff       	call   80100360 <panic>
...
80104b27:	89 d3                	mov    %edx,%ebx
80104b29:	83 ec 20             	sub    $0x20,%esp
  if(argint(n, &fd) < 0)
80104b2c:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b2f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104b3a:	e8 e1 fc ff ff       	call   80104820 <argint>
80104b3f:	85 c0                	test   %eax,%eax
80104b41:	78 2d                	js     80104b70 <argfd.constprop.0+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104b43:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104b47:	77 27                	ja     80104b70 <argfd.constprop.0+0x50>
80104b49:	e8 52 eb ff ff       	call   801036a0 <myproc>
80104b4e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104b51:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104b55:	85 c0                	test   %eax,%eax
80104b57:	74 17                	je     80104b70 <argfd.constprop.0+0x50>
  if(pfd)
80104b59:	85 f6                	test   %esi,%esi
80104b5b:	74 02                	je     80104b5f <argfd.constprop.0+0x3f>
    *pfd = fd;
80104b5d:	89 16                	mov    %edx,(%esi)
  if(pf)
80104b5f:	85 db                	test   %ebx,%ebx
80104b61:	74 1d                	je     80104b80 <argfd.constprop.0+0x60>
    *pf = f;
80104b63:	89 03                	mov    %eax,(%ebx)
  return 0;
80104b65:	31 c0                	xor    %eax,%eax
}
80104b67:	83 c4 20             	add    $0x20,%esp
80104b6a:	5b                   	pop    %ebx
80104b6b:	5e                   	pop    %esi
80104b6c:	5d                   	pop    %ebp
80104b6d:	c3                   	ret    
80104b6e:	66 90                	xchg   %ax,%ax
80104b70:	83 c4 20             	add    $0x20,%esp
    return -1;
...
80104b82:	eb e3                	jmp    80104b67 <argfd.constprop.0+0x47>
...
80104b96:	83 ec 24             	sub    $0x24,%esp
  if(argfd(0, 0, &f) < 0)
80104b99:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104b9c:	e8 7f ff ff ff       	call   80104b20 <argfd.constprop.0>
80104ba1:	85 c0                	test   %eax,%eax
80104ba3:	78 23                	js     80104bc8 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104ba5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ba8:	e8 b3 fd ff ff       	call   80104960 <fdalloc>
80104bad:	85 c0                	test   %eax,%eax
80104baf:	89 c3                	mov    %eax,%ebx
80104bb1:	78 15                	js     80104bc8 <sys_dup+0x38>
  filedup(f);
80104bb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bb6:	89 04 24             	mov    %eax,(%esp)
80104bb9:	e8 22 c2 ff ff       	call   80100de0 <filedup>
  return fd;
80104bbe:	89 d8                	mov    %ebx,%eax
}
80104bc0:	83 c4 24             	add    $0x24,%esp
80104bc3:	5b                   	pop    %ebx
80104bc4:	5d                   	pop    %ebp
80104bc5:	c3                   	ret    
...
80104bcd:	eb f1                	jmp    80104bc0 <sys_dup+0x30>
80104bcf:	90                   	nop
...
80104bdb:	e8 40 ff ff ff       	call   80104b20 <argfd.constprop.0>
...
80104bf2:	e8 29 fc ff ff       	call   80104820 <argint>
...
80104c4b:	e8 d0 fe ff ff       	call   80104b20 <argfd.constprop.0>
...
80104c62:	e8 b9 fb ff ff       	call   80104820 <argint>
...
80104cbc:	e8 5f fe ff ff       	call   80104b20 <argfd.constprop.0>
80104cc1:	85 c0                	test   %eax,%eax
80104cc3:	78 23                	js     80104ce8 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104cc5:	e8 d6 e9 ff ff       	call   801036a0 <myproc>
80104cca:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104ccd:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104cd4:	00 
  fileclose(f);
...
80104cfb:	e8 20 fe ff ff       	call   80104b20 <argfd.constprop.0>
...
80104d57:	e8 54 fb ff ff       	call   801048b0 <argstr>
...
80104d72:	e8 39 fb ff ff       	call   801048b0 <argstr>
...
80104d8a:	e8 71 d1 ff ff       	call   80101f00 <namei>
...
80104db7:	e8 34 c8 ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
...
80104dce:	e8 4d d1 ff ff       	call   80101f20 <nameiparent>
...
80104e2b:	e8 80 c8 ff ff       	call   801016b0 <ilock>
  ip->nlink--;
...
80104e77:	e8 34 fa ff ff       	call   801048b0 <argstr>
80104e7c:	85 c0                	test   %eax,%eax
80104e7e:	0f 88 76 01 00 00    	js     80104ffa <sys_unlink+0x19a>
  begin_op();
80104e84:	e8 87 dc ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104e96:	e8 85 d0 ff ff       	call   80101f20 <nameiparent>
...
80104eac:	e8 ff c7 ff ff       	call   801016b0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104eb1:	c7 44 24 04 bc 76 10 	movl   $0x801076bc,0x4(%esp)
80104eb8:	80 
80104eb9:	89 1c 24             	mov    %ebx,(%esp)
80104ebc:	e8 cf cc ff ff       	call   80101b90 <namecmp>
80104ec1:	85 c0                	test   %eax,%eax
80104ec3:	0f 84 21 01 00 00    	je     80104fea <sys_unlink+0x18a>
80104ec9:	c7 44 24 04 bb 76 10 	movl   $0x801076bb,0x4(%esp)
80104ed0:	80 
80104ed1:	89 1c 24             	mov    %ebx,(%esp)
80104ed4:	e8 b7 cc ff ff       	call   80101b90 <namecmp>
...
80104eef:	e8 cc cc ff ff       	call   80101bc0 <dirlookup>
...
80104f01:	e8 aa c7 ff ff       	call   801016b0 <ilock>
  if(ip->nlink < 1)
...
80104f2e:	e8 fd f5 ff ff       	call   80104530 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104f4c:	e8 0f cb ff ff       	call   80101a60 <writei>
...
80104fd1:	e8 8a c9 ff ff       	call   80101960 <readi>
...
80104fe5:	e8 26 c9 ff ff       	call   80101910 <iunlockput>
  iunlockput(dp);
80104fea:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104fed:	89 04 24             	mov    %eax,(%esp)
80104ff0:	e8 1b c9 ff ff       	call   80101910 <iunlockput>
  end_op();
80104ff5:	e8 86 db ff ff       	call   80102b80 <end_op>
}
...
80105013:	e8 d8 c5 ff ff       	call   801015f0 <iupdate>
80105018:	e9 48 ff ff ff       	jmp    80104f65 <sys_unlink+0x105>
      panic("isdirempty: readi");
8010501d:	c7 04 24 e0 76 10 80 	movl   $0x801076e0,(%esp)
80105024:	e8 37 b3 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80105029:	c7 04 24 f2 76 10 80 	movl   $0x801076f2,(%esp)
80105030:	e8 2b b3 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80105035:	c7 04 24 ce 76 10 80 	movl   $0x801076ce,(%esp)
...
80105067:	e8 44 f8 ff ff       	call   801048b0 <argstr>
8010506c:	85 c0                	test   %eax,%eax
8010506e:	0f 88 d1 00 00 00    	js     80105145 <sys_open+0xf5>
80105074:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105077:	89 44 24 04          	mov    %eax,0x4(%esp)
8010507b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105082:	e8 99 f7 ff ff       	call   80104820 <argint>
80105087:	85 c0                	test   %eax,%eax
80105089:	0f 88 b6 00 00 00    	js     80105145 <sys_open+0xf5>
    return -1;
...
8010508f:	e8 7c da ff ff       	call   80102b10 <begin_op>
  ...
  if(omode & O_CREATE){
80105094:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105098:	0f 85 82 00 00 00    	jne    80105120 <sys_open+0xd0>
    if(ip == 0){
      end_op();
      return -1;
    }
    ...
    if((ip = namei(path)) == 0){
8010509e:	8b 45 e0             	mov    -0x20(%ebp),%eax
801050a1:	89 04 24             	mov    %eax,(%esp)
801050a4:	e8 57 ce ff ff       	call   80101f00 <namei>
801050a9:	85 c0                	test   %eax,%eax
801050ab:	89 c6                	mov    %eax,%esi
801050ad:	0f 84 8d 00 00 00    	je     80105140 <sys_open+0xf0>
      end_op();
      return -1;
    }
    ilock(ip);
801050b3:	89 04 24             	mov    %eax,(%esp)
801050b6:	e8 f5 c5 ff ff       	call   801016b0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801050bb:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
801050c0:	0f 84 92 00 00 00    	je     80105158 <sys_open+0x108>
      end_op();
      return -1;
    }
  }
...
801050cf:	0f 84 93 00 00 00    	je     80105168 <sys_open+0x118>
801050d5:	e8 86 f8 ff ff       	call   80104960 <fdalloc>
801050da:	85 c0                	test   %eax,%eax
801050dc:	89 c7                	mov    %eax,%edi
801050de:	0f 88 94 00 00 00    	js     80105178 <sys_open+0x128>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
801050e4:	89 34 24             	mov    %esi,(%esp)
801050e7:	e8 a4 c6 ff ff       	call   80101790 <iunlock>
  end_op();
801050ec:	e8 8f da ff ff       	call   80102b80 <end_op>

  f->type = FD_INODE;
801050f1:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
801050f7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  f->ip = ip;
801050fa:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
801050fd:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80105104:	89 c2                	mov    %eax,%edx
80105106:	83 e2 01             	and    $0x1,%edx
80105109:	83 f2 01             	xor    $0x1,%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010510c:	a8 03                	test   $0x3,%al
  f->readable = !(omode & O_WRONLY);
8010510e:	88 53 08             	mov    %dl,0x8(%ebx)
  return fd;
80105111:	89 f8                	mov    %edi,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105113:	0f 95 43 09          	setne  0x9(%ebx)
}
80105117:	83 c4 2c             	add    $0x2c,%esp
8010511a:	5b                   	pop    %ebx
8010511b:	5e                   	pop    %esi
8010511c:	5f                   	pop    %edi
8010511d:	5d                   	pop    %ebp
...
80105120:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105123:	31 c9                	xor    %ecx,%ecx
80105125:	ba 02 00 00 00       	mov    $0x2,%edx
8010512a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105131:	e8 6a f8 ff ff       	call   801049a0 <create>
    if(ip == 0){
80105136:	85 c0                	test   %eax,%eax
    ip = create(path, T_FILE, 0, 0);
80105138:	89 c6                	mov    %eax,%esi
    if(ip == 0){
8010513a:	75 8a                	jne    801050c6 <sys_open+0x76>
8010513c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
80105140:	e8 3b da ff ff       	call   80102b80 <end_op>
}
80105145:	83 c4 2c             	add    $0x2c,%esp
    return -1;
...
80105193:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105196:	e8 75 d9 ff ff       	call   80102b10 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
8010519b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010519e:	89 44 24 04          	mov    %eax,0x4(%esp)
801051a2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801051a9:	e8 02 f7 ff ff       	call   801048b0 <argstr>
801051ae:	85 c0                	test   %eax,%eax
801051b0:	78 2e                	js     801051e0 <sys_mkdir+0x50>
801051b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051b5:	31 c9                	xor    %ecx,%ecx
801051b7:	ba 01 00 00 00       	mov    $0x1,%edx
801051bc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801051c3:	e8 d8 f7 ff ff       	call   801049a0 <create>
801051c8:	85 c0                	test   %eax,%eax
801051ca:	74 14                	je     801051e0 <sys_mkdir+0x50>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80105209:	e8 a2 f6 ff ff       	call   801048b0 <argstr>
8010520e:	85 c0                	test   %eax,%eax
80105210:	78 5e                	js     80105270 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
80105212:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105215:	89 44 24 04          	mov    %eax,0x4(%esp)
80105219:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105220:	e8 fb f5 ff ff       	call   80104820 <argint>
  if((argstr(0, &path)) < 0 ||
80105225:	85 c0                	test   %eax,%eax
80105227:	78 47                	js     80105270 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
80105229:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010522c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105230:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105237:	e8 e4 f5 ff ff       	call   80104820 <argint>
     argint(1, &major) < 0 ||
8010523c:	85 c0                	test   %eax,%eax
8010523e:	78 30                	js     80105270 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
80105240:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
     argint(2, &minor) < 0 ||
80105244:	ba 03 00 00 00       	mov    $0x3,%edx
     (ip = create(path, T_DEV, major, minor)) == 0){
80105249:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
8010524d:	89 04 24             	mov    %eax,(%esp)
     argint(2, &minor) < 0 ||
80105250:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105253:	e8 48 f7 ff ff       	call   801049a0 <create>
80105258:	85 c0                	test   %eax,%eax
8010525a:	74 14                	je     80105270 <sys_mknod+0x80>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80105285:	83 ec 20             	sub    $0x20,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80105288:	e8 13 e4 ff ff       	call   801036a0 <myproc>
8010528d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010528f:	e8 7c d8 ff ff       	call   80102b10 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105294:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105297:	89 44 24 04          	mov    %eax,0x4(%esp)
8010529b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801052a2:	e8 09 f6 ff ff       	call   801048b0 <argstr>
801052a7:	85 c0                	test   %eax,%eax
801052a9:	78 4a                	js     801052f5 <sys_chdir+0x75>
801052ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052ae:	89 04 24             	mov    %eax,(%esp)
801052b1:	e8 4a cc ff ff       	call   80101f00 <namei>
801052b6:	85 c0                	test   %eax,%eax
801052b8:	89 c3                	mov    %eax,%ebx
801052ba:	74 39                	je     801052f5 <sys_chdir+0x75>
    end_op();
    return -1;
  }
  ilock(ip);
801052bc:	89 04 24             	mov    %eax,(%esp)
801052bf:	e8 ec c3 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
801052c4:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
    iunlockput(ip);
801052c9:	89 1c 24             	mov    %ebx,(%esp)
  if(ip->type != T_DIR){
801052cc:	75 22                	jne    801052f0 <sys_chdir+0x70>
    end_op();
    return -1;
  }
  iunlock(ip);
801052ce:	e8 bd c4 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
801052d3:	8b 46 68             	mov    0x68(%esi),%eax
801052d6:	89 04 24             	mov    %eax,(%esp)
801052d9:	e8 f2 c4 ff ff       	call   801017d0 <iput>
  end_op();
801052de:	e8 9d d8 ff ff       	call   80102b80 <end_op>
  curproc->cwd = ip;
  return 0;
801052e3:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
801052e5:	89 5e 68             	mov    %ebx,0x68(%esi)
}
801052e8:	83 c4 20             	add    $0x20,%esp
801052eb:	5b                   	pop    %ebx
801052ec:	5e                   	pop    %esi
801052ed:	5d                   	pop    %ebp
801052ee:	c3                   	ret    
801052ef:	90                   	nop
    iunlockput(ip);
801052f0:	e8 1b c6 ff ff       	call   80101910 <iunlockput>
    end_op();
801052f5:	e8 86 d8 ff ff       	call   80102b80 <end_op>
}
801052fa:	83 c4 20             	add    $0x20,%esp
    return -1;
...
80105316:	81 ec ac 00 00 00    	sub    $0xac,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
8010531c:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
80105322:	89 44 24 04          	mov    %eax,0x4(%esp)
80105326:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010532d:	e8 7e f5 ff ff       	call   801048b0 <argstr>
80105332:	85 c0                	test   %eax,%eax
80105334:	0f 88 84 00 00 00    	js     801053be <sys_exec+0xae>
8010533a:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105340:	89 44 24 04          	mov    %eax,0x4(%esp)
80105344:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010534b:	e8 d0 f4 ff ff       	call   80104820 <argint>
80105350:	85 c0                	test   %eax,%eax
80105352:	78 6a                	js     801053be <sys_exec+0xae>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105354:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
8010535a:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
8010535c:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80105363:	00 
80105364:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
8010536a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105371:	00 
80105372:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105378:	89 04 24             	mov    %eax,(%esp)
8010537b:	e8 b0 f1 ff ff       	call   80104530 <memset>
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105380:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105386:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010538a:	8d 04 98             	lea    (%eax,%ebx,4),%eax
8010538d:	89 04 24             	mov    %eax,(%esp)
80105390:	e8 eb f3 ff ff       	call   80104780 <fetchint>
80105395:	85 c0                	test   %eax,%eax
80105397:	78 25                	js     801053be <sys_exec+0xae>
      return -1;
    if(uarg == 0){
80105399:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010539f:	85 c0                	test   %eax,%eax
801053a1:	74 2d                	je     801053d0 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
801053a3:	89 74 24 04          	mov    %esi,0x4(%esp)
801053a7:	89 04 24             	mov    %eax,(%esp)
801053aa:	e8 11 f4 ff ff       	call   801047c0 <fetchstr>
801053af:	85 c0                	test   %eax,%eax
801053b1:	78 0b                	js     801053be <sys_exec+0xae>
  for(i=0;; i++){
801053b3:	83 c3 01             	add    $0x1,%ebx
801053b6:	83 c6 04             	add    $0x4,%esi
    if(i >= NELEM(argv))
801053b9:	83 fb 20             	cmp    $0x20,%ebx
801053bc:	75 c2                	jne    80105380 <sys_exec+0x70>
      return -1;
  }
  return exec(path, argv);
}
801053be:	81 c4 ac 00 00 00    	add    $0xac,%esp
    return -1;
...
801053da:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
      argv[i] = 0;
801053e0:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
801053e7:	00 00 00 00 
  return exec(path, argv);
801053eb:	89 04 24             	mov    %eax,(%esp)
801053ee:	e8 ad b5 ff ff       	call   801009a0 <exec>
}
801053f3:	81 c4 ac 00 00 00    	add    $0xac,%esp
801053f9:	5b                   	pop    %ebx
801053fa:	5e                   	pop    %esi
801053fb:	5f                   	pop    %edi
801053fc:	5d                   	pop    %ebp
...
80105407:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010540a:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105411:	00 
80105412:	89 44 24 04          	mov    %eax,0x4(%esp)
80105416:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010541d:	e8 2e f4 ff ff       	call   80104850 <argptr>
80105422:	85 c0                	test   %eax,%eax
80105424:	78 6d                	js     80105493 <sys_pipe+0x93>
    return -1;
...
80105433:	e8 38 dd ff ff       	call   80103170 <pipealloc>
80105438:	85 c0                	test   %eax,%eax
8010543a:	78 57                	js     80105493 <sys_pipe+0x93>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010543c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010543f:	e8 1c f5 ff ff       	call   80104960 <fdalloc>
80105444:	85 c0                	test   %eax,%eax
80105446:	89 c3                	mov    %eax,%ebx
80105448:	78 33                	js     8010547d <sys_pipe+0x7d>
8010544a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010544d:	e8 0e f5 ff ff       	call   80104960 <fdalloc>
80105452:	85 c0                	test   %eax,%eax
80105454:	78 1a                	js     80105470 <sys_pipe+0x70>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
80105456:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105459:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
8010545b:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010545e:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
}
...
80105469:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105470:	e8 2b e2 ff ff       	call   801036a0 <myproc>
80105475:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
8010547c:	00 
    fileclose(rf);
8010547d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105480:	89 04 24             	mov    %eax,(%esp)
80105483:	e8 a8 b9 ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
80105488:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010548b:	89 04 24             	mov    %eax,(%esp)
8010548e:	e8 9d b9 ff ff       	call   80100e30 <fileclose>
}
80105493:	83 c4 24             	add    $0x24,%esp
    return -1;
...
801054a3:	5d                   	pop    %ebp
  return fork();
801054a4:	e9 a7 e3 ff ff       	jmp    80103850 <fork>
...
801054b3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054b6:	e8 e5 e5 ff ff       	call   80103aa0 <exit>
...
801054d4:	e8 47 f3 ff ff       	call   80104820 <argint>
801054d9:	85 c0                	test   %eax,%eax
801054db:	78 13                	js     801054f0 <sys_exitS+0x30>
     return -1;
  	
  exitS(pid);
801054dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054e0:	89 04 24             	mov    %eax,(%esp)
801054e3:	e8 d8 e6 ff ff       	call   80103bc0 <exitS>
...
8010551c:	e8 2f f3 ff ff       	call   80104850 <argptr>
...
8010552b:	e8 a0 e8 ff ff       	call   80103dd0 <wait>
}
80105530:	c9                   	leave  
80105531:	c3                   	ret    
...
80105599:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010559c:	89 04 24             	mov    %eax,(%esp)
8010559f:	e8 1c e9 ff ff       	call   80103ec0 <waitpid>
}
801055a4:	c9                   	leave  
801055a5:	c3                   	ret    
...
801055c4:	e8 57 f2 ff ff       	call   80104820 <argint>
801055c9:	85 c0                	test   %eax,%eax
801055cb:	78 13                	js     801055e0 <sys_kill+0x30>
    return -1;
  return kill(pid);
801055cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055d0:	89 04 24             	mov    %eax,(%esp)
801055d3:	e8 a8 ea ff ff       	call   80104080 <kill>
}
801055d8:	c9                   	leave  
801055d9:	c3                   	ret    
...
801055f3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801055f6:	e8 a5 e0 ff ff       	call   801036a0 <myproc>
...
80105615:	e8 06 f2 ff ff       	call   80104820 <argint>
8010561a:	85 c0                	test   %eax,%eax
8010561c:	78 22                	js     80105640 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010561e:	e8 7d e0 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
80105623:	8b 55 f4             	mov    -0xc(%ebp),%edx
  addr = myproc()->sz;
80105626:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105628:	89 14 24             	mov    %edx,(%esp)
8010562b:	e8 b0 e1 ff ff       	call   801037e0 <growproc>
80105630:	85 c0                	test   %eax,%eax
80105632:	78 0c                	js     80105640 <sys_sbrk+0x40>
    return -1;
  return addr;
80105634:	89 d8                	mov    %ebx,%eax
}
80105636:	83 c4 24             	add    $0x24,%esp
80105639:	5b                   	pop    %ebx
8010563a:	5d                   	pop    %ebp
8010563b:	c3                   	ret    
...
80105645:	eb ef                	jmp    80105636 <sys_sbrk+0x36>
...
80105665:	e8 b6 f1 ff ff       	call   80104820 <argint>
8010566a:	85 c0                	test   %eax,%eax
8010566c:	78 7e                	js     801056ec <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010566e:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105675:	e8 f6 ed ff ff       	call   80104470 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010567a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010567d:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
80105690:	c7 44 24 04 60 4d 11 	movl   $0x80114d60,0x4(%esp)
80105697:	80 
80105698:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
8010569f:	e8 7c e6 ff ff       	call   80103d20 <sleep>
  while(ticks - ticks0 < n){
801056a4:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
801056ba:	74 d4                	je     80105690 <sys_sleep+0x40>
      release(&tickslock);
801056bc:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801056c3:	e8 18 ee ff ff       	call   801044e0 <release>
      return -1;
...
801056cd:	83 c4 24             	add    $0x24,%esp
801056d0:	5b                   	pop    %ebx
801056d1:	5d                   	pop    %ebp
801056d2:	c3                   	ret    
801056d3:	90                   	nop
801056d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801056d8:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801056df:	e8 fc ed ff ff       	call   801044e0 <release>
}
...
801056f1:	eb da                	jmp    801056cd <sys_sleep+0x7d>
...
80105704:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105707:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010570e:	e8 5d ed ff ff       	call   80104470 <acquire>
  xticks = ticks;
80105713:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
80105719:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105720:	e8 bb ed ff ff       	call   801044e0 <release>
  return xticks;
}
...
8010573c:	54                   	push   %esp
8010573d:	e8 de 00 00 00       	call   80105820 <trap>
80105742:	83 c4 04             	add    $0x4,%esp

80105745 <trapret>:
80105745:	61                   	popa   
80105746:	0f a9                	pop    %gs
80105748:	0f a1                	pop    %fs
8010574a:	07                   	pop    %es
8010574b:	1f                   	pop    %ds
8010574c:	83 c4 08             	add    $0x8,%esp
8010574f:	cf                   	iret   
...
80105758:	8b 14 85 08 a0 10 80 	mov    -0x7fef5ff8(,%eax,4),%edx
8010575f:	b9 08 00 00 00       	mov    $0x8,%ecx
80105764:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
8010576b:	80 
8010576c:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
80105773:	00 
80105774:	c6 04 c5 a5 4d 11 80 	movb   $0x8e,-0x7feeb25b(,%eax,8)
8010577b:	8e 
8010577c:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
80105783:	80 
80105784:	c1 ea 10             	shr    $0x10,%edx
80105787:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
8010578e:	80 
  for(i = 0; i < 256; i++)
...
801057a1:	83 ec 18             	sub    $0x18,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801057a4:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
801057a9:	c7 44 24 04 01 77 10 	movl   $0x80107701,0x4(%esp)
801057b0:	80 
801057b1:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801057b8:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
801057bf:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
801057c5:	c1 e8 10             	shr    $0x10,%eax
801057c8:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
801057cf:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
801057d6:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
801057dc:	e8 1f eb ff ff       	call   80104300 <initlock>
}
801057e1:	c9                   	leave  
801057e2:	c3                   	ret    
...
801057fb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801057ff:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
8010583e:	77 08                	ja     80105848 <trap+0x28>
80105840:	ff 24 85 a8 77 10 80 	jmp    *-0x7fef8858(,%eax,4)
80105847:	90                   	nop
    lapiceoi();
    break;
...
80105848:	e8 53 de ff ff       	call   801036a0 <myproc>
8010584d:	85 c0                	test   %eax,%eax
8010584f:	90                   	nop
80105850:	0f 84 fa 01 00 00    	je     80105a50 <trap+0x230>
80105856:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010585a:	0f 84 f0 01 00 00    	je     80105a50 <trap+0x230>
...
80105863:	8b 53 38             	mov    0x38(%ebx),%edx
80105866:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105869:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010586c:	e8 0f de ff ff       	call   80103680 <cpuid>
80105871:	8b 73 30             	mov    0x30(%ebx),%esi
80105874:	89 c7                	mov    %eax,%edi
80105876:	8b 43 34             	mov    0x34(%ebx),%eax
80105879:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010587c:	e8 1f de ff ff       	call   801036a0 <myproc>
80105881:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105884:	e8 17 de ff ff       	call   801036a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105889:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010588c:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105890:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105893:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105896:	89 7c 24 14          	mov    %edi,0x14(%esp)
8010589a:	89 54 24 18          	mov    %edx,0x18(%esp)
8010589e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
801058a1:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801058a4:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801058a8:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801058ac:	89 54 24 10          	mov    %edx,0x10(%esp)
801058b0:	8b 40 10             	mov    0x10(%eax),%eax
801058b3:	c7 04 24 64 77 10 80 	movl   $0x80107764,(%esp)
801058ba:	89 44 24 04          	mov    %eax,0x4(%esp)
801058be:	e8 8d ad ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801058c3:	e8 d8 dd ff ff       	call   801036a0 <myproc>
801058c8:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801058cf:	90                   	nop
  }
...
801058d0:	e8 cb dd ff ff       	call   801036a0 <myproc>
801058d5:	85 c0                	test   %eax,%eax
801058d7:	74 0c                	je     801058e5 <trap+0xc5>
801058d9:	e8 c2 dd ff ff       	call   801036a0 <myproc>
801058de:	8b 50 24             	mov    0x24(%eax),%edx
801058e1:	85 d2                	test   %edx,%edx
801058e3:	75 4b                	jne    80105930 <trap+0x110>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801058e5:	e8 b6 dd ff ff       	call   801036a0 <myproc>
801058ea:	85 c0                	test   %eax,%eax
801058ec:	74 0d                	je     801058fb <trap+0xdb>
801058ee:	66 90                	xchg   %ax,%ax
801058f0:	e8 ab dd ff ff       	call   801036a0 <myproc>
801058f5:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801058f9:	74 4d                	je     80105948 <trap+0x128>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058fb:	e8 a0 dd ff ff       	call   801036a0 <myproc>
80105900:	85 c0                	test   %eax,%eax
80105902:	74 1d                	je     80105921 <trap+0x101>
80105904:	e8 97 dd ff ff       	call   801036a0 <myproc>
80105909:	8b 40 24             	mov    0x24(%eax),%eax
8010590c:	85 c0                	test   %eax,%eax
8010590e:	74 11                	je     80105921 <trap+0x101>
80105910:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105914:	83 e0 03             	and    $0x3,%eax
80105917:	66 83 f8 03          	cmp    $0x3,%ax
8010591b:	0f 84 e8 00 00 00    	je     80105a09 <trap+0x1e9>
    exit();
}
80105921:	83 c4 3c             	add    $0x3c,%esp
80105924:	5b                   	pop    %ebx
80105925:	5e                   	pop    %esi
80105926:	5f                   	pop    %edi
80105927:	5d                   	pop    %ebp
...
80105929:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105930:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105934:	83 e0 03             	and    $0x3,%eax
80105937:	66 83 f8 03          	cmp    $0x3,%ax
8010593b:	75 a8                	jne    801058e5 <trap+0xc5>
    exit();
8010593d:	e8 5e e1 ff ff       	call   80103aa0 <exit>
80105942:	eb a1                	jmp    801058e5 <trap+0xc5>
...
80105950:	75 a9                	jne    801058fb <trap+0xdb>
    yield();
80105952:	e8 89 e3 ff ff       	call   80103ce0 <yield>
80105957:	eb a2                	jmp    801058fb <trap+0xdb>
80105959:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105960:	e8 1b dd ff ff       	call   80103680 <cpuid>
80105965:	85 c0                	test   %eax,%eax
80105967:	0f 84 b3 00 00 00    	je     80105a20 <trap+0x200>
8010596d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105970:	e8 0b ce ff ff       	call   80102780 <lapiceoi>
    break;
80105975:	e9 56 ff ff ff       	jmp    801058d0 <trap+0xb0>
...
80105985:	e8 f6 cd ff ff       	call   80102780 <lapiceoi>
    break;
8010598a:	e9 41 ff ff ff       	jmp    801058d0 <trap+0xb0>
8010598f:	90                   	nop
    uartintr();
80105990:	e8 1b 02 00 00       	call   80105bb0 <uartintr>
    lapiceoi();
80105995:	e8 e6 cd ff ff       	call   80102780 <lapiceoi>
    break;
8010599a:	e9 31 ff ff ff       	jmp    801058d0 <trap+0xb0>
8010599f:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801059a0:	8b 7b 38             	mov    0x38(%ebx),%edi
801059a3:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
801059a7:	e8 d4 dc ff ff       	call   80103680 <cpuid>
801059ac:	c7 04 24 0c 77 10 80 	movl   $0x8010770c,(%esp)
801059b3:	89 7c 24 0c          	mov    %edi,0xc(%esp)
801059b7:	89 74 24 08          	mov    %esi,0x8(%esp)
801059bb:	89 44 24 04          	mov    %eax,0x4(%esp)
801059bf:	e8 8c ac ff ff       	call   80100650 <cprintf>
    lapiceoi();
801059c4:	e8 b7 cd ff ff       	call   80102780 <lapiceoi>
    break;
801059c9:	e9 02 ff ff ff       	jmp    801058d0 <trap+0xb0>
801059ce:	66 90                	xchg   %ax,%ax
    ideintr();
801059d0:	e8 ab c6 ff ff       	call   80102080 <ideintr>
801059d5:	eb 96                	jmp    8010596d <trap+0x14d>
801059d7:	90                   	nop
801059d8:	90                   	nop
801059d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
801059e0:	e8 bb dc ff ff       	call   801036a0 <myproc>
801059e5:	8b 70 24             	mov    0x24(%eax),%esi
801059e8:	85 f6                	test   %esi,%esi
801059ea:	75 2c                	jne    80105a18 <trap+0x1f8>
    myproc()->tf = tf;
801059ec:	e8 af dc ff ff       	call   801036a0 <myproc>
801059f1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801059f4:	e8 f7 ee ff ff       	call   801048f0 <syscall>
    if(myproc()->killed)
801059f9:	e8 a2 dc ff ff       	call   801036a0 <myproc>
801059fe:	8b 48 24             	mov    0x24(%eax),%ecx
80105a01:	85 c9                	test   %ecx,%ecx
80105a03:	0f 84 18 ff ff ff    	je     80105921 <trap+0x101>
}
80105a09:	83 c4 3c             	add    $0x3c,%esp
80105a0c:	5b                   	pop    %ebx
80105a0d:	5e                   	pop    %esi
80105a0e:	5f                   	pop    %edi
80105a0f:	5d                   	pop    %ebp
      exit();
80105a10:	e9 8b e0 ff ff       	jmp    80103aa0 <exit>
80105a15:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105a18:	e8 83 e0 ff ff       	call   80103aa0 <exit>
80105a1d:	eb cd                	jmp    801059ec <trap+0x1cc>
80105a1f:	90                   	nop
      acquire(&tickslock);
80105a20:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105a27:	e8 44 ea ff ff       	call   80104470 <acquire>
      wakeup(&ticks);
80105a2c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105a33:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105a3a:	e8 e1 e5 ff ff       	call   80104020 <wakeup>
      release(&tickslock);
80105a3f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105a46:	e8 95 ea ff ff       	call   801044e0 <release>
80105a4b:	e9 1d ff ff ff       	jmp    8010596d <trap+0x14d>
80105a50:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105a53:	8b 73 38             	mov    0x38(%ebx),%esi
80105a56:	e8 25 dc ff ff       	call   80103680 <cpuid>
80105a5b:	89 7c 24 10          	mov    %edi,0x10(%esp)
80105a5f:	89 74 24 0c          	mov    %esi,0xc(%esp)
80105a63:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a67:	8b 43 30             	mov    0x30(%ebx),%eax
80105a6a:	c7 04 24 30 77 10 80 	movl   $0x80107730,(%esp)
80105a71:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a75:	e8 d6 ab ff ff       	call   80100650 <cprintf>
      panic("trap");
80105a7a:	c7 04 24 06 77 10 80 	movl   $0x80107706,(%esp)
80105a81:	e8 da a8 ff ff       	call   80100360 <panic>
...
80105ae7:	e8 b4 cc ff ff       	call   801027a0 <microdelay>
...
80105b5e:	74 42                	je     80105ba2 <uartinit+0x92>
  uart = 1;
80105b60:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105b67:	00 00 00 
...
80105b77:	00 
  for(p="xv6...\n"; *p; p++)
80105b78:	bb 28 78 10 80       	mov    $0x80107828,%ebx
  ioapicenable(IRQ_COM1, 0);
80105b7d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105b84:	e8 27 c7 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105b93:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105b96:	e8 25 ff ff ff       	call   80105ac0 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105b9b:	0f be 03             	movsbl (%ebx),%eax
80105b9e:	84 c0                	test   %al,%al
80105ba0:	75 ee                	jne    80105b90 <uartinit+0x80>
}
...
80105bb6:	c7 04 24 90 5a 10 80 	movl   $0x80105a90,(%esp)
...
80105bc6:	6a 00                	push   $0x0
  jmp alltraps
80105bc8:	e9 60 fb ff ff       	jmp    8010572d <alltraps>
...
80105bcf:	6a 01                	push   $0x1
  jmp alltraps
80105bd1:	e9 57 fb ff ff       	jmp    8010572d <alltraps>
...
80105bd8:	6a 02                	push   $0x2
  jmp alltraps
80105bda:	e9 4e fb ff ff       	jmp    8010572d <alltraps>
...
80105be1:	6a 03                	push   $0x3
  jmp alltraps
80105be3:	e9 45 fb ff ff       	jmp    8010572d <alltraps>
...
80105bea:	6a 04                	push   $0x4
  jmp alltraps
80105bec:	e9 3c fb ff ff       	jmp    8010572d <alltraps>
...
80105bf3:	6a 05                	push   $0x5
  jmp alltraps
80105bf5:	e9 33 fb ff ff       	jmp    8010572d <alltraps>
...
80105bfc:	6a 06                	push   $0x6
  jmp alltraps
80105bfe:	e9 2a fb ff ff       	jmp    8010572d <alltraps>
...
80105c05:	6a 07                	push   $0x7
  jmp alltraps
80105c07:	e9 21 fb ff ff       	jmp    8010572d <alltraps>
...
80105c0c:	6a 08                	push   $0x8
  jmp alltraps
80105c0e:	e9 1a fb ff ff       	jmp    8010572d <alltraps>
...
80105c15:	6a 09                	push   $0x9
  jmp alltraps
80105c17:	e9 11 fb ff ff       	jmp    8010572d <alltraps>
...
80105c23:	6a 0b                	push   $0xb
  jmp alltraps
80105c25:	e9 03 fb ff ff       	jmp    8010572d <alltraps>
...
80105c2a:	6a 0c                	push   $0xc
  jmp alltraps
80105c2c:	e9 fc fa ff ff       	jmp    8010572d <alltraps>
...
80105c31:	6a 0d                	push   $0xd
  jmp alltraps
80105c33:	e9 f5 fa ff ff       	jmp    8010572d <alltraps>
...
80105c38:	6a 0e                	push   $0xe
  jmp alltraps
80105c3a:	e9 ee fa ff ff       	jmp    8010572d <alltraps>
...
80105c41:	6a 0f                	push   $0xf
  jmp alltraps
80105c43:	e9 e5 fa ff ff       	jmp    8010572d <alltraps>
...
80105c5a:	6a 12                	push   $0x12
  jmp alltraps
80105c5c:	e9 cc fa ff ff       	jmp    8010572d <alltraps>
...
80105c63:	6a 13                	push   $0x13
  jmp alltraps
80105c65:	e9 c3 fa ff ff       	jmp    8010572d <alltraps>
...
80105c6c:	6a 14                	push   $0x14
  jmp alltraps
80105c6e:	e9 ba fa ff ff       	jmp    8010572d <alltraps>
...
80105c75:	6a 15                	push   $0x15
  jmp alltraps
80105c77:	e9 b1 fa ff ff       	jmp    8010572d <alltraps>
...
80105c7e:	6a 16                	push   $0x16
  jmp alltraps
80105c80:	e9 a8 fa ff ff       	jmp    8010572d <alltraps>
...
80105c87:	6a 17                	push   $0x17
  jmp alltraps
80105c89:	e9 9f fa ff ff       	jmp    8010572d <alltraps>
...
80105c90:	6a 18                	push   $0x18
  jmp alltraps
80105c92:	e9 96 fa ff ff       	jmp    8010572d <alltraps>
...
80105c99:	6a 19                	push   $0x19
  jmp alltraps
80105c9b:	e9 8d fa ff ff       	jmp    8010572d <alltraps>
...
80105ca2:	6a 1a                	push   $0x1a
  jmp alltraps
80105ca4:	e9 84 fa ff ff       	jmp    8010572d <alltraps>
...
80105cab:	6a 1b                	push   $0x1b
  jmp alltraps
80105cad:	e9 7b fa ff ff       	jmp    8010572d <alltraps>
...
80105cb4:	6a 1c                	push   $0x1c
  jmp alltraps
80105cb6:	e9 72 fa ff ff       	jmp    8010572d <alltraps>
...
80105cbd:	6a 1d                	push   $0x1d
  jmp alltraps
80105cbf:	e9 69 fa ff ff       	jmp    8010572d <alltraps>
...
80105cc6:	6a 1e                	push   $0x1e
  jmp alltraps
80105cc8:	e9 60 fa ff ff       	jmp    8010572d <alltraps>
...
80105ccf:	6a 1f                	push   $0x1f
  jmp alltraps
80105cd1:	e9 57 fa ff ff       	jmp    8010572d <alltraps>
...
80105cd8:	6a 20                	push   $0x20
  jmp alltraps
80105cda:	e9 4e fa ff ff       	jmp    8010572d <alltraps>
...
80105ce1:	6a 21                	push   $0x21
  jmp alltraps
80105ce3:	e9 45 fa ff ff       	jmp    8010572d <alltraps>
...
80105cea:	6a 22                	push   $0x22
  jmp alltraps
80105cec:	e9 3c fa ff ff       	jmp    8010572d <alltraps>
...
80105cf3:	6a 23                	push   $0x23
  jmp alltraps
80105cf5:	e9 33 fa ff ff       	jmp    8010572d <alltraps>
...
80105cfc:	6a 24                	push   $0x24
  jmp alltraps
80105cfe:	e9 2a fa ff ff       	jmp    8010572d <alltraps>
...
80105d05:	6a 25                	push   $0x25
  jmp alltraps
80105d07:	e9 21 fa ff ff       	jmp    8010572d <alltraps>
...
80105d0e:	6a 26                	push   $0x26
  jmp alltraps
80105d10:	e9 18 fa ff ff       	jmp    8010572d <alltraps>
...
80105d17:	6a 27                	push   $0x27
  jmp alltraps
80105d19:	e9 0f fa ff ff       	jmp    8010572d <alltraps>
...
80105d20:	6a 28                	push   $0x28
  jmp alltraps
80105d22:	e9 06 fa ff ff       	jmp    8010572d <alltraps>
...
80105d29:	6a 29                	push   $0x29
  jmp alltraps
80105d2b:	e9 fd f9 ff ff       	jmp    8010572d <alltraps>
...
80105d32:	6a 2a                	push   $0x2a
  jmp alltraps
80105d34:	e9 f4 f9 ff ff       	jmp    8010572d <alltraps>
...
80105d3b:	6a 2b                	push   $0x2b
  jmp alltraps
80105d3d:	e9 eb f9 ff ff       	jmp    8010572d <alltraps>
...
80105d44:	6a 2c                	push   $0x2c
  jmp alltraps
80105d46:	e9 e2 f9 ff ff       	jmp    8010572d <alltraps>
...
80105d4d:	6a 2d                	push   $0x2d
  jmp alltraps
80105d4f:	e9 d9 f9 ff ff       	jmp    8010572d <alltraps>
...
80105d56:	6a 2e                	push   $0x2e
  jmp alltraps
80105d58:	e9 d0 f9 ff ff       	jmp    8010572d <alltraps>
...
80105d5f:	6a 2f                	push   $0x2f
  jmp alltraps
80105d61:	e9 c7 f9 ff ff       	jmp    8010572d <alltraps>
...
80105d68:	6a 30                	push   $0x30
  jmp alltraps
80105d6a:	e9 be f9 ff ff       	jmp    8010572d <alltraps>
...
80105d71:	6a 31                	push   $0x31
  jmp alltraps
80105d73:	e9 b5 f9 ff ff       	jmp    8010572d <alltraps>
...
80105d83:	6a 33                	push   $0x33
  jmp alltraps
80105d85:	e9 a3 f9 ff ff       	jmp    8010572d <alltraps>
...
80105d8c:	6a 34                	push   $0x34
  jmp alltraps
80105d8e:	e9 9a f9 ff ff       	jmp    8010572d <alltraps>
...
80105d95:	6a 35                	push   $0x35
  jmp alltraps
80105d97:	e9 91 f9 ff ff       	jmp    8010572d <alltraps>
...
80105d9e:	6a 36                	push   $0x36
  jmp alltraps
80105da0:	e9 88 f9 ff ff       	jmp    8010572d <alltraps>
...
80105da7:	6a 37                	push   $0x37
  jmp alltraps
80105da9:	e9 7f f9 ff ff       	jmp    8010572d <alltraps>
...
80105db0:	6a 38                	push   $0x38
  jmp alltraps
80105db2:	e9 76 f9 ff ff       	jmp    8010572d <alltraps>
...
80105db9:	6a 39                	push   $0x39
  jmp alltraps
80105dbb:	e9 6d f9 ff ff       	jmp    8010572d <alltraps>
...
80105dc2:	6a 3a                	push   $0x3a
  jmp alltraps
80105dc4:	e9 64 f9 ff ff       	jmp    8010572d <alltraps>
...
80105dcb:	6a 3b                	push   $0x3b
  jmp alltraps
80105dcd:	e9 5b f9 ff ff       	jmp    8010572d <alltraps>
...
80105dd4:	6a 3c                	push   $0x3c
  jmp alltraps
80105dd6:	e9 52 f9 ff ff       	jmp    8010572d <alltraps>
...
80105ddd:	6a 3d                	push   $0x3d
  jmp alltraps
80105ddf:	e9 49 f9 ff ff       	jmp    8010572d <alltraps>
...
80105de6:	6a 3e                	push   $0x3e
  jmp alltraps
80105de8:	e9 40 f9 ff ff       	jmp    8010572d <alltraps>
...
80105def:	6a 3f                	push   $0x3f
  jmp alltraps
80105df1:	e9 37 f9 ff ff       	jmp    8010572d <alltraps>
...
80105df8:	6a 40                	push   $0x40
  jmp alltraps
80105dfa:	e9 2e f9 ff ff       	jmp    8010572d <alltraps>
...
80105e01:	6a 41                	push   $0x41
  jmp alltraps
80105e03:	e9 25 f9 ff ff       	jmp    8010572d <alltraps>
...
80105e0a:	6a 42                	push   $0x42
  jmp alltraps
80105e0c:	e9 1c f9 ff ff       	jmp    8010572d <alltraps>
...
80105e13:	6a 43                	push   $0x43
  jmp alltraps
80105e15:	e9 13 f9 ff ff       	jmp    8010572d <alltraps>
...
80105e1c:	6a 44                	push   $0x44
  jmp alltraps
80105e1e:	e9 0a f9 ff ff       	jmp    8010572d <alltraps>
...
80105e25:	6a 45                	push   $0x45
  jmp alltraps
80105e27:	e9 01 f9 ff ff       	jmp    8010572d <alltraps>
...
80105e2e:	6a 46                	push   $0x46
  jmp alltraps
80105e30:	e9 f8 f8 ff ff       	jmp    8010572d <alltraps>
...
80105e37:	6a 47                	push   $0x47
  jmp alltraps
80105e39:	e9 ef f8 ff ff       	jmp    8010572d <alltraps>
...
80105e40:	6a 48                	push   $0x48
  jmp alltraps
80105e42:	e9 e6 f8 ff ff       	jmp    8010572d <alltraps>
...
80105e49:	6a 49                	push   $0x49
  jmp alltraps
80105e4b:	e9 dd f8 ff ff       	jmp    8010572d <alltraps>
...
80105e52:	6a 4a                	push   $0x4a
  jmp alltraps
80105e54:	e9 d4 f8 ff ff       	jmp    8010572d <alltraps>
...
80105e5b:	6a 4b                	push   $0x4b
  jmp alltraps
80105e5d:	e9 cb f8 ff ff       	jmp    8010572d <alltraps>
...
80105e64:	6a 4c                	push   $0x4c
  jmp alltraps
80105e66:	e9 c2 f8 ff ff       	jmp    8010572d <alltraps>
...
80105e6d:	6a 4d                	push   $0x4d
  jmp alltraps
80105e6f:	e9 b9 f8 ff ff       	jmp    8010572d <alltraps>
...
80105e76:	6a 4e                	push   $0x4e
  jmp alltraps
80105e78:	e9 b0 f8 ff ff       	jmp    8010572d <alltraps>
...
80105e7f:	6a 4f                	push   $0x4f
  jmp alltraps
80105e81:	e9 a7 f8 ff ff       	jmp    8010572d <alltraps>
...
80105e88:	6a 50                	push   $0x50
  jmp alltraps
80105e8a:	e9 9e f8 ff ff       	jmp    8010572d <alltraps>
...
80105e91:	6a 51                	push   $0x51
  jmp alltraps
80105e93:	e9 95 f8 ff ff       	jmp    8010572d <alltraps>
...
80105e9a:	6a 52                	push   $0x52
  jmp alltraps
80105e9c:	e9 8c f8 ff ff       	jmp    8010572d <alltraps>
...
80105ea3:	6a 53                	push   $0x53
  jmp alltraps
80105ea5:	e9 83 f8 ff ff       	jmp    8010572d <alltraps>
...
80105eac:	6a 54                	push   $0x54
  jmp alltraps
80105eae:	e9 7a f8 ff ff       	jmp    8010572d <alltraps>
...
80105eb5:	6a 55                	push   $0x55
  jmp alltraps
80105eb7:	e9 71 f8 ff ff       	jmp    8010572d <alltraps>
...
80105ebe:	6a 56                	push   $0x56
  jmp alltraps
80105ec0:	e9 68 f8 ff ff       	jmp    8010572d <alltraps>
...
80105ec7:	6a 57                	push   $0x57
  jmp alltraps
80105ec9:	e9 5f f8 ff ff       	jmp    8010572d <alltraps>
...
80105ed0:	6a 58                	push   $0x58
  jmp alltraps
80105ed2:	e9 56 f8 ff ff       	jmp    8010572d <alltraps>
...
80105ed9:	6a 59                	push   $0x59
  jmp alltraps
80105edb:	e9 4d f8 ff ff       	jmp    8010572d <alltraps>
...
80105ee2:	6a 5a                	push   $0x5a
  jmp alltraps
80105ee4:	e9 44 f8 ff ff       	jmp    8010572d <alltraps>
...
80105eeb:	6a 5b                	push   $0x5b
  jmp alltraps
80105eed:	e9 3b f8 ff ff       	jmp    8010572d <alltraps>
...
80105ef4:	6a 5c                	push   $0x5c
  jmp alltraps
80105ef6:	e9 32 f8 ff ff       	jmp    8010572d <alltraps>
...
80105efd:	6a 5d                	push   $0x5d
  jmp alltraps
80105eff:	e9 29 f8 ff ff       	jmp    8010572d <alltraps>
...
80105f06:	6a 5e                	push   $0x5e
  jmp alltraps
80105f08:	e9 20 f8 ff ff       	jmp    8010572d <alltraps>
...
80105f0f:	6a 5f                	push   $0x5f
  jmp alltraps
80105f11:	e9 17 f8 ff ff       	jmp    8010572d <alltraps>
...
80105f18:	6a 60                	push   $0x60
  jmp alltraps
80105f1a:	e9 0e f8 ff ff       	jmp    8010572d <alltraps>
...
80105f21:	6a 61                	push   $0x61
  jmp alltraps
80105f23:	e9 05 f8 ff ff       	jmp    8010572d <alltraps>
...
80105f2a:	6a 62                	push   $0x62
  jmp alltraps
80105f2c:	e9 fc f7 ff ff       	jmp    8010572d <alltraps>
...
80105f33:	6a 63                	push   $0x63
  jmp alltraps
80105f35:	e9 f3 f7 ff ff       	jmp    8010572d <alltraps>
...
80105f3c:	6a 64                	push   $0x64
  jmp alltraps
80105f3e:	e9 ea f7 ff ff       	jmp    8010572d <alltraps>
...
80105f45:	6a 65                	push   $0x65
  jmp alltraps
80105f47:	e9 e1 f7 ff ff       	jmp    8010572d <alltraps>
...
80105f4e:	6a 66                	push   $0x66
  jmp alltraps
80105f50:	e9 d8 f7 ff ff       	jmp    8010572d <alltraps>
...
80105f57:	6a 67                	push   $0x67
  jmp alltraps
80105f59:	e9 cf f7 ff ff       	jmp    8010572d <alltraps>
...
80105f60:	6a 68                	push   $0x68
  jmp alltraps
80105f62:	e9 c6 f7 ff ff       	jmp    8010572d <alltraps>
...
80105f69:	6a 69                	push   $0x69
  jmp alltraps
80105f6b:	e9 bd f7 ff ff       	jmp    8010572d <alltraps>
...
80105f72:	6a 6a                	push   $0x6a
  jmp alltraps
80105f74:	e9 b4 f7 ff ff       	jmp    8010572d <alltraps>
...
80105f7b:	6a 6b                	push   $0x6b
  jmp alltraps
80105f7d:	e9 ab f7 ff ff       	jmp    8010572d <alltraps>
...
80105f84:	6a 6c                	push   $0x6c
  jmp alltraps
80105f86:	e9 a2 f7 ff ff       	jmp    8010572d <alltraps>
...
80105f8d:	6a 6d                	push   $0x6d
  jmp alltraps
80105f8f:	e9 99 f7 ff ff       	jmp    8010572d <alltraps>
...
80105f96:	6a 6e                	push   $0x6e
  jmp alltraps
80105f98:	e9 90 f7 ff ff       	jmp    8010572d <alltraps>
...
80105f9f:	6a 6f                	push   $0x6f
  jmp alltraps
80105fa1:	e9 87 f7 ff ff       	jmp    8010572d <alltraps>
...
80105fa8:	6a 70                	push   $0x70
  jmp alltraps
80105faa:	e9 7e f7 ff ff       	jmp    8010572d <alltraps>
...
80105fb1:	6a 71                	push   $0x71
  jmp alltraps
80105fb3:	e9 75 f7 ff ff       	jmp    8010572d <alltraps>
...
80105fba:	6a 72                	push   $0x72
  jmp alltraps
80105fbc:	e9 6c f7 ff ff       	jmp    8010572d <alltraps>
...
80105fc3:	6a 73                	push   $0x73
  jmp alltraps
80105fc5:	e9 63 f7 ff ff       	jmp    8010572d <alltraps>
...
80105fcc:	6a 74                	push   $0x74
  jmp alltraps
80105fce:	e9 5a f7 ff ff       	jmp    8010572d <alltraps>
...
80105fd5:	6a 75                	push   $0x75
  jmp alltraps
80105fd7:	e9 51 f7 ff ff       	jmp    8010572d <alltraps>
...
80105fde:	6a 76                	push   $0x76
  jmp alltraps
80105fe0:	e9 48 f7 ff ff       	jmp    8010572d <alltraps>
...
80105fe7:	6a 77                	push   $0x77
  jmp alltraps
80105fe9:	e9 3f f7 ff ff       	jmp    8010572d <alltraps>
...
80105ff0:	6a 78                	push   $0x78
  jmp alltraps
80105ff2:	e9 36 f7 ff ff       	jmp    8010572d <alltraps>
...
80105ff9:	6a 79                	push   $0x79
  jmp alltraps
80105ffb:	e9 2d f7 ff ff       	jmp    8010572d <alltraps>
...
80106002:	6a 7a                	push   $0x7a
  jmp alltraps
80106004:	e9 24 f7 ff ff       	jmp    8010572d <alltraps>
...
8010600b:	6a 7b                	push   $0x7b
  jmp alltraps
8010600d:	e9 1b f7 ff ff       	jmp    8010572d <alltraps>
...
80106014:	6a 7c                	push   $0x7c
  jmp alltraps
80106016:	e9 12 f7 ff ff       	jmp    8010572d <alltraps>
...
8010601d:	6a 7d                	push   $0x7d
  jmp alltraps
8010601f:	e9 09 f7 ff ff       	jmp    8010572d <alltraps>
...
80106026:	6a 7e                	push   $0x7e
  jmp alltraps
80106028:	e9 00 f7 ff ff       	jmp    8010572d <alltraps>
...
8010602f:	6a 7f                	push   $0x7f
  jmp alltraps
80106031:	e9 f7 f6 ff ff       	jmp    8010572d <alltraps>
...
80106044:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106049:	e9 df f6 ff ff       	jmp    8010572d <alltraps>
...
80106050:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106055:	e9 d3 f6 ff ff       	jmp    8010572d <alltraps>
...
80106068:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010606d:	e9 bb f6 ff ff       	jmp    8010572d <alltraps>
...
80106074:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106079:	e9 af f6 ff ff       	jmp    8010572d <alltraps>
...
8010608c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106091:	e9 97 f6 ff ff       	jmp    8010572d <alltraps>
...
80106098:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010609d:	e9 8b f6 ff ff       	jmp    8010572d <alltraps>
...
801060b0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801060b5:	e9 73 f6 ff ff       	jmp    8010572d <alltraps>
...
801060bc:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801060c1:	e9 67 f6 ff ff       	jmp    8010572d <alltraps>
...
801060d4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801060d9:	e9 4f f6 ff ff       	jmp    8010572d <alltraps>
...
801060e0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801060e5:	e9 43 f6 ff ff       	jmp    8010572d <alltraps>
...
801060f8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801060fd:	e9 2b f6 ff ff       	jmp    8010572d <alltraps>
...
80106104:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106109:	e9 1f f6 ff ff       	jmp    8010572d <alltraps>
...
8010611c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106121:	e9 07 f6 ff ff       	jmp    8010572d <alltraps>
...
80106128:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010612d:	e9 fb f5 ff ff       	jmp    8010572d <alltraps>
...
80106140:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106145:	e9 e3 f5 ff ff       	jmp    8010572d <alltraps>
...
8010614c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106151:	e9 d7 f5 ff ff       	jmp    8010572d <alltraps>
...
80106164:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106169:	e9 bf f5 ff ff       	jmp    8010572d <alltraps>
...
80106170:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106175:	e9 b3 f5 ff ff       	jmp    8010572d <alltraps>
...
801066a2:	e8 89 de ff ff       	call   80104530 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106741:	c3                   	ret    
      panic("remap");
80106742:	c7 04 24 30 78 10 80 	movl   $0x80107830,(%esp)
...
801067da:	c3                   	ret    
        panic("kfree");
801067db:	c7 04 24 c6 71 10 80 	movl   $0x801071c6,(%esp)
...
801067f3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801067f6:	e8 85 ce ff ff       	call   80103680 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801067fb:	31 c9                	xor    %ecx,%ecx
801067fd:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c = &cpus[cpuid()];
80106802:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106808:	05 80 27 11 80       	add    $0x80112780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010680d:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106811:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  lgdt(c->gdt, sizeof(c->gdt));
80106816:	83 c0 70             	add    $0x70,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106819:	66 89 48 0a          	mov    %cx,0xa(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010681d:	31 c9                	xor    %ecx,%ecx
8010681f:	66 89 50 10          	mov    %dx,0x10(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106823:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106828:	66 89 48 12          	mov    %cx,0x12(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010682c:	31 c9                	xor    %ecx,%ecx
8010682e:	66 89 50 18          	mov    %dx,0x18(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106832:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106837:	66 89 48 1a          	mov    %cx,0x1a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010683b:	31 c9                	xor    %ecx,%ecx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010683d:	c6 40 0d 9a          	movb   $0x9a,0xd(%eax)
80106841:	c6 40 0e cf          	movb   $0xcf,0xe(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106845:	c6 40 15 92          	movb   $0x92,0x15(%eax)
80106849:	c6 40 16 cf          	movb   $0xcf,0x16(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010684d:	c6 40 1d fa          	movb   $0xfa,0x1d(%eax)
80106851:	c6 40 1e cf          	movb   $0xcf,0x1e(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106855:	c6 40 25 f2          	movb   $0xf2,0x25(%eax)
80106859:	c6 40 26 cf          	movb   $0xcf,0x26(%eax)
8010685d:	66 89 50 20          	mov    %dx,0x20(%eax)
  pd[0] = size-1;
80106861:	ba 2f 00 00 00       	mov    $0x2f,%edx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106866:	c6 40 0c 00          	movb   $0x0,0xc(%eax)
8010686a:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010686e:	c6 40 14 00          	movb   $0x0,0x14(%eax)
80106872:	c6 40 17 00          	movb   $0x0,0x17(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106876:	c6 40 1c 00          	movb   $0x0,0x1c(%eax)
8010687a:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010687e:	66 89 48 22          	mov    %cx,0x22(%eax)
80106882:	c6 40 24 00          	movb   $0x0,0x24(%eax)
80106886:	c6 40 27 00          	movb   $0x0,0x27(%eax)
8010688a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
8010688e:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106892:	c1 e8 10             	shr    $0x10,%eax
80106895:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80106899:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010689c:	0f 01 10             	lgdtl  (%eax)
}
8010689f:	c9                   	leave  
801068a0:	c3                   	ret    
801068a1:	eb 0d                	jmp    801068b0 <switchkvm>
801068a3:	90                   	nop
801068a4:	90                   	nop
801068a5:	90                   	nop
801068a6:	90                   	nop
...
801068f4:	0f 84 c3 00 00 00    	je     801069bd <switchuvm+0xed>
  pushcli();
801068fa:	e8 81 da ff ff       	call   80104380 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801068ff:	e8 fc cc ff ff       	call   80103600 <mycpu>
80106904:	89 c3                	mov    %eax,%ebx
80106906:	e8 f5 cc ff ff       	call   80103600 <mycpu>
8010690b:	89 c7                	mov    %eax,%edi
8010690d:	e8 ee cc ff ff       	call   80103600 <mycpu>
80106912:	83 c7 08             	add    $0x8,%edi
80106915:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106918:	e8 e3 cc ff ff       	call   80103600 <mycpu>
8010691d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106920:	ba 67 00 00 00       	mov    $0x67,%edx
80106925:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
8010692c:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106933:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
8010693a:	83 c1 08             	add    $0x8,%ecx
8010693d:	c1 e9 10             	shr    $0x10,%ecx
80106940:	83 c0 08             	add    $0x8,%eax
80106943:	c1 e8 18             	shr    $0x18,%eax
80106946:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
8010694c:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106953:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106959:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
8010695e:	e8 9d cc ff ff       	call   80103600 <mycpu>
80106963:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010696a:	e8 91 cc ff ff       	call   80103600 <mycpu>
...
80106986:	89 48 0c             	mov    %ecx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106989:	e8 72 cc ff ff       	call   80103600 <mycpu>
...
801069ab:	5d                   	pop    %ebp
  popcli();
801069ac:	e9 0f da ff ff       	jmp    801043c0 <popcli>
    panic("switchuvm: no process");
801069b1:	c7 04 24 36 78 10 80 	movl   $0x80107836,(%esp)
801069b8:	e8 a3 99 ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801069bd:	c7 04 24 61 78 10 80 	movl   $0x80107861,(%esp)
801069c4:	e8 97 99 ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801069c9:	c7 04 24 4c 78 10 80 	movl   $0x8010784c,(%esp)
801069d0:	e8 8b 99 ff ff       	call   80100360 <panic>
...
801069fb:	77 54                	ja     80106a51 <inituvm+0x71>
  mem = kalloc();
801069fd:	e8 9e ba ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106a17:	e8 14 db ff ff       	call   80104530 <memset>
...
80106a36:	00 
80106a37:	e8 94 fc ff ff       	call   801066d0 <mappages>
  memmove(mem, init, sz);
...
80106a4b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106a4c:	e9 7f db ff ff       	jmp    801045d0 <memmove>
    panic("inituvm: more than a page");
80106a51:	c7 04 24 75 78 10 80 	movl   $0x80107875,(%esp)
...
80106aa3:	e8 98 fb ff ff       	call   80106640 <walkpgdir>
...
80106add:	e8 7e ae ff ff       	call   80101960 <readi>
...
80106b02:	c7 04 24 8f 78 10 80 	movl   $0x8010788f,(%esp)
80106b09:	e8 52 98 ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
80106b0e:	c7 04 24 30 79 10 80 	movl   $0x80107930,(%esp)
...
80106b63:	e8 c8 d9 ff ff       	call   80104530 <memset>
...
80106b82:	00 
80106b83:	e8 48 fb ff ff       	call   801066d0 <mappages>
...
80106ba1:	c7 04 24 ad 78 10 80 	movl   $0x801078ad,(%esp)
...
80106bd0:	c7 04 24 c5 78 10 80 	movl   $0x801078c5,(%esp)
...
80106be9:	e8 62 fb ff ff       	call   80106750 <deallocuvm.part.0>
      kfree(mem);
80106bee:	89 34 24             	mov    %esi,(%esp)
80106bf1:	e8 fa b6 ff ff       	call   801022f0 <kfree>
      return 0;
...
80106c02:	e8 49 fb ff ff       	call   80106750 <deallocuvm.part.0>
      return 0;
...
80106c20:	5d                   	pop    %ebp
80106c21:	e9 2a fb ff ff       	jmp    80106750 <deallocuvm.part.0>
...
80106c4a:	e8 01 fb ff ff       	call   80106750 <deallocuvm.part.0>
...
80106c7d:	e8 6e b6 ff ff       	call   801022f0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
...
80106c92:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106c93:	e9 58 b6 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106c98:	c7 04 24 e1 78 10 80 	movl   $0x801078e1,(%esp)
...
80106cb8:	e8 e3 b7 ff ff       	call   801024a0 <kalloc>
80106cbd:	85 c0                	test   %eax,%eax
80106cbf:	89 c6                	mov    %eax,%esi
80106cc1:	74 6d                	je     80106d30 <setupkvm+0x80>
  memset(pgdir, 0, PGSIZE);
80106cc3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106cca:	00 
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106ccb:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
80106cd0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106cd7:	00 
80106cd8:	89 04 24             	mov    %eax,(%esp)
80106cdb:	e8 50 d8 ff ff       	call   80104530 <memset>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106ce0:	8b 53 0c             	mov    0xc(%ebx),%edx
80106ce3:	8b 43 04             	mov    0x4(%ebx),%eax
80106ce6:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106ce9:	89 54 24 04          	mov    %edx,0x4(%esp)
80106ced:	8b 13                	mov    (%ebx),%edx
80106cef:	89 04 24             	mov    %eax,(%esp)
80106cf2:	29 c1                	sub    %eax,%ecx
80106cf4:	89 f0                	mov    %esi,%eax
80106cf6:	e8 d5 f9 ff ff       	call   801066d0 <mappages>
80106cfb:	85 c0                	test   %eax,%eax
80106cfd:	78 19                	js     80106d18 <setupkvm+0x68>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106cff:	83 c3 10             	add    $0x10,%ebx
80106d02:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106d08:	72 d6                	jb     80106ce0 <setupkvm+0x30>
80106d0a:	89 f0                	mov    %esi,%eax
}
...
80106d14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      freevm(pgdir);
80106d18:	89 34 24             	mov    %esi,(%esp)
80106d1b:	e8 10 ff ff ff       	call   80106c30 <freevm>
}
...
80106d32:	eb d8                	jmp    80106d0c <setupkvm+0x5c>
...
80106d43:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106d46:	e8 65 ff ff ff       	call   80106cb0 <setupkvm>
...
80106d6e:	e8 cd f8 ff ff       	call   80106640 <walkpgdir>
  if(pte == 0)
...
80106d7b:	c3                   	ret    
    panic("clearpteu");
80106d7c:	c7 04 24 f2 78 10 80 	movl   $0x801078f2,(%esp)
...
80106d96:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80106d99:	e8 12 ff ff ff       	call   80106cb0 <setupkvm>
80106d9e:	85 c0                	test   %eax,%eax
80106da0:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106da3:	0f 84 b9 00 00 00    	je     80106e62 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106db8:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106dbe:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106dc5:	00 
80106dc6:	89 74 24 04          	mov    %esi,0x4(%esp)
80106dca:	89 04 24             	mov    %eax,(%esp)
80106dcd:	e8 fe d7 ff ff       	call   801045d0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106dd2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106dd5:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106dda:	89 fa                	mov    %edi,%edx
80106ddc:	89 44 24 04          	mov    %eax,0x4(%esp)
80106de0:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106de6:	89 04 24             	mov    %eax,(%esp)
80106de9:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106dec:	e8 df f8 ff ff       	call   801066d0 <mappages>
80106df1:	85 c0                	test   %eax,%eax
80106df3:	78 63                	js     80106e58 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106df5:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106dfb:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106dfe:	76 48                	jbe    80106e48 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106e00:	8b 45 08             	mov    0x8(%ebp),%eax
80106e03:	31 c9                	xor    %ecx,%ecx
80106e05:	89 fa                	mov    %edi,%edx
80106e07:	e8 34 f8 ff ff       	call   80106640 <walkpgdir>
80106e0c:	85 c0                	test   %eax,%eax
80106e0e:	74 62                	je     80106e72 <copyuvm+0xe2>
    if(!(*pte & PTE_P))
80106e10:	8b 00                	mov    (%eax),%eax
80106e12:	a8 01                	test   $0x1,%al
80106e14:	74 50                	je     80106e66 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106e16:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106e18:	25 ff 0f 00 00       	and    $0xfff,%eax
80106e1d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106e20:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106e26:	e8 75 b6 ff ff       	call   801024a0 <kalloc>
80106e2b:	85 c0                	test   %eax,%eax
80106e2d:	89 c3                	mov    %eax,%ebx
80106e2f:	75 87                	jne    80106db8 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106e31:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106e34:	89 04 24             	mov    %eax,(%esp)
80106e37:	e8 f4 fd ff ff       	call   80106c30 <freevm>
  return 0;
80106e3c:	31 c0                	xor    %eax,%eax
}
80106e3e:	83 c4 2c             	add    $0x2c,%esp
80106e41:	5b                   	pop    %ebx
80106e42:	5e                   	pop    %esi
80106e43:	5f                   	pop    %edi
80106e44:	5d                   	pop    %ebp
80106e45:	c3                   	ret    
80106e46:	66 90                	xchg   %ax,%ax
80106e48:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106e4b:	83 c4 2c             	add    $0x2c,%esp
80106e4e:	5b                   	pop    %ebx
80106e4f:	5e                   	pop    %esi
80106e50:	5f                   	pop    %edi
80106e51:	5d                   	pop    %ebp
...
80106e54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80106e58:	89 1c 24             	mov    %ebx,(%esp)
80106e5b:	e8 90 b4 ff ff       	call   801022f0 <kfree>
      goto bad;
80106e60:	eb cf                	jmp    80106e31 <copyuvm+0xa1>
    return 0;
80106e62:	31 c0                	xor    %eax,%eax
80106e64:	eb d8                	jmp    80106e3e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106e66:	c7 04 24 16 79 10 80 	movl   $0x80107916,(%esp)
80106e6d:	e8 ee 94 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106e72:	c7 04 24 fc 78 10 80 	movl   $0x801078fc,(%esp)
80106e79:	e8 e2 94 ff ff       	call   80100360 <panic>
...
80106efc:	e8 cf d6 ff ff       	call   801045d0 <memmove>
    len -= n;
    buf += n;
